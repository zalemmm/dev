...
var pathToImages = "/wp-content/plugins/fbshop/relaiscolis/img/";
...
// Chargement de la liste de relais colis apr�s le choix de la commune parmis plusieurs
// communes correspondant au m�me code postal
...
function tntB2CRelaisColis() {
	...
	// For�age de la propri�t� "top", car elle est �cras�e par la gestion de jqModal
	// si on la met dans la d�finition de la classe du div correspondant...
	...
	// R�cup�rations des param�tres de l'URL
	...
	// Initialisation de Map associ�e
	tntRCInitMap();
};
...
function tntRCafficheDetail(i) {
	...
	// Les noeuds dans le fichier JSON ne sont pas forc�ment ordonn�s pour l'affichage, on va donc d'abord r�cup�rer leur valeur
	var codeRelais = oRelais[0]
	var nomRelais = oRelais[1];
	var adresse = oRelais[4];
	var codePostal = oRelais[2];
...
// Table vide avec 3 colonnes et ent�te en gris
...
// Table ent�te de colonnes grises
...
/*
 * Fonction appell�e en retour de la recherche des communes par rapport � un code postal
 * si plusieurs communes ont �t� trouv�es
 */

function listeCommunes(tabCommunes) {
	tntRCJsonCommunes = null;

	// TEMP: car le contenu du div est enti�rement reconstruit
...
/*
 * Fonction appell�e en retour de la recherche des communes par rapport � un code postal
 * si une seule commune a �t� trouv�e
 */
...
/*
 * Fonction appell�e en retour de la recherche des communes si aucune commune trouv�e
 */
