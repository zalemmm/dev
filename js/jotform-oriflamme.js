...
//denisedesign
						...
						/////////////////////oriflamme//////////
				       	...
				       	if ($('input_1').value == 'drapeaux') {
							...
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/oriflamme/drapeaux.jpg) no-repeat" ;
						}
							if ($('input_1').value == 'oriflamme') {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/oriflamme/oriflamme-aile-d-avion.jpg) no-repeat" ;
						}
							if ($('input_1').value == 'beachflag') {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/oriflamme/oriflamme-beachflag.jpg) no-repeat" ;
						}
							if ($('input_1').value == 'windflag') {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/oriflamme/oriflamme-windflag.jpg) no-repeat" ;
						}
