...
//denisedesign
						...
						var preview_info_ul2 = $("preview_info_ul2");
							if ($('input_1').value) {
								...
								preview_name.innerHTML='ENSEIGNE sélectionné:';

								var preview_info_title = $("preview_info_title");
								var folder = 'enseignes'; var plik; var nazwa; var li1; var li2; var li3;
								if ($('input_1').value == 'forex3mm' ) { var nazwa = 'forex 3mm'; li1='<span id="lista1"><li>panneau expansé en PVC 3mm rigide et léger</li></span>'; }
								if ($('input_1').value == 'forex5mm' ) { var nazwa = 'forex 5mm'; li1='<span id="lista1"><li>panneau expansé en PVC 5mm rigide et léger</li></span>'; }
								if ($('input_1').value == 'dibond' ) { var nazwa = 'dibond 3mm'; li1='<span id="lista1"><li>panneau à la fois solide et léger</li><li>composé de polyéthylène au centre entouré par deux plaques d\'aluminium</li></span>'; }

								if (($('input_1').value == 'forex3mm' ) && ($('input_31').value == 'recto' )) { li1='<span id="lista1"><li>panneau expansé en PVC 3mm rigide et léger</li><li>Recto</li></span>'; }
								if (($('input_1').value == 'forex3mm' ) && ($('input_31').value == 'rectoverso' )) { li1='<span id="lista1"><li>panneau expansé en PVC 3mm rigide et léger</li><li>Recto/Verso</li></span>'; }
								if (($('input_1').value == 'forex3mm' ) && ($('input_31').value == 'recto' ) && ($('input_32').value == '2' )) { li1='<span id="lista1"><li>panneau expansé en PVC 3mm rigide et léger</li><li>Recto</li><li>2 trous</li></span>'; }
								if (($('input_1').value == 'forex3mm' ) && ($('input_31').value == 'rectoverso' ) && ($('input_32').value == '2' )) { li1='<span id="lista1"><li>panneau expansé en PVC 3mm rigide et léger</li><li>Recto/Verso</li><li>2 trous</li></span>'; }
								if (($('input_1').value == 'forex3mm' ) && ($('input_31').value == 'recto' ) && ($('input_32').value == '4' )) { li1='<span id="lista1"><li>panneau expansé en PVC 3mm rigide et léger</li><li>Recto</li><li>4 trous</li></span>'; }
								if (($('input_1').value == 'forex3mm' ) && ($('input_31').value == 'rectoverso' ) && ($('input_32').value == '4' )) { li1='<span id="lista1"><li>panneau expansé en PVC 3mm rigide et léger</li><li>Recto/Verso</li><li>4 trous</li></span>'; }
								if (($('input_1').value == 'forex3mm' ) && ($('input_31').value == 'recto' ) && ($('input_32').value == '6' )) { li1='<span id="lista1"><li>panneau expansé en PVC 3mm rigide et léger</li><li>Recto</li><li>6 trous</li></span>'; }
								if (($('input_1').value == 'forex3mm' ) && ($('input_31').value == 'rectoverso' ) && ($('input_32').value == '6' )) { li1='<span id="lista1"><li>panneau expansé en PVC 3mm rigide et léger</li><li>Recto/Verso</li><li>6 trous</li></span>'; }
								if (($('input_1').value == 'forex3mm' ) && ($('input_31').value == 'recto' ) && ($('input_32').value == '8' )) { li1='<span id="lista1"><li>panneau expansé en PVC 3mm rigide et léger</li><li>Recto</li><li>8 trous</li></span>'; }
								if (($('input_1').value == 'forex3mm' ) && ($('input_31').value == 'rectoverso' ) && ($('input_32').value == '8' )) { li1='<span id="lista1"><li>panneau expansé en PVC 3mm rigide et léger</li><li>Recto/Verso</li><li>8 trous</li></span>'; }
								if (($('input_1').value == 'forex3mm' ) && ($('input_31').value == 'recto' ) && ($('input_32').value == '10' )) { li1='<span id="lista1"><li>panneau expansé en PVC 3mm rigide et léger</li><li>Recto</li><li>10 trous</li></span>'; }
								if (($('input_1').value == 'forex3mm' ) && ($('input_31').value == 'rectoverso' ) && ($('input_32').value == '10' )) { li1='<span id="lista1"><li>panneau expansé en PVC 3mm rigide et léger</li><li>Recto/Verso</li><li>10 trous</li></span>'; }
								if (($('input_1').value == 'forex3mm' ) && ($('input_31').value == 'recto' ) && ($('input_32').value == 'Pas de perçage' )) { li1='<span id="lista1"><li>panneau expansé en PVC 3mm rigide et léger</li><li>Recto</li><li>Pas de perçage</li></span>'; }
								if (($('input_1').value == 'forex3mm' ) && ($('input_31').value == 'rectoverso' ) && ($('input_32').value == 'Pas de perçage' )) { li1='<span id="lista1"><li>panneau expansé en PVC 3mm rigide et léger</li><li>Recto/Verso</li><li>Pas de perçage</li></span>'; }


								if (($('input_1').value == 'forex5mm' ) && ($('input_31').value == 'recto' )) { li1='<span id="lista1"><li>panneau expansé en PVC 5mm rigide et léger</li><li>Recto</li></span>'; }
								if (($('input_1').value == 'forex5mm' ) && ($('input_31').value == 'rectoverso' )) { li1='<span id="lista1"><li>panneau expansé en PVC 5mm rigide et léger</li><li>Recto/Verso</li></span>'; }
								if (($('input_1').value == 'forex5mm' ) && ($('input_31').value == 'recto' ) && ($('input_32').value == '2' )) { li1='<span id="lista1"><li>panneau expansé en PVC 5mm rigide et léger</li><li>Recto</li><li>2 trous</li></span>'; }
								if (($('input_1').value == 'forex5mm' ) && ($('input_31').value == 'rectoverso' ) && ($('input_32').value == '2' )) { li1='<span id="lista1"><li>panneau expansé en PVC 5mm rigide et léger</li><li>Recto/Verso</li><li>2 trous</li></span>'; }
								if (($('input_1').value == 'forex5mm' ) && ($('input_31').value == 'recto' ) && ($('input_32').value == '4' )) { li1='<span id="lista1"><li>panneau expansé en PVC 5mm rigide et léger</li><li>Recto</li><li>4 trous</li></span>'; }
								if (($('input_1').value == 'forex5mm' ) && ($('input_31').value == 'rectoverso' ) && ($('input_32').value == '4' )) { li1='<span id="lista1"><li>panneau expansé en PVC 5mm rigide et léger</li><li>Recto/Verso</li><li>4 trous</li></span>'; }
								if (($('input_1').value == 'forex5mm' ) && ($('input_31').value == 'recto' ) && ($('input_32').value == '6' )) { li1='<span id="lista1"><li>panneau expansé en PVC 5mm rigide et léger</li><li>Recto</li><li>6 trous</li></span>'; }
								if (($('input_1').value == 'forex5mm' ) && ($('input_31').value == 'rectoverso' ) && ($('input_32').value == '6' )) { li1='<span id="lista1"><li>panneau expansé en PVC 5mm rigide et léger</li><li>Recto/Verso</li><li>6 trous</li></span>'; }
								if (($('input_1').value == 'forex5mm' ) && ($('input_31').value == 'recto' ) && ($('input_32').value == '8' )) { li1='<span id="lista1"><li>panneau expansé en PVC 5mm rigide et léger</li><li>Recto</li><li>8 trous</li></span>'; }
								if (($('input_1').value == 'forex5mm' ) && ($('input_31').value == 'rectoverso' ) && ($('input_32').value == '8' )) { li1='<span id="lista1"><li>panneau expansé en PVC 5mm rigide et léger</li><li>Recto/Verso</li><li>8 trous</li></span>'; }
								if (($('input_1').value == 'forex5mm' ) && ($('input_31').value == 'recto' ) && ($('input_32').value == '10' )) { li1='<span id="lista1"><li>panneau expansé en PVC 5mm rigide et léger</li><li>Recto</li><li>10 trous</li></span>'; }
								if (($('input_1').value == 'forex5mm' ) && ($('input_31').value == 'rectoverso' ) && ($('input_32').value == '10' )) { li1='<span id="lista1"><li>panneau expansé en PVC 5mm rigide et léger</li><li>Recto/Verso</li><li>10 trous</li></span>'; }
								if (($('input_1').value == 'forex5mm' ) && ($('input_31').value == 'recto' ) && ($('input_32').value == 'Pas de perçage' )) { li1='<span id="lista1"><li>panneau expansé en PVC 5mm rigide et léger</li><li>Recto</li><li>Pas de perçage</li></span>'; }
								if (($('input_1').value == 'forex5mm' ) && ($('input_31').value == 'rectoverso' ) && ($('input_32').value == 'Pas de perçage' )) { li1='<span id="lista1"><li>panneau expansé en PVC 5mm rigide et léger</li><li>Recto/Verso</li><li>Pas de perçage</li></span>'; }

								if (($('input_1').value == 'dibond' ) && ($('input_31').value == 'recto' )) { li1='<span id="lista1"><li>panneau à la fois solide et léger</li><li>composé de polyéthylène au centre entouré par deux plaques d\'aluminium</li><li>Recto</li></span>'; }
								if (($('input_1').value == 'dibond' ) && ($('input_31').value == 'rectoverso' )) { li1='<span id="lista1"><li>panneau à la fois solide et léger</li><li>composé de polyéthylène au centre entouré par deux plaques d\'aluminium</li><li>Recto/Verso</li></span>'; }
								if (($('input_1').value == 'dibond' ) && ($('input_31').value == 'recto' ) && ($('input_32').value == '2' )) { li1='<span id="lista1"><li>panneau à la fois solide et léger</li><li>composé de polyéthylène au centre entouré par deux plaques d\'aluminium</li><li>Recto</li><li>2 trous</li></span>'; }
								if (($('input_1').value == 'dibond' ) && ($('input_31').value == 'rectoverso' ) && ($('input_32').value == '2' )) { li1='<span id="lista1"><li>panneau à la fois solide et léger</li><li>composé de polyéthylène au centre entouré par deux plaques d\'aluminium</li><li>Recto/Verso</li><li>2 trous</li></span>'; }
								if (($('input_1').value == 'dibond' ) && ($('input_31').value == 'recto' ) && ($('input_32').value == '4' )) { li1='<span id="lista1"><li>panneau à la fois solide et léger</li><li>composé de polyéthylène au centre entouré par deux plaques d\'aluminium</li><li>Recto</li><li>4 trous</li></span>'; }
								if (($('input_1').value == 'dibond' ) && ($('input_31').value == 'rectoverso' ) && ($('input_32').value == '4' )) { li1='<span id="lista1"><li>panneau à la fois solide et léger</li><li>composé de polyéthylène au centre entouré par deux plaques d\'aluminium</li><li>Recto/Verso</li><li>4 trous</li></span>'; }
								if (($('input_1').value == 'dibond' ) && ($('input_31').value == 'recto' ) && ($('input_32').value == '6' )) { li1='<span id="lista1"><li>panneau à la fois solide et léger</li><li>composé de polyéthylène au centre entouré par deux plaques d\'aluminium</li><li>Recto</li><li>6 trous</li></span>'; }
								if (($('input_1').value == 'dibond' ) && ($('input_31').value == 'rectoverso' ) && ($('input_32').value == '6' )) { li1='<span id="lista1"><li>panneau à la fois solide et léger</li><li>composé de polyéthylène au centre entouré par deux plaques d\'aluminium</li><li>Recto/Verso</li><li>6 trous</li></span>'; }
								if (($('input_1').value == 'dibond' ) && ($('input_31').value == 'recto' ) && ($('input_32').value == '8' )) { li1='<span id="lista1"><li>panneau à la fois solide et léger</li><li>composé de polyéthylène au centre entouré par deux plaques d\'aluminium</li><li>Recto</li><li>8 trous</li></span>'; }
								if (($('input_1').value == 'dibond' ) && ($('input_31').value == 'rectoverso' ) && ($('input_32').value == '8' )) { li1='<span id="lista1"><li>panneau à la fois solide et léger</li><li>composé de polyéthylène au centre entouré par deux plaques d\'aluminium</li><li>Recto/Verso</li><li>8 trous</li></span>'; }
								if (($('input_1').value == 'dibond' ) && ($('input_31').value == 'recto' ) && ($('input_32').value == '10' )) { li1='<span id="lista1"><li>panneau à la fois solide et léger</li><li>composé de polyéthylène au centre entouré par deux plaques d\'aluminium</li><li>Recto</li><li>10 trous</li></span>'; }
								if (($('input_1').value == 'dibond' ) && ($('input_31').value == 'rectoverso' ) && ($('input_32').value == '10' )) { li1='<span id="lista1"><li>panneau à la fois solide et léger</li><li>composé de polyéthylène au centre entouré par deux plaques d\'aluminium</li><li>Recto/Verso</li><li>10 trous</li></span>'; }
								if (($('input_1').value == 'dibond' ) && ($('input_31').value == 'recto' ) && ($('input_32').value == 'Pas de perçage' )) { li1='<span id="lista1"><li>panneau à la fois solide et léger</li><li>composé de polyéthylène au centre entouré par deux plaques d\'aluminium</li><li>Recto</li><li>Pas de perçage</li></span>'; }
								if (($('input_1').value == 'dibond' ) && ($('input_31').value == 'rectoverso' ) && ($('input_32').value == 'Pas de perçage' )) { li1='<span id="lista1"><li>panneau à la fois solide et léger</li><li>composé de polyéthylène au centre entouré par deux plaques d\'aluminium</li><li>Recto/Verso</li><li>Pas de perçage</li></span>'; }
...
// obrazki 1
								...
								if (term.field==1) {
									imag.style.background="url('https://www.france-banderole.com/wp-content/plugins/fbshop/images/"+folder+"/"+$('input_1').value+".jpg') no-repeat";
								}
								var obecny1 = $("lista1");
								if (obecny1) {
									obecny1.replace(li1);
							...
							var preview_info_title2 = $("preview_info_title2");
								if ($('input_31').value == 'recto' ) { var nazwa2 = 'simple'; li2='<span id="lista2"><li>recto</li></span>'; }
								if ($('input_31').value == 'rectoverso' ) { var nazwa2 = 'personnalisée'; li2='<span id="lista2"><li>recto/verso</li></span>'; }
								...
								if (term.field==3) {
									imag2.style.background="url('https://www.france-banderole.com/wp-content/plugins/fbshop/images/"+folder+"/"+$('input_3').value+".jpg') no-repeat";
								}
								var obecny2 = $("lista2");
								if (obecny2) {
									obecny2.replace(li2);
								} else {
									preview_info_ul2.insert(li2);
								}
