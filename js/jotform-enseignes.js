...
// obrazki 1
								...
								if (term.field==1) {
									imag.style.background="url('http://www.france-banderole.com/wp-content/plugins/fbshop/images/"+folder+"/"+$('input_1').value+".jpg') no-repeat";
								}
								var obecny1 = $("lista1");
								if (obecny1) { 
									obecny1.replace(li1);
							...
							var preview_info_title2 = $("preview_info_title2");
								...
								if (term.field==3) {
									imag2.style.background="url('http://www.france-banderole.com/wp-content/plugins/fbshop/images/"+folder+"/"+$('input_3').value+".jpg') no-repeat";
								}
								var obecny2 = $("lista2");
								if (obecny2) { 
									obecny2.replace(li2);
