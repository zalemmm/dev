...
//denisedesign
						...
						if (term.field==1) {
							...
							imag.style.background="url(http://france-banderole.com/wp-content/plugins/fbshop/images/oriflamme/"+($('input_1').value)+".jpg) no-repeat";
						}	
						if (term.field==20) {
							preview_info_ul.innerHTML='';
							preview_info_ul.insert(li1='<li>voile: '+($('input_20').value)+' cm</li>');
						...
						if (term.field==23) {
							...
							preview_info_ul.insert('<li>taille finale 63x256cm</li>');
							}
