...
//denisedesign
            if(JotForm.checkValueByOperator(term.operator, term.value, value)){
              ...
              if (($('input_1').value == 'recto') || ($('input_1').value == 'rectoverso')) {
                 ...
                 $("preview_imag").style.backgroundImage="url(../wp-content/plugins/fbshop/images/akilux/bg.png)";
                 var imag = $("preview_imag2");
                 imag.style.backgroundImage="url(../wp-content/plugins/fbshop/images/enseignes/base.png)";
