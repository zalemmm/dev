...
//denisedesign
						...
						if ($('input_1').value) {
							var preview_info_title = $("preview_info_title");
								if ($('input_1').value == 'depliants 80g' ) { nazwa = 'depliants 80g'; var ktorawersja = 1;}
								if ($('input_1').value == 'depliants 135g' ) { nazwa = 'depliants 135g'; var ktorawersja = 2;}
								if ($('input_1').value == 'depliants 170g' ) { nazwa = 'depliants 170g'; var ktorawersja = 3;}
								if ($('input_1').value == 'depliants 250g' ) { nazwa = 'depliants 250g'; var ktorawersja = 4;}
								...
								if (term.field==21 || term.field==22 || term.field==23 || term.field==24 || term.field==32 || term.field==33 || term.field==34 || term.field==41 || term.field==42 ) {
									var plik; var nazwa; var li1; var li2; var li3;
									if ( ktorawersja==1 || ktorawersja==2 || ktorawersja==3 || ktorawersja==4) {
										var folder = 'depliants'; 
										if ($('input_21').value == '1') { plik='2020'; li1='<span id="lista1"><li>Recto/Verso</li><li>Quadri</li><li>Double DIN long plié (19,8 x 21 cm ouvert)</li></span>'; }
										if ($('input_21').value == '2') { plik='a3'; li1='<span id="lista1"><li>Recto/Verso</li><li>Quadri</li><li>A7 (7,4 x 10,5 cm)</li></span>'; }
										if ($('input_21').value == '3') { plik='a5'; li1='<span id="lista1"><li>Recto/Verso</li><li>Quadri</li><li>A6 (10,5 x 14,8 cm)</li></span>'; }
										if ($('input_21').value == '4') { plik='a4'; li1='<span id="lista1"><li>Recto/Verso</li><li>Quadri</li><li>A6 (10,5 x 14,8 cm)</li></span>'; }
										if ($('input_22').value == '1') { plik='2020'; li1='<span id="lista1"><li>Recto/Verso</li><li>Quadri</li><li>A7 (7,4 x 10,5 cm)</li></span>'; }
										if ($('input_22').value == '2') { plik='a3'; li1='<span id="lista1"><li>Recto/Verso</li><li>Quadri</li><li>A7 (7,4 x 10,5 cm)</li></span>'; }
										if ($('input_22').value == '3') { plik='a5'; li1='<span id="lista1"><li>Recto/Verso</li><li>Quadri</li><li>A6 (10,5 x 14,8 cm)</li></span>'; }
										if ($('input_22').value == '4') { plik='a4'; li1='<span id="lista1"><li>Recto/Verso</li><li>Quadri</li><li>A6 (10,5 x 14,8 cm)</li></span>'; }
										if ($('input_23').value == '1') { plik='2020'; li1='<span id="lista1"><li>Recto</li><li>Quadri</li><li>A7 (7,4 x 10,5 cm)</li></span>'; }
										if ($('input_23').value == '2') { plik='a3'; li1='<span id="lista1"><li>Recto/Verso</li><li>Quadri</li><li>A7 (7,4 x 10,5 cm)</li></span>'; }
										if ($('input_23').value == '3') { plik='a5'; li1='<span id="lista1"><li>Recto</li><li>Quadri</li><li>A6 (10,5 x 14,8 cm)</li></span>'; }
										if ($('input_23').value == '4') { plik='a4'; li1='<span id="lista1"><li>Recto/Verso</li><li>Quadri</li><li>A6 (10,5 x 14,8 cm)</li></span>'; }
										if ($('input_24').value == '1') { plik='2020'; li1='<span id="lista1"><li>Recto</li><li>Quadri</li><li>A7 (7,4 x 10,5 cm)</li></span>'; }
										if ($('input_24').value == '2') { plik='a3'; li1='<span id="lista1"><li>Recto/Verso</li><li>Quadri</li><li>A7 (7,4 x 10,5 cm)</li></span>'; }
										if ($('input_24').value == '3') { plik='a5'; li1='<span id="lista1"><li>Recto</li><li>Quadri</li><li>A6 (10,5 x 14,8 cm)</li></span>'; }
										if ($('input_24').value == '4') { plik='a4'; li1='<span id="lista1"><li>Recto/Verso</li><li>Quadri</li><li>A6 (10,5 x 14,8 cm)</li></span>'; }
