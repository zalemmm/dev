...
//denisedesign
						...
						var preview_info_ul2 = $("preview_info_ul2");
							if ($('input_0').value) {
								...
								preview_name.innerHTML='Dibond :';
								
								var preview_info_title = $("preview_info_title");
								var folder = 'enseignes'; var plik; var nazwa; var li1; var li2; var li3;								
								if ($('input_0').value == 'recto' ) { var nazwa = '3mm'; li1='<span id="lista1"><li>Recto</li></span>'; }
								if ($('input_0').value == 'rectoverso' ) { var nazwa = '3mm'; li1='<span id="lista1"><li>Recto/Verso</li></span>'; }
...
// obrazki 1
								...
								if (term.field==0) {
									imag.style.background="url('http://www.france-banderole.com/wp-content/plugins/fbshop/images/enseignes/dibond.jpg') no-repeat";
								}
...
//							
							...
							var preview_info_title = $("preview_info_title");
								...
								if ($('input_10').value == 'dibond' ) { var nazwa = 'Dibond'; li1='<span id="lista1"><li>Dibond</li></span>'; }
								if (preview_info_title) {
									preview_info_title.innerHTML='';
									preview_info_title.insert(nazwa);
								}
