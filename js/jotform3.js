...
//denisedesign
						...
						if ($('input_1').value) {
							...
							imag.style.background="url(http://france-banderole.com/wp-content/plugins/fbshop/images/"+($('input_1').value)+".png) no-repeat";							
						}	
						if (term.field>=1) {
							var podglad = $("preview");
							...
							if (obecny) { 
								...
								obecny.replace('<li id="lista'+term.field+'">'+mysel.options[mysel.selectedIndex].text+'</li>');
							} else {
								var mysel = $('input_'+term.field);
						...
						if ( (term.field == 3) && ($('input_3').value != 'pas de lamination') ) {
							var preview_info_title2 = $("preview_info_title2");
							if ($('input_3').value == 'pas de lamination') { var optiondename='pas de lamination'; }
							...
							imag2.style.background="url(http://france-banderole.com/wp-content/plugins/fbshop/images/lamination.png) no-repeat";
							preview_info_ul2.innerHTML=''; preview_info_ul2.insert('<li>Lamination</li>');
						}
						
						
						var podglad = $("preview2");
						if ( (term.field == 33) && ($('input_33').value != 'pas de lamination') ) {
							var preview_info_title2 = $("preview_info_title2");
							if ($('input_33').value == 'pas de lamination') { var optiondename='pas de lamination'; }
							if (preview_info_title2) {
								preview_info_title2.innerHTML='';
								preview_info_title2.insert(optiondename);
							}
						...
						var podglad = $("preview3");
						if ( (term.field == 4) && ($('input_4').value != 'Pas de film de pose') ) {
							var preview_info_title3 = $("preview_info_title3");
							if ($('input_4').value == 'Pas de film de pose') { var optiondename='Pas de film de pose'; }
							if (preview_info_title3) {
								preview_info_title3.innerHTML='';
								preview_info_title3.insert(optiondename);
							}
							podglad.style.display="inline-block";
							var imag3 = $("preview_imag3");
							imag3.style.background="url(http://france-banderole.com/wp-content/plugins/fbshop/images/film-pose-facile.png) no-repeat";
							preview_info_ul3.innerHTML=''; preview_info_ul3.insert('<li>Film pose facile</li>');
						}
