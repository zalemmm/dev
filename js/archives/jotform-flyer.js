...
//denisedesign
            ...
            imag.style.backgroundImage="url(../wp-content/plugins/fbshop/images/roll-up/bg.png)";
              ...
              $('container').style.display="none";
							imag2.style.backgroundImage="url(../wp-content/plugins/fbshop/images/flyer/flyerA5.png)";
              ...
              imag5.style.backgroundImage="none";
  					...
  					if ($('input_0').value == 'Depliants') {
							imag2.style.backgroundImage="url(../wp-content/plugins/fbshop/images/flyer/depliantA5.png)";
              ...
              imag5.style.backgroundImage="none";
						...
						/////////////////////grammage//////////
						if (!$('input_1').value == '') {
							imag2.style.backgroundImage="url(../wp-content/plugins/fbshop/images/flyer/grammage.png)";
              ...
              imag5.style.backgroundImage="none";
						...
						/////////////////////format//////////
						if (!$('input_21').value == '') {
							imag2.style.backgroundImage="url(../wp-content/plugins/fbshop/images/flyer/format-papier.png)";
              imag2.style.animation="anim3 .5s 1";
              imag4.style.backgroundImage="none";
              imag5.style.backgroundImage="none";
						}
						if ($('input_21depliant').value == 'Din long') {
							imag2.style.backgroundImage="url(../wp-content/plugins/fbshop/images/flyer/21x21.png)";
              imag2.style.animation="anim3 .5s 1";
              imag4.style.backgroundImage="none";
              imag5.style.backgroundImage="none";
						}
						if ($('input_21depliant').value == 'A3') {
							imag2.style.backgroundImage="url(../wp-content/plugins/fbshop/images/flyer/A3-A4.png)";
              imag2.style.animation="anim3 .5s 1";
              imag4.style.backgroundImage="none";
              imag5.style.backgroundImage="none";
						}
						if ($('input_21depliant').value == 'A4') {
							imag2.style.backgroundImage="url(../wp-content/plugins/fbshop/images/flyer/A4-A5.png)";
              imag2.style.animation="anim3 .5s 1";
              imag4.style.backgroundImage="none";
              imag5.style.backgroundImage="none";
						}
						if ($('input_21depliant').value == 'A4 3 volets') {
							imag2.style.backgroundImage="url(../wp-content/plugins/fbshop/images/flyer/A4-3volets.png)";
              imag2.style.animation="anim3 .5s 1";
              imag4.style.backgroundImage="none";
              imag5.style.backgroundImage="none";
						}
						if ($('input_21depliant').value == 'A5') {
							imag2.style.backgroundImage="url(../wp-content/plugins/fbshop/images/flyer/A5-A6.png)";
              imag2.style.animation="anim3 .5s 1";
              imag4.style.backgroundImage="none";
              imag5.style.backgroundImage="none";
						}
