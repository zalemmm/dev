...
//denisedesign
						...
						if ($('input_1').value) {
							var preview_info_title = $("preview_info_title");
								if ($('input_1').value == 'Flyers 135g' ) { nazwa = 'Flyers 135g'; var ktorawersja = 1;}
								...
								if (term.field==2 || term.field==3) {
									var plik; var nazwa; var li1; var li2; var li3;
									if ( ktorawersja==1 ) {
										var folder = 'flyers_135g'; 
										if ($('input_2').value == '1') { plik='A7_recto-verso'; li1='<span id="lista1"><li>Recto/Verso</li><li>Couché Brillant</li><li>Quadri</li><li>A7 (7,4 x 10 cm)</li></span>'; }
										if ($('input_2').value == '2') { plik='A6_recto-verso'; li1='<span id="lista1"><li>Recto/Verso</li><li>Couché Brillant</li><li>Quadri</li><li>A6 (10,5 x 14,8 cm)</li></span>'; }
										if ($('input_2').value == '3') { plik='A5_recto-verso'; li1='<span id="lista1"><li>Recto/Verso</li><li>Couché Brillant</li><li>Quadri</li><li>A5 (14,8 x 21 cm)</li></span>'; }
										if ($('input_2').value == '4') { plik='A4_recto-verso'; li1='<span id="lista1"><li>Recto/Verso</li><li>Couché Brillant</li><li>Quadri</li><li>A4 (21 x 29,7 cm)</li></span>'; }
										if ($('input_2').value == '5') { plik='DIN_long'; li1='<span id="lista1"><li>Couché Brillant</li><li>Quadri</li><li>DIN long</li><li>(9,8 x 21 cm)</li></span>'; }
