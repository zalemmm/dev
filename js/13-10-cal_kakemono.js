...
if ( ($('input_1').value) && ( ($('input_21').value) || ($('input_22').value) || ($('input_23').value) || ($('input_24').value) || ($('input_25').value) || ($('input_4').value))  && ($('input_6').value) && ($('input_7').value) && ($('input_8').value) && ($('input_9').value) ) {
	var ktorytyp='';
	var ktorapodstawa='';
	var tape='';
	...
	if ( ($('input_1').value == 'Formes') && ($('input_21').value == 'permanent')) {
		ktorytyp='Autocollant (carré/rectangulaire)';
		ktorapodstawa = ($('input_21').value);
				cena = metraz*0.002;
		}
	
	if ( ($('input_1').value == 'Formes') && ($('input_21').value == 'semi-permanent')) {
		ktorytyp='Autocollant (carré/rectangulaire)';
		ktorapodstawa = ($('input_21').value);
				cena = metraz*0.0020;
		}
	
	if ( ($('input_1').value == 'Formes') && ($('input_21').value == 'vinyle micro-perforè M1 dos noir')) {
		ktorytyp='Autocollant (carré/rectangulaire)';
		ktorapodstawa = ($('input_21').value);
				cena = metraz*0.0035;
		}
	
	if ( ($('input_1').value == 'Formes') && ($('input_21').value == 'permanent75μ')) {
		ktorytyp='Autocollant (carré/rectangulaire)';
		ktorapodstawa = ($('input_21').value);
				cena = metraz*0.0055;
		}
	
	if ( ($('input_1').value == 'Formes') && ($('input_21').value == 'vinyle magnètique')) {
		ktorytyp='Autocollant (carré/rectangulaire)';
		ktorapodstawa = ($('input_21').value);
				cena = metraz*0.0055;
		}
	...
	if ( ($('input_1').value == 'predecoupe') && ($('input_22').value == 'permanent') && ($('input_4').value == 'Pas de film de pose') ) {
		ktorytyp='Sticker prédécoupé / Forme personnalisée';
		ktorapodstawa = ($('input_22').value);
		tape = ($('input_4').value);
				cena = metraz*0.0030;
		}
	if ( ($('input_1').value == 'predecoupe') && ($('input_22').value == 'permanent') && ($('input_4').value == 'tape') ) {
		ktorytyp='Sticker prédécoupé / Forme personnalisée';
		ktorapodstawa = ($('input_22').value);
		tape = ($('input_4').value);
				cena = metraz*0.0045;
	...
	if ( ($('input_1').value == 'predecoupe') && ($('input_22').value == 'semi-permanent')  && ($('input_4').value == 'Pas de film de pose') ) {
		ktorytyp='Sticker prédécoupé / Forme personnalisée';
		ktorapodstawa = ($('input_22').value);
		tape = ($('input_4').value);
				cena = metraz*0.0030;
		}
	if ( ($('input_1').value == 'predecoupe') && ($('input_22').value == 'semi-permanent') && ($('input_4').value == 'tape') ) {
		ktorytyp='Sticker prédécoupé / Forme personnalisée';
		ktorapodstawa = ($('input_22').value);
		tape = ($('input_4').value);
				cena = metraz*0.0045;
	...
	if ( ($('input_1').value == 'predecoupe') && ($('input_22').value == 'permanent75μ') && ($('input_4').value == 'Pas de film de pose') ) {
		ktorytyp='Sticker prédécoupé / Forme personnalisée';
		ktorapodstawa = ($('input_22').value);
		tape = ($('input_4').value);
				cena = metraz*0.0065;
		}
	if ( ($('input_1').value == 'predecoupe') && ($('input_22').value == 'permanent75μ')  && ($('input_4').value == 'tape') ) {
		ktorytyp='Sticker prédécoupé / Forme personnalisée';
		ktorapodstawa = ($('input_22').value);
		tape = ($('input_4').value);
				cena = metraz*0.008;
	...
	if ( ($('input_1').value == 'lettrage-blanc') && ($('input_23').value == 'permanent') && ($('input_4').value == 'Pas de film de pose') ) {
		ktorytyp='lettrage blanc prédécoupé';
		ktorapodstawa = ($('input_22').value);
		tape = ($('input_4').value);
				cena = metraz*0.0025;
		}
	if ( ($('input_1').value == 'lettrage-blanc') && ($('input_23').value == 'permanent') && ($('input_4').value == 'tape') ) {
		ktorytyp='Lettrage blanc prédécoupé';
		ktorapodstawa = ($('input_22').value);
		tape = ($('input_4').value);
				cena = metraz*0.004;
	...
	if ( ($('input_1').value == 'lettrage-blanc') && ($('input_23').value == 'semi-permanent')  && ($('input_4').value == 'Pas de film de pose') ) {
		ktorytyp='Lettrage blanc prédécoupé';
		ktorapodstawa = ($('input_22').value);
		tape = ($('input_4').value);
				cena = metraz*0.0025;
		}
	if ( ($('input_1').value == 'lettrage-blanc') && ($('input_23').value == 'semi-permanent')  && ($('input_4').value == 'tape') ) {
		ktorytyp='Lettrage blanc prédécoupé';
		ktorapodstawa = ($('input_22').value);
		tape = ($('input_4').value);
				cena = metraz*0.004;
	...
	if ( ($('input_1').value == 'lettrage-blanc') && ($('input_23').value == 'permanent75μ') && ($('input_4').value == 'Pas de film de pose') ) {
		ktorytyp='Lettrage blanc prédécoupé';
		ktorapodstawa = ($('input_22').value);
		tape = ($('input_4').value);
				cena = metraz*0.006;
		}
	if ( ($('input_1').value == 'lettrage-blanc') && ($('input_23').value == 'permanent75μ')  && ($('input_4').value == 'tape') ) {
		ktorytyp='Lettrage blanc prédécoupé';
		ktorapodstawa = ($('input_22').value);
		tape = ($('input_4').value);
				cena = metraz*0.0075;
	...
	if ( ($('input_1').value == 'lettrage-couleur') && ($('input_24').value == 'permanent')  && ($('input_4').value == 'Pas de film de pose') ) {
		ktorytyp='Lettrage couleur prédécoupé';
		ktorapodstawa = ($('input_22').value);
		tape = ($('input_4').value);
				cena = metraz*0.003;
		}
	if ( ($('input_1').value == 'lettrage-couleur') && ($('input_24').value == 'permanent')  && ($('input_4').value == 'tape') ) {
		ktorytyp='Lettrage couleur prédécoupé';
		ktorapodstawa = ($('input_22').value);
		tape = ($('input_4').value);
				cena = metraz*0.0045;
	...
	if ( ($('input_1').value == 'lettrage-couleur') && ($('input_24').value == 'semi-permanent')  && ($('input_4').value == 'Pas de film de pose') ) {
		ktorytyp='Lettrage couleur prédécoupé';
		ktorapodstawa = ($('input_22').value);
		tape = ($('input_4').value);
				cena = metraz*0.003;
		}
	if ( ($('input_1').value == 'lettrage-couleur') && ($('input_24').value == 'semi-permanent')  && ($('input_4').value == 'tape') ) {
		ktorytyp='Lettrage couleur prédécoupé';
		ktorapodstawa = ($('input_22').value);
		tape = ($('input_4').value);
				cena = metraz*0.0045;
	...
	if ( ($('input_1').value == 'lettrage-couleur') && ($('input_24').value == 'permanent75μ')  && ($('input_4').value == 'Pas de film de pose') ) {
		ktorytyp='Lettrage couleur prédécoupé';
		ktorapodstawa = ($('input_22').value);
		tape = ($('input_4').value);
				cena = metraz*0.0065;
		}
	if ( ($('input_1').value == 'lettrage-couleur') && ($('input_24').value == 'permanent75μ')  && ($('input_4').value == 'tape') ) {
		ktorytyp='Lettrage couleur prédécoupé';
		ktorapodstawa = ($('input_22').value);
		tape = ($('input_4').value);
				cena = metraz*0.008;
	...
	if ( ($('input_1').value == 'covering') && ($('input_25').value == 'permanent75μ') && ($('input_4').value == 'Pas de film de pose') ) {
		ktorytyp='Covering coulé prédécoupé';
		ktorapodstawa = ($('input_22').value);
		tape = ($('input_4').value);
				cena = metraz*0.007;
		}
	if ( ($('input_1').value == 'covering') && ($('input_25').value == 'permanent75μ')  && ($('input_4').value == 'tape') ) {
		ktorytyp='Covering coulé prédécoupé';
		ktorapodstawa = ($('input_22').value);
		tape = ($('input_4').value);
				cena = metraz*0.0085;
...
/* koszty transportu */	
	...
	if (forfait > 0) {
		...
		var dodajkoszyk = document.getElementById("cart_form");
		dodajkoszyk.innerHTML = '<input type="hidden" name="addtocart" value="addtocart" /><input type="hidden" name="rodzaj" value="Vinyles Stickers" /><input type="hidden" name="opis" value="- '+ktorytyp+'<br />- '+ktorapodstawa+'<br />- '+tape+'<br />- '+ktodaje+'<br />- '+szerokosc+' x '+wysokosc+'cm'+cedzik+'<br />- '+ilosc+' exemplaire(s)" /><input type="hidden" name="ilosc" value="'+ilosc+'" /><input type="hidden" name="prix" value="'+cena2+' &euro;" /><input type="hidden" name="option" value="'+option2+'" /><input type="hidden" name="remise" value="-" /><input type="hidden" name="total" value="'+suma2+' &euro;" /><input type="hidden" name="transport" value="'+transport+' &euro;" /><button id="submit_cart" type="submit">Send</button> ';
...
var ax1 = document.getElementById("id_9");
...
if (($('input_0').value == 'recto') || ($('input_0').value == 'rectoverso')) {
	...
	wysokosc = fixstr(wysokosc);
	$('input_9').value = wysokosc;
	metraz = (szerokosc * wysokosc)/10000;
	metraz = fixstr(metraz);
	...
	if ($('input_0').value == 'recto') {
		...
		opis += '<br />- Akilux 3mm recto';	
		dim= metraz2*ilosc;
		np = Math.ceil(dim/dimp);
		p1=np*cppr;
		metragetotal = metraz*ilosc; ////m² du panneau x quantité///
	...
	if ($('input_0').value == 'rectoverso') {
		...
		if((metraz>0.48)&&(metraz<=0.96)){metraz2=0.96}
		if((metraz>0.96)&&(metraz<=1.92)){metraz2=1.92}
		opis += '<br />- Akilux 3mm recto verso';	
		dim= metraz2*ilosc;
		np = Math.ceil(dim/dimp);
		p1=np*cpprv;
		metragetotal = metraz*ilosc; ////m² du panneau x quantité///
	...
	////fixation et maquette///	
	
	if ($('input_4').value == 'oeillets') {fixations=0.7; opis += '<br />- 4 oeillets';}
	if ($('input_4').value == 'crochets'){fixations=0.4; opis += '<br />- 2 crochets';}
	if ($('input_4').value == 'rislans 4') {fixations=0.3; opis += '<br />- 4 rislans';}
	if ($('input_4').value == 'rislans 6') {fixations=0.4; opis += '<br />- 6 rislans';}
	...
	////fin fixation et maquette///
	
	//// coupe ///	
	if (metraz<=0.24){
		if (np<=1){
		if (ilosc<=2){coupe = 0*ilosc}
		if ((ilosc>2) && (ilosc<=4)){coupe = 1*ilosc}
		if (ilosc>4){coupe = 1.5*ilosc}
		}
		if ((np>1) && (np<=2)){
		if (ilosc<=9){coupe = 0.3*ilosc}
		if ((ilosc>9)&& (ilosc<=11)){coupe = 0.70*ilosc}
		if (ilosc>11){coupe = 1*ilosc}
		}
		if ((np>2) && (np<=3)){coupe = 0.5*ilosc} 
		...
		if ((np>31) && (np<=39)){coupe = 0.0*ilosc}
		if ((np>39) && (np<=60)){coupe = 0.10*ilosc}
		if ((np>60) && (np<=74)){coupe = 0.13*ilosc}
		if ((np>74) && (np<=99)){coupe = 0.22*ilosc}
		...
		if ((np>249) && (np<=1000000)){coupe = 0.38*ilosc} 
	}
		if ((metraz>0.24) && (metraz<=0.48)){
		if (np<=1){
		if (ilosc<=2){coupe = 0*ilosc}
		if (ilosc>2){coupe = 1.5*ilosc}
		}
		if ((np>1) && (np<=2)){
		if (ilosc<=5){coupe = 0.3*ilosc}
		if (ilosc>5){coupe = 1.2*ilosc}
		}
		if ((np>2) && (np<=3)){coupe = 0.5*ilosc} 
		if ((np>3) && (np<=4)){coupe = 0.5*ilosc}
		if ((np>4) && (np<=6)){coupe = 0.5*ilosc}
		...
		if ((np>25) && (np<=31)){coupe = 0.10*ilosc}
		if ((np>31) && (np<=39)){coupe = 0.0*ilosc}
		if ((np>39) && (np<=62)){coupe = 0.10*ilosc}
		if ((np>62) && (np<=70)){coupe = 0.03*ilosc}
		if ((np>70) && (np<=74)){coupe = 0.10*ilosc}
		if ((np>74) && (np<=90)){coupe = 0.15*ilosc}
		if ((np>90) && (np<=99)){coupe = 0.22*ilosc}
		if ((np>99) && (np<=112)){coupe = 0.20*ilosc}
		if ((np>112) && (np<=124)){coupe = 0.25*ilosc} 
		if ((np>124) && (np<=125)){coupe = 0.32*ilosc}  
		if ((np>125) && (np<=137)){coupe = 0.35*ilosc} 
	...
	if ((metraz>0.48) && (metraz<=0.96)){
		if (np<=1){
		if (ilosc>1){coupe = 1.5*ilosc}
		}
		if ((np>1) && (np<=2)){
		if (ilosc<=3){coupe = 0.3*ilosc}
		...
		if ((np>137) && (np<=187)){coupe = 0.33*ilosc}
		if ((np>187) && (np<=249)){coupe = 0.35*ilosc}  
		if ((np>249) && (np<=1000000)){coupe = 0.6*ilosc} 
	}
	
	
 	if ((metraz>0.96) && (metraz<=1.92)){
		if (np<=1){coupe = 4.00*ilosc}
	...
	/////FIN coefficient par tranche de plaque/////
	
	/////PRIX/////
	
	option = (fixations+rainage)*ilosc
...
var rodzaj = "Akilux 3mm";
	...
	dodajkoszyk.innerHTML = '<input type="hidden" name="addtocart" value="addtocart" /><input type="hidden" name="rodzaj" value="'+rodzaj+'" /><input type="hidden" name="opis" value="'+opis+etiqdesc+'</br>- '+szerokosc+' x '+wysokosc+' cm" /><input type="hidden" name="ilosc" value="'+ilosc+'" /><input type="hidden" name="prix" value="'+cena2+' &euro;" /><input type="hidden" name="option" value="'+option2+'" /><input type="hidden" name="remise" value="-" /><input type="hidden" name="total" value="'+suma2+' &euro;" /><input type="hidden" name="transport" value="'+transport+' &euro;" /><button id="submit_cart" type="submit">Send</button> ';
...
if (($('input_0').value == 'recto') || ($('input_0').value == 'rectoverso')) {
	...
	///fixations et maquette///
	if ($('input_4').value == 'oeillets'){fixations=0.6; opis += '<br />- 4 oeillets';}
	if ($('input_4').value == 'crochets'){fixations=0.4; opis += '<br />- 2 crochets';}
	if ($('input_4').value == 'rislans 4'){fixations=0.3; opis += '<br />- 4 rislans';}
	if ($('input_4').value == 'rislans 6') {fixations=0.4; opis += '<br />- 6 rislans';}
	if ($('input_4').value == 'double face'){fixations=0.3; opis += '<br />- double face';}
	...
	if (metraz<=0.24){
		if (np<=1){
		if (ilosc<=1){coupe = -8*ilosc}
		if ((ilosc>1) && (ilosc<=2)){coupe = -1.5*ilosc}
		if ((ilosc>2) && (ilosc<=3)){coupe = -0.5*ilosc}
		if ((ilosc>3) && (ilosc<=4)){coupe = -0.2*ilosc}
		if (ilosc>4){coupe = 1*ilosc}
		}
		if ((np>1) && (np<=2)){
		if (ilosc<=9){coupe = 0.3*ilosc}
		if ((ilosc>9)&& (ilosc<=10)){coupe = 0.2*ilosc}
		if (ilosc>10){coupe = 1*ilosc}
		}
		if ((np>2) && (np<=3)){coupe = 0.5*ilosc} 
		if ((np>3) && (np<=4)){coupe = 0.5*ilosc}
		if ((np>4) && (np<=6)){coupe = 0.5*ilosc}
		if ((np>6) && (np<=7)){coupe = 0.25*ilosc}
		if ((np>7) && (np<=8)){coupe = 0.4*ilosc}
		if ((np>8) && (np<=9)){coupe = 0.5*ilosc}
		if ((np>9) && (np<=16)){coupe = 0.4*ilosc}
		if ((np>16) && (np<=17)){coupe = 0.38*ilosc}
		if ((np>17) && (np<=18)){coupe = 0.42*ilosc}
		if ((np>18) && (np<=21)){coupe = 0.35*ilosc}
		if ((np>21) && (np<=22)){coupe = 0.29*ilosc}
		if ((np>22) && (np<=24)){coupe = 0.24*ilosc}
		if ((np>24) && (np<=25)){coupe = 0.08*ilosc}
		if ((np>25) && (np<=31)){coupe = 0.05*ilosc}
		if ((np>31) && (np<=99)){coupe = 0.0*ilosc}
		if ((np>39) && (np<=60)){coupe = 0.10*ilosc}
		if ((np>60) && (np<=74)){coupe = 0.13*ilosc}
		if ((np>74) && (np<=99)){coupe = 0.22*ilosc}
		if ((np>99) && (np<=112)){coupe = 0.20*ilosc}
		...
		if ((ilosc>1)&&(ilosc<=2)){coupe = -2*ilosc}
		if (ilosc>2){coupe = 0.5*ilosc}
		}
		if ((np>1) && (np<=2)){
		if (ilosc<=5){coupe = 0.0*ilosc}
		if (ilosc>5){coupe = 0.5*ilosc}
		}
		if ((np>2) && (np<=3)){coupe = 0.3*ilosc} 
		if ((np>3) && (np<=4)){coupe = 0.5*ilosc}
		if ((np>4) && (np<=6)){coupe = 0.5*ilosc}
		if ((np>6) && (np<=7)){coupe = 0.25*ilosc}
		if ((np>7) && (np<=8)){coupe = 0.2*ilosc}
		if ((np>8) && (np<=9)){coupe = 0.3*ilosc}
		if ((np>9) && (np<=16)){coupe = 0.25*ilosc}
		if ((np>16) && (np<=17)){coupe = 0.38*ilosc}
		if ((np>17) && (np<=18)){coupe = 0.42*ilosc}
		if ((np>18) && (np<=21)){coupe = 0.28*ilosc}
		if ((np>21) && (np<=22)){coupe = 0.25*ilosc}
		if ((np>22) && (np<=24)){coupe = 0.20*ilosc}
		if ((np>24) && (np<=25)){coupe = 0.15*ilosc}
		if ((np>25) && (np<=31)){coupe = 0.10*ilosc}
		if ((np>31) && (np<=39)){coupe = 0.0*ilosc}
		if ((np>39) && (np<=62)){coupe = 0.10*ilosc}
		if ((np>62) && (np<=70)){coupe = 0.00*ilosc}
		if ((np>70) && (np<=74)){coupe = 0.00*ilosc}
		if ((np>74) && (np<=90)){coupe = 0.12*ilosc}
		if ((np>90) && (np<=99)){coupe = 0.22*ilosc}
		if ((np>99) && (np<=112)){coupe = 0.20*ilosc}
		if ((np>112) && (np<=124)){coupe = 0.25*ilosc} 
		if ((np>124) && (np<=125)){coupe = 0.32*ilosc}  
		...
		if ((np>137) && (np<=187)){coupe = 0.33*ilosc}
		if ((np>187) && (np<=249)){coupe = 0.35*ilosc}  
		if ((np>249) && (np<=1000000)){coupe = 0.45*ilosc} 
	}
	...
	if (np <= 1) {p2=p1*8;}
	if ((np > 1) && (np <= 2)) {p2=p1*5.5;}
	if ((np > 2) && (np <= 3)) {p2=p1*4.8;}
	if ((np > 3) && (np <= 4)) {p2=p1*4.3;}
	if ((np > 4) && (np <= 5)) {p2=p1*4.1;}
	if ((np > 5) && (np <= 6)) {p2=p1*3.8;}
	if ((np > 6) && (np <= 7)) {p2=p1*3.8;}
	if ((np > 7) && (np <= 8)) {p2=p1*3.0;}
	if ((np > 8) && (np <= 9)) {p2=p1*2.7;}
	if ((np > 9) && (np <= 10)) {p2=p1*3.0;}
	if ((np > 10) && (np <= 11)) {p2=p1*2.9;}
	if ((np > 11) && (np <= 12)) {p2=p1*2.8;}
	if ((np > 12) && (np <= 13)) {p2=p1*2.8;}
	...
	if ((np > 140) && (np <= 200)) {p2=p1*1.70;}
	if ((np > 200) && (np <= 999)) {p2=p1*1.60;}
	if ((np > 999) && (np <= 100000000000)) {p2=p1*1.6;}
...
if (($('input_0').value == 'recto') || ($('input_0').value == 'rectoverso')) {
	...
	if ($('input_0').value == 'recto') {
		...
		p1=np*cppr;
		metragetotal = metraz*ilosc; ////m² du panneau x quantité///
		poidstotal = metragetotal*0.90;	//// m² total x grammage///	
...
//// coupe ///	
	...
	if (metraz<=0.24){
		...
		if ((np>4) && (np<=6)){coupe = 0.5*ilosc}
		if ((np>6) && (np<=7)){coupe = 0.25*ilosc}
		if ((np>7) && (np<=8)){coupe = 0.0*ilosc}
		if ((np>8) && (np<=9)){coupe = 0.0*ilosc}
		if ((np>9) && (np<=16)){coupe = 0.4*ilosc}
		if ((np>16) && (np<=17)){coupe = 0.38*ilosc}
		if ((np>17) && (np<=18)){coupe = 0.42*ilosc}
		if ((np>18) && (np<=21)){coupe = 0.35*ilosc}
		...
		if ((metraz>0.24) && (metraz<=0.48)){
		if (np<=1){
		if (ilosc==1){coupe = -14*ilosc}
		if (ilosc==2){coupe = -5*ilosc}
		if (ilosc==3){coupe = -2*ilosc}
		if (ilosc==4){coupe = -1*ilosc}
		}
		if ((np>1) && (np<=2)){
		if (ilosc==5){coupe = -1*ilosc}
		if (ilosc==6){coupe = -0.5*ilosc}
		if (ilosc==7){coupe = -0.2*ilosc}
		if (ilosc==8){coupe = -0.1*ilosc}
		}
		if ((np>2) && (np<=3)){coupe = 0.0*ilosc} 
		if ((np>3) && (np<=4)){coupe = 0.5*ilosc}
		if ((np>4) && (np<=6)){coupe = 0.5*ilosc}
		if ((np>6) && (np<=7)){coupe = 0.25*ilosc}
		if ((np>7) && (np<=8)){coupe = 0.0*ilosc}
		if ((np>8) && (np<=9)){coupe = 0.3*ilosc}
		if ((np>9) && (np<=16)){coupe = 0.0*ilosc}
		if ((np>16) && (np<=17)){coupe = 0.38*ilosc}
		if ((np>17) && (np<=18)){coupe = 0.25*ilosc}
		if ((np>18) && (np<=21)){coupe = 0.0*ilosc}
		if ((np>21) && (np<=22)){coupe = 0.0*ilosc}
		if ((np>22) && (np<=24)){coupe = 0.0*ilosc}
		if ((np>24) && (np<=25)){coupe = 0.0*ilosc}
		if ((np>25) && (np<=31)){coupe = 0.0*ilosc}
		if ((np>31) && (np<=39)){coupe = 0.0*ilosc}
		if ((np>39) && (np<=62)){coupe = 0.00*ilosc}
		if ((np>62) && (np<=70)){coupe = 0.00*ilosc}
		if ((np>70) && (np<=74)){coupe = 0.00*ilosc}
		if ((np>74) && (np<=90)){coupe = 0.0*ilosc}
		if ((np>90) && (np<=99)){coupe = 0.0*ilosc}
		if ((np>99) && (np<=112)){coupe = 0.0*ilosc}
		if ((np>112) && (np<=124)){coupe = 0.0*ilosc} 
		if ((np>124) && (np<=125)){coupe = 0.25*ilosc}  
		if ((np>125) && (np<=137)){coupe = 0.35*ilosc} 
		if ((np>137) && (np<=187)){coupe = 0.33*ilosc}
		if ((np>187) && (np<=249)){coupe = 0.35*ilosc}  
		if ((np>249) && (np<=1000000)){coupe = 0.45*ilosc} 
	...
	if ((metraz>0.48) && (metraz<=0.96)){
		if (np<=1){
		if (ilosc==1){coupe = -14*ilosc}
		if (ilosc==2){coupe = -2*ilosc}
		}
		if ((np>1) && (np<=2)){
		if (ilosc==3){coupe = -2*ilosc}
		if (ilosc==4){coupe = 0*ilosc}
		}
		if ((np>2) && (np<=3)){coupe = 0.0*ilosc} 
		if ((np>3) && (np<=4)){coupe = 0.5*ilosc}
		if ((np>4) && (np<=6)){coupe = 0.5*ilosc}
		...
		if ((np>24) && (np<=25)){coupe = 0.0*ilosc}
		if ((np>25) && (np<=31)){coupe = 0.0*ilosc}
		if ((np>31) && (np<=39)){coupe = 0.20*ilosc}
		if ((np>39) && (np<=62)){coupe = 0.0*ilosc}
		if ((np>62) && (np<=70)){coupe = 0.03*ilosc}
		if ((np>70) && (np<=74)){coupe = 0.10*ilosc}
		if ((np>74) && (np<=90)){coupe = 0.26*ilosc}
		if ((np>90) && (np<=99)){coupe = 0.25*ilosc}
	...
	/////coefficient par tranche de plaque/////
	if (np <= 1) {p2=p1*7;}
	if ((np > 1) && (np <= 2)) {p2=p1*4.5;}
	if ((np > 2) && (np <= 3)) {p2=p1*4.0;}
	if ((np > 3) && (np <= 4)) {p2=p1*3.5;}
	if ((np > 4) && (np <= 5)) {p2=p1*3.3;}
	if ((np > 5) && (np <= 6)) {p2=p1*3.2;}
	if ((np > 6) && (np <= 7)) {p2=p1*3.2;}
	if ((np > 7) && (np <= 8)) {p2=p1*3.0;}
	if ((np > 8) && (np <= 9)) {p2=p1*2.8;}
	if ((np > 9) && (np <= 10)) {p2=p1*2.8;}
	if ((np > 10) && (np <= 11)) {p2=p1*2.8;}
	if ((np > 11) && (np <= 12)) {p2=p1*2.8;}
	if ((np > 12) && (np <= 13)) {p2=p1*2.8;}
	if ((np > 13) && (np <= 14)) {p2=p1*2.8;}
	if ((np > 14) && (np <= 15)) {p2=p1*2.8;}
	if ((np > 15) && (np <= 17)) {p2=p1*2.8;}
	if ((np > 17) && (np <= 24)) {p2=p1*2.6;}
	if ((np > 24) && (np <= 25)) {p2=p1*2.55;}
	if ((np > 25) && (np <= 27)) {p2=p1*2.45;}
	if ((np > 27) && (np <= 29)) {p2=p1*2.5;}
	if ((np > 29) && (np <= 34)) {p2=p1*2.4;}
	if ((np > 34) && (np <= 35)) {p2=p1*2.3;}
	if ((np > 35) && (np <= 39)) {p2=p1*2.25;}
	if ((np > 39) && (np <= 44)) {p2=p1*2.18;}
	if ((np > 44) && (np <= 49)) {p2=p1*2.16;}
	if ((np > 49) && (np <= 51)) {p2=p1*2.05;}
	if ((np > 51) && (np <= 53)) {p2=p1*2.00;}
	if ((np > 53) && (np <= 74)) {p2=p1*2.02;}
	if ((np > 74) && (np <= 99)) {p2=p1*1.80;}
	if ((np > 99) && (np <= 120)) {p2=p1*1.75;}
	if ((np > 120) && (np <= 140)) {p2=p1*1.70;}
	if ((np > 140) && (np <= 199)) {p2=p1*1.60;}
	if ((np > 199) && (np <= 249)) {p2=p1*1.57;}
	if ((np > 249) && (np <= 299)) {p2=p1*1.54;}
	if ((np > 299) && (np <= 999)) {p2=p1*1.50;}
	if ((np > 999) && (np <= 100000000000)) {p2=p1*1.50;}
