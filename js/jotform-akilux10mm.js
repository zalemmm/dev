...
//denisedesign
						...
						var preview_info_ul2 = $("preview_info_ul2");
							if ($('input_0').value) {
								...
								preview_name.innerHTML='Akilux :';
								
								var preview_info_title = $("preview_info_title");
								var folder = 'enseignes'; var plik; var nazwa; var li1; var li2; var li3;								
								if ($('input_0').value == 'recto' ) { var nazwa = ' 10mm '; li1='<span id="lista1"><li>Recto</li></span>'; }
								if ($('input_0').value == 'rectoverso' ) { var nazwa = ' 10mm '; li1='<span id="lista1"><li>Recto/Verso</li></span>'; }
...
// obrazki 1
								...
								if (term.field==0) {
									imag.style.background="url('http://www.france-banderole.com/wp-content/plugins/fbshop/images/panneau/akilux-10mm-2.jpg') no-repeat";
								}
