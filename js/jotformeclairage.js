...
//denisedesign
						...
						if ($('input_1').value) {
							var preview_info_title = $("preview_info_title");
								if ($('input_1').value == '130-200cm' ) { nazwa = '130 à 200cm'; var ktorawersja = 1;}
								if ($('input_1').value == '201-300cm' ) { nazwa = '201 à 300cm';  var ktorawersja = 2; }
								if ($('input_1').value == '300-399cm' ) { nazwa = '300 à 399cm';  var ktorawersja = 3; }
								if ($('input_1').value == '400-499cm' ) { nazwa = '400 à 499cm';  var ktorawersja = 4; }
								if ($('input_1').value == '500-599cm' ) { nazwa = '500 à 599cm';  var ktorawersja = 5; }
								if ($('input_1').value == '600-699cm' ) { nazwa = '600 à 699cm';  var ktorawersja = 6; }
								...
								if (term.field==21|| term.field==22|| term.field==23|| term.field==3|| term.field==4) {
									...
									if ( ktorawersja==1 || ktorawersja==2 || ktorawersja==3|| ktorawersja==4|| ktorawersja==5|| ktorawersja==6|| ktorawersja==7|| ktorawersja==8) {
										...
										if ($('input_21').value == '1') { plik='carte_recto'; li1='<span id="lista1"><li>Recto</li><li>Quadri</li><li>85 mm x 54 mm</li></span>'; }
										if ($('input_21').value == '2') { plik='carte_recto-verso'; li1='<span id="lista1"><li>Recto/Verso</li><li>Quadri</li><li>85 mm x 54 mm</li></span>'; }


										if ($('input_22').value == '1') { plik='carte_recto'; li1='<span id="lista1"><li>Recto</li><li>Quadri</li><li>85 mm x 54 mm</li></span>'; }
										if ($('input_22').value == '2') { plik='carte_recto-verso'; li1='<span id="lista1"><li>Recto/Verso</li><li>Quadri</li><li>85 mm x 54 mm</li></span>'; }

										if ($('input_23').value == '1') { plik='carte_recto'; li1='<span id="lista1"><li>Recto</li><li>Quadri</li><li>85 mm x 54 mm</li></span>'; }
										if ($('input_23').value == '2') { plik='carte_recto-verso'; li1='<span id="lista1"><li>Recto/Verso</li><li>Quadri</li><li>85 mm x 54 mm</li></span>'; }



										if ($('input_3').value == '1') { li2='<span id="lista2"><li>Couché Brillant</li></span>'; }
										if ($('input_3').value == '2') { li2='<span id="lista2"><li>Satiné</li></span>'; }
										if ($('input_3').value == '3') { li2='<span id="lista2"><li>Mat</li></span>'; }


									}
									var imag = $("preview_imag");
									imag.src="url(https://www.france-banderole.com/wp-content/plugins/fbshop/images/"+folder+"/"+plik+".png)";
