...
//denisedesign
						...
						if ($('input_1').value) {
							var preview_info_title = $("preview_info_title");
								if ($('input_1').value == 'Cartes 350g' ) { nazwa = 'Cartes 350g'; var ktorawersja = 1;}
								if ($('input_1').value == 'Cartes 270µ' ) { nazwa = 'Cartes 270µ';  var ktorawersja = 2; }
								if ($('input_1').value == 'Cartes 350µ' ) { nazwa = 'Cartes 350µ';  var ktorawersja = 3; }
