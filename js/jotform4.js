...
// obrazki 1
								var folder = ''; var plik;
								if ($('input_1').value == 'extérieur' ) { folder='ext'; }
								if ($('input_1').value == 'interieur' ) { folder='int'; }
								if ($('input_1').value == 'int/ext' ) { folder='intext'; }
								var imag = $("preview_imag");
								var podglad = $("preview");
								podglad.style.visibility="visible";
								if (term.field==1) {
									imag.style.background="url('http://france-banderole.com/wp-content/plugins/fbshop/images/"+folder+"/pas.png') no-repeat";
								}
							if (term.field==6 || term.field==7 || term.field==81 || term.field==8) {
								if ($('input_'+term.field).value == 'oeillets/mètres') { plik = 'oeme'; }
								if ($('input_'+term.field).value == 'nouettes/mètres') { plik = 'oeme'; }
								if ($('input_'+term.field).value == 'oeillets+ourlets de renforts') { plik = 'oeouren'; }
								if ($('input_'+term.field).value == 'ourlet de renfort périmétrique') { plik = 'oeourenper'; }
								if ($('input_'+term.field).value == 'oeillets+ourlets de renforts+fourreaux G/D') { plik = 'fougd'; }
								if ($('input_'+term.field).value == 'fourreaux G/D') { plik = 'fougd'; }
								if ($('input_'+term.field).value == 'fourreaux H/B+oeillets') { plik = 'fouhb'; }
								if ($('input_'+term.field).value == 'pas de finition') { plik = 'pas'; }
								imag.style.background="url('http://france-banderole.com/wp-content/plugins/fbshop/images/"+folder+"/"+plik+".png') no-repeat";
							}							
// //obrazki

						}	
						if ( (term.field>1) && (term.field<9) ) {							
							var wartoscpola = '';
							var obecny1 = $("iden1");
							var obecny2 = $("iden2");
							if ( (term.field == 3) || (term.field == 4) || (term.field ==5)) {
								if (obecny1) {
									var mysel = $('input_'+term.field);
									if (mysel.options[mysel.selectedIndex].text != 'choisir...') {
										if (mysel.options[mysel.selectedIndex].text == 'bache 440g') { wartoscpola = '<li>Bâche PVC laminée évenementielle extérieur. Blanc mat, semi opaque, prix discount</li>'; }
										if (mysel.options[mysel.selectedIndex].text == 'bache 560g') { wartoscpola = '<li>Bâche PVC enduite extérieur. Blanc mat, semi opaque. Rapport qualité/prix idéal.</li>'; }
										if (mysel.options[mysel.selectedIndex].text == 'bache 510g OP M1') { wartoscpola = '<li>Bâche PVC intérieur / extérieur très résistante anti-feu. Blanc mat. Rendu opaque. Recto verso possible</li>'; }
										if (mysel.options[mysel.selectedIndex].text == 'bache 520g M2/B1') { wartoscpola = '<li>Bâche PVC enduite intérieur / extérieur résistance anti-feu. Blanc satiné. Rendu semi opaque, pré-contraint.</li>'; }
										if (mysel.options[mysel.selectedIndex].text == 'bache 680g M2/B1') { wartoscpola = '<li>PVC enduite Durapack intérieur / extérieur très résistante anti-feu. Blanc satiné. Rendu opaque. Recto verso possible</li>'; }
										if (mysel.options[mysel.selectedIndex].text == 'bache 680g M2/B1 recto verso') { wartoscpola = '<li>PVC enduite Durapack intérieur / extérieur très résistante anti-feu. Blanc satiné. Rendu opaque. Recto verso possible</li>'; }
										if (mysel.options[mysel.selectedIndex].text == 'bache micro perforée M1/B1') { wartoscpola = '<li>Bâche intérieur / extérieur légère et anti-feu. Idéal grand vents ou vitrophanie (laisse rentrée la lumière tout en habillant vos vitrines).</li>'; }
										if (mysel.options[mysel.selectedIndex].text == 'bache 100% écologique M1') { wartoscpola = '<li>Bâche écologique anti feu M1 300g/m², 100% polyester, aspect tissu blanc satiné</li>'; }
										obecny1.replace('<span id="iden1"><li style="list-style-type:disc;">'+mysel.options[mysel.selectedIndex].text+'</li>'+wartoscpola+'</span>');
									}
								}
							}
							if ( (term.field == 6) || (term.field == 7) || (term.field == 81) || (term.field ==8)) {
								if (obecny2) {
									var mysel = $('input_'+term.field);
									if (mysel.options[mysel.selectedIndex].text != 'choisir...') {
										obecny2.replace('<li id="iden2" style="list-style-type:disc;">'+mysel.options[mysel.selectedIndex].text+'</li>');
									}
								} 
							}
						}
// option de finition						
						var podglad = $("preview2");
						if ( ((term.field == 9) && ($('input_9').value != 'pas d’option de finition')) || ((term.field == 91) && ($('input_91').value != 'pas d’option de finition')) ) {
							var preview_info_title2 = $("preview_info_title2");
							if ($('input_9').value == 'oeillets supplémentaires tous les 50 cm') { var optiondename='50 cm'; var obraz2='50cm'; }
							if ($('input_9').value == 'oeillets supplémentaires tous les 25 cm') { var optiondename='25 cm'; var obraz2='25cm'; }
							if ($('input_91').value == 'oeillets supplémentaires tous les 50 cm') { var optiondename='50 cm'; var obraz2='50cm'; }
							if ($('input_91').value == 'oeillets supplémentaires tous les 25 cm') { var optiondename='25 cm'; var obraz2='25cm'; }
							if ($('input_91').value == 'nouettes supplémentaires tous les 50 cm') { var optiondename='50 cm'; var obraz2='50cm'; }
							if ($('input_91').value == 'nouettes supplémentaires tous les 25 cm') { var optiondename='25 cm'; var obraz2='25cm'; }
							if (preview_info_title2) {
								preview_info_title2.innerHTML='';
								preview_info_title2.insert(optiondename);
							}
							podglad.style.display="inline-block";
							var imag2 = $("preview_imag2");
							imag2.style.background="url('http://france-banderole.com/wp-content/plugins/fbshop/images/"+obraz2+".png') no-repeat";
							preview_info_ul2.innerHTML=''; preview_info_ul2.insert('<li>'+$('input_9').value+'</li>');
						}
						if ($('input_9').value == 'pas d’option de finition') { podglad.style.display="none"; }
						if ($('input_91').value == 'pas d’option de finition') { podglad.style.display="none"; }
						
					

// fixation
						var podglad3 = $("preview3");
						if ( ( (term.field == 10) && ($('input_10').value != 'pas de fixation') ) || ( (term.field == 101) && ($('input_101').value != 'pas de fixation') ) || ((term.field == 11) && ($('input_11').value != 'pas de fixation')) ) {
							var preview_info_title3 = $("preview_info_title3");
							if ($('input_'+term.field).value == 'tendeurs H/B tous les mètres') { var optiondename2='tendeurs H/B'; var obraz3='tenderhb'; }
							if ($('input_'+term.field).value == '2 tourillons bois et sandows') { var optiondename2='2 tourillons'; var obraz3='tourillons'; }
							if ($('input_'+term.field).value == '2 piquets de bois') { var optiondename2='2 piquets'; var obraz3='piquets'; }
							if ($('input_'+term.field).value == 'drisse périmétrique') { var optiondename2='drisse'; var obraz3='drissep'; }
							if ($('input_'+term.field).value == 'drisse fourreaux H/B') { var optiondename2='drisse H/B'; var obraz3='drisse'; }
							if (preview_info_title3) {
								preview_info_title3.innerHTML='';
								preview_info_title3.insert(optiondename2);
							}
							podglad3.style.display="inline-block";
							var imag3 = $("preview_imag3");
							imag3.style.background="url('http://france-banderole.com/wp-content/plugins/fbshop/images/fixation/"+obraz3+".png') no-repeat";
							preview_info_ul3.innerHTML=''; preview_info_ul3.insert('<li>'+$('input_10').value+$('input_11').value+$('input_101').value+'</li>');
						}
						if (($('input_11').value == 'pas de fixation') || ($('input_101').value == 'pas de fixation') || ($('input_10').value == 'pas d’option de finition')) { podglad3.style.display="none"; }

						if (term.field == 12) {
							var obecny12 = $("maq");
							if (obecny12) {
								var mysel = $('input_'+term.field);
								obecny12.replace('<span id="maq"><li id="lista'+term.field+'">'+mysel.options[mysel.selectedIndex].text+'</li></span>');						
							} else {
								var mysel = $('input_'+term.field);
								preview_info_ul.insert('<span id="maq"><li id="lista'+term.field+'">'+mysel.options[mysel.selectedIndex].text+'</li></span>');						
							}
						}
						}
