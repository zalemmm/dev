                     ...
                     if(JotForm.checkValueByOperator(term.operator, term.value, value)){
						...
						var preview_info_ul2 = $("preview_info_ul2");
							if ($('input_0').value) {
								...
								if ($('input_0').value == 'recto' ) { var nazwa = '1mm'; li1='<span id="lista1"><li>Recto</li></span>'; }
								if ($('input_0').value == 'rectoverso' ) { var nazwa = '1mm'; li1='<span id="lista1"><li>Recto/Verso</li></span>'; }
