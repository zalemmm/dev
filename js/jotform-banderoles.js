    ...
    handleAutoCompletes: function( ) {
        ...
        $H( JotForm.autoCompletes )
            .each( function( pair ) {
                ...
                var list = new Element('div', { className: 'form-autocomplete-list' }).setStyle({
                    listStyle: 'none',
                ...
                el.observe( 'keyup', function( e ) {
                    ...
                    if ( matches.length > 0 ) {
                        ...
                        list.setStyle({
                            height: ( liHeight * ( ( matches.length > 9 )
                                ? 10
                                : matches.length ) + 4 ) + 'px',
                            overflow: 'auto',
                        });
    ...
    prePopulations: function( ) {
        $H( document.get )
            .each( function( pair ) {
                ...
                $$('.form-checkbox%s, .form-radio%s'.replace( /\%s/gim, n ))
                    .each( function( input ) {
                    ...
                    $H( res.result )
                        .each( function( pair ) {
                            ...
                            switch ( question.type ) {
                                ...
                                case "control_scale":
                                case "control_radio":
                                    var radios = document.getElementsByName("q" + qid + "_" + ( ( question.type == "control_radio" )
                                        ? question.name
                                        : qid ));
                ...
                switch (JotForm.getInputType( term.field )) {
                    ...
                    case "radio":
                        ...
                        if ([ 'isEmpty', 'isFilled', ].include( term.operator )) {
                            var filled = $$( '#id_' + term.field + ' input' ).collect( function( e ) {
                                return e.checked;
                            }).any( );
                ...
                .each( function( condition ) {
                    ...
                    if ( condition.type == 'field' ) {
                        ...
                        $A( condition.terms )
                            .each( function( term ) {
                                var id = term.field;
                                var nextButton = JotForm
                                    .getSection($( 'id_' + id ))
                                    .select( '.form-pagebreak-next' )[ 0 ];
                                if ( !nextButton ) {
                                    return;
                                }
 ...
 */
    highLightLines: function( ) {
        ...
        $$( '.form-line' )
            .each( function( l, i ) {
                l
                    .select( 'input, select, textarea, div, table div' )
                    .each( function( i ) {
                        i
            ...
            .each( function( item ) {
                item
                    .observe( 'blur', function( ) {
                        var id = item
                            .id
                            .replace( /input_(\d+)_\d+/, "$1" );
                        var total = 0;

                        $( "grade_error_" + id ).innerHTML = "";

                        $( item.parentNode.parentNode )
                            .select( ".form-grading-input" )
    ...
    handlePages: function( ) {
        ...
        $$( '.form-pagebreak' ).each( function( page, i ) {
            ...
            section
                ...
                .invoke( 'observe', 'click', function( ) { // When next button clicked
                    if (JotForm.validateAll(JotForm.getForm( section ))) {

                        if ( JotForm.nextPage ) {
                            JotForm
                                .backStack
                                .push(section.hide( )); // Hide current
                            JotForm
                                .nextPage
                                .show( );
            ...
            section
                ...
                .invoke( 'observe', 'click', function( ) { // When back button clicked
                ...
                .observe( 'click', function( ) {
                    ...
                    if ( section.closed ) {
                        ...
                        if ( openBar && openBar != section && openCount <= 1 ) {
                            ...
                            openBar.shift({ height: 60, duration: 0.5, });
                            openBar
                                .select( '.form-collapse-right-show' )
                                .each( function( e ) {
                                    e
                                        .addClassName( 'form-collapse-right-hide' )
                                        .removeClassName( 'form-collapse-right-show' );
                                });
                            openBar.closed = true;
                        }
                        openBar = section;
                        ...
                        section
                            .select( '.form-collapse-right-hide' )
                            .each( function( e ) {
                                e
                                    .addClassName( 'form-collapse-right-show' )
                                    .removeClassName( 'form-collapse-right-hide' );
                            });
 ...
 */
    description: function( input, message ) {
        ...
        var buble = new Element('div', { className: 'form-description' });
 ...
 */
    errored: function( input, message ) {
        ...
        if (JotForm.isCollapsed( input )) {
            ...
            if ( !collapse.errored ) {
                collapse
                    ...
                    .insert({ top: '<img src="//www.france-banderole.com/wp-content/themes/fb/images/exclamation-octagon.png" align="bottom" style="margin-right:5px;"> ' })
                    .setStyle({ color: 'red' });
        ...
        container.insert(new Element('div', { className: 'form-error-message' }).insert( '<img src="//www.france-banderole.com/wp-content/themes/fb/images/exclamation-octagon.png" align="left" style="margin-right:5px;"> ' + message ));
            ...
            $$( '*[class*="validate"]' ).each( function( input ) {
                ...
                input.validateInput = function( ) {
                    ...
                    if (( input.readAttribute( 'type' ) == "password" ) && ( input.readAttribute( 'id' ) == 'input_4' )) {
                        var pass1 = $( 'input_3' );
                        var pass2 = $( 'input_4' );
                        if ( $( pass1 ).value == $( pass2 ).value ) {} else {
                            return JotForm.errored( input, "Please retype password correctly!" );
                        }
                    }
