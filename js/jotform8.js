...
//denisedesign
				if(JotForm.checkValueByOperator(term.operator, term.value, value)){
					...
					if ($('input_0').value == 'affiches') {
						if ($('input_1').value) {
							var preview_info_title = $("preview_info_title");
								var folder = 'affiches'; var plik; var nazwa; var li1; var li2; var li3;
								var nazwa = 'affiche';
								if ($('input_1').value == '1' ) { li1='<span id="lista1"><li>Quadri Recto</li><li>CB. 135g</li><li>Coupe</li><li>17 x 50 cm</li></span>'; }
								if ($('input_1').value == '2' ) { li1='<span id="lista1"><li>Quadri Recto</li><li>CB. 135g</li><li>Coupe</li><li>A4 (21 x 29.7 cm)</li></span>'; }
								if ($('input_1').value == '3' ) { li1='<span id="lista1"><li>Quadri Recto</li><li>CB. 135g</li><li>Coupe</li><li>A3 (29.7 x 42 cm)</li></span>'; }
								if ($('input_1').value == '4' ) { li1='<span id="lista1"><li>Quadri Recto</li><li>CB. 135g</li><li>Coupe</li><li>35 X 50 cm</li></span>'; }
								if ($('input_1').value == '5' ) { li1='<span id="lista1"><li>Quadri Recto</li><li>CB. 135g</li><li>Coupe</li><li>A2 (40 x 60 cm)</li></span>'; }
								if ($('input_1').value == '6' ) { li1='<span id="lista1"><li>Quadri Recto</li><li>CB. 135g</li><li>Coupe</li><li>50 x 70 cm</li></span>'; }
								if ($('input_1').value == '7' ) { li1='<span id="lista1"><li>Quadri Recto</li><li>CB. 135g</li><li>Coupe</li><li>A1 (60 x 80 cm)</li></span>'; }
								if ($('input_1').value == '8' ) { li1='<span id="lista1"><li>Quadri Recto</li><li>CB. 135g</li><li>Coupe</li><li>70 x 100 cm</li></span>'; }
...
// obrazki 1
								...
								if (term.field==1) {
									imag.style.background="url('https://www.france-banderole.com/wp-content/plugins/fbshop/images/"+folder+"/"+$('input_1').value+".png') no-repeat";
								}
								var obecny1 = $("lista1");
								if (obecny1) {
									obecny1.replace(li1);
					...
					if ($('input_0').value == 'cartes') {
						if ($('input_12').value) {
							var preview_info_title = $("preview_info_title");
								var folder = 'cartes'; var plik; var nazwa; var li1; var li2; var li3;
								if ($('input_12').value == '1' ) { plik='1'; nazwa='Cartes R'; li1='<span id="lista1"><li>Recto Coupe</li><li>Quadri</li><li>CM. 350g</li></span>'; }
								if ($('input_12').value == '2' ) { plik='2'; nazwa='Cartes R/V'; li1='<span id="lista1"><li>Recto/Verso Coupe</li><li>Quadri</li><li>CM. 350g</li></span>'; }
								if ($('input_12').value == '3' ) { plik='3'; nazwa='Cartes R/V + P'; li1='<span id="lista1"><li>Recto/Verso Coupe</li><li>Pelliculage</li><li>Quadri</li><li>CM. 350g</li></span>'; }
								if (preview_info_title) {
									preview_info_title.innerHTML='';
									preview_info_title.insert(nazwa);
								}
