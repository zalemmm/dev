...
//denisedesign
						...
						if (term.field>1) {
				       	...
				       	if ((term.field==3) || (term.field==4) || (term.field==15)) {
							var imag = $("preview_imag");
							imag.style.background="url(http://france-banderole.com/wp-content/plugins/fbshop/images/"+($('input_1').value)+".png) no-repeat";							
						}
				       	if ((term.field==10)) {
							var imag = $("preview_imag");
							imag.style.background="url(http://france-banderole.com/wp-content/plugins/fbshop/images/clipit.png) no-repeat";							
						}
						var podglad = $("preview2");
						if ( (term.field == 11) && ($('input_11').value != 'aucune') ) {
							var preview_info_title2 = $("preview_info_title2");
							if ($('input_11').value == 'spot') { var optiondename='spot'; var obraz2='spot Pince Halogène 35w Aluminium '; }
							...
							imag2.style.background="url(http://france-banderole.com/wp-content/plugins/fbshop/images/spot35w.png) no-repeat";
							preview_info_ul2.innerHTML=''; preview_info_ul2.insert('<li>spot Pince Halogène 35w Aluminium </li>');
						}
						if ($('input_11').value == 'aucune') { podglad.style.display="none"; }
