...
var FancyUpload2 = new Class({
	...
	onProgress: function(file, current, overall) {
		...
		this.currentText.set('html', 'Vitesse moyenne : {rate}/s. Temps restant : ~{timeLeft}'.substitute({
	...
	onComplete: function(file, response) {
		...
		this.currentText.set('html', '<strong><font color="#ff000">T�L�CHARGEMENT TERMIN� !</strong></font>');
	...
	updateOverall: function(bytesTotal) {
		...
		this.overallTitle.set('html', 'Progression totale (' + this.sizeToKB(bytesTotal) + ')');
	},
