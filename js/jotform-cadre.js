...
//denisedesign
						...
						var imag = $("preview-cadre_imag");
						var podglad = $("preview2");
						var podglad3 = $("preview3");
						podglad.style.display="none";
						podglad3.style.display="none";
						if (term.field==01) {
							var preview_info_title = $("preview_info_title");
							if (preview_info_title) {
								preview_info_title.innerHTML='';
								preview_info_title.insert($('input_01').value);
							}
							var podglad = $("preview-cadre");
							podglad.style.visibility="visible";
							imag.style.background="url(http://france-banderole.com/wp-content/plugins/fbshop/images/cadre/"+($('input_01').value)+".jpg) no-repeat";
						}
						if (term.field==02) {
							preview_info_ul.innerHTML='';
							preview_info_ul.insert(li1='<li>'+($('input_02').value)+'</li>');
							imag.style.background="url(http://france-banderole.com/wp-content/plugins/fbshop/images/oriflamme"+($('input_20').value)+".jpg) no-repeat";
						}	
						if (term.field==03) {
							preview_info_ul.innerHTML='';
							preview_info_ul.insert(li1='<li>'+($('input_03').value)+'</li>');
							imag.style.background="url(http://france-banderole.com/wp-content/plugins/fbshop/images/oriflamme"+($('input_20').value)+".jpg) no-repeat";
						}
						if (term.field==21) {
							preview_info_ul.innerHTML='';
							preview_info_ul.insert('<li>voile: '+($('input_21').value)+' cm</li>');
							if ($('input_21').value == 'oriflamme-54x190') {
							preview_info_ul.insert('<li>taille finale 54x240cm</li>');
							}
							if ($('input_21').value == 'oriflamme-85x245') {
							preview_info_ul.insert('<li>taille finale 85x308cm</li>');
							}
							if ($('input_21').value == 'oriflamme-85x298') {
							preview_info_ul.insert('<li>taille finale 85x351cm</li>');
							}
							if ($('input_21').value == 'oriflamme-85x397') {
							preview_info_ul.insert('<li>taille finale 85x465cm</li>');
							}
							imag.style.background="url(http://france-banderole.com/wp-content/plugins/fbshop/images/oriflamme/"+($('input_21').value)+".jpg) no-repeat";
						}
						if (term.field==22) {
							preview_info_ul.innerHTML='';
							preview_info_ul.insert('<li>voile: '+($('input_22').value)+' cm</li>');
							if ($('input_22').value == 'beachflag-72x156') {
							preview_info_ul.insert('<li>taille finale 72x203cm</li>');
							}
							if ($('input_22').value == 'beachflag-75x213') {
							preview_info_ul.insert('<li>taille finale 75x254cm</li>');
							}
							if ($('input_22').value == 'beachflag-106x257') {
							preview_info_ul.insert('<li>taille finale 106x323cm</li>');
							}
							if ($('input_22').value == 'beachflag-125x402') {
							preview_info_ul.insert('<li>taille finale 125x460cm</li>');
							}
							imag.style.background="url(http://france-banderole.com/wp-content/plugins/fbshop/images/oriflamme/"+($('input_22').value)+".jpg) no-repeat";
						}
						if (term.field==23) {
							preview_info_ul.innerHTML='';
							preview_info_ul.insert('<li>voile: '+($('input_23').value)+' cm</li>');
							if ($('input_23').value == 'windflag-59x180') {
							preview_info_ul.insert('<li>taille finale 63x290cm</li>');
							}
							if ($('input_23').value == 'windflag-80x280') {
							preview_info_ul.insert('<li>taille finale 80x410cm</li>');
							}
							if ($('input_23').value == 'windflag-100x350') {
							preview_info_ul.insert('<li>taille finale 100x530cm</li>');
							}
							imag.style.background="url(http://france-banderole.com/wp-content/plugins/fbshop/images/oriflamme/"+($('input_23').value)+".jpg) no-repeat";
						}
						if (term.field==3) {
							if ($('input_21').value) {
							preview_info_ul.innerHTML='';
							...
							if ($('input_21').value == 'oriflamme-85x289') {
							preview_info_ul.insert('<li>taille finale 85x351cm</li>');
							}
							if ($('input_21').value == 'oriflamme-85x390') {
							preview_info_ul.insert('<li>taille finale 85x465cm</li>');
							}
							preview_info_ul.insert('<li>'+($('input_3').value)+'</li>');
							}
						...
						if ($('input_6').value ) {
							...
							if (preview_info_title2) {
								...
								preview_info_title2.insert($('input_6').value+'bonjour');
							}
							...
							var obraz = '';
								...
								if ($('input_6').value == 'Embase 8kg') { obraz='Embase-8kg'; preview_info_ul2.innerHTML=''; preview_info_ul2.insert('<li>Embase 8kg</li>'); }
								if ($('input_6').value == 'Embase carrée 13,5kg') { obraz='Embase-carree'; preview_info_ul2.innerHTML=''; preview_info_ul2.insert('<li>Embase carrée 13,5kg</li>'); }
								if ($('input_6').value == 'Pied 4 branches + bouée') { obraz='Pied-branches'; preview_info_ul2.innerHTML=''; preview_info_ul2.insert('<li>Pied 4 branches + bouée</li>'); }
								if ($('input_6').value == 'Pied piquet') { obraz='Pied-piquet'; preview_info_ul2.innerHTML=''; preview_info_ul2.insert('<li>Pied piquet</li>'); }
								if ($('input_6').value == 'Pied voiture') { obraz='Pied-voiture'; preview_info_ul2.innerHTML=''; preview_info_ul2.insert('<li>Pied voiture</li>'); }
								if ($('input_6').value == 'Pied à visser') { obraz='Pied-visser'; preview_info_ul2.innerHTML=''; preview_info_ul2.insert('<li>Pied à visser</li>'); }
								if ($('input_6').value == 'Pied parasol 23L') { obraz='Pied-parasol'; preview_info_ul2.innerHTML=''; preview_info_ul2.insert('<li>Pied parasol 23L</li>'); }
								imag2.style.background="url(http://france-banderole.com/wp-content/plugins/fbshop/images/oriflamme/"+obraz+".jpg) no-repeat";
						}	
