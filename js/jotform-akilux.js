...
/////////////////////sans rainage//////////
	...
	/*			    	/////////////////////sans rainage recto//////////
						if ($('input_0').value == 'recto') {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r.jpg)";
						}

										/////sans rainage recto standard////
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s.jpg)";
						}
						...
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'oeillets')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-oeillet.jpg)";
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'rislans')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-rislan.jpg)";
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'crochets')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-crochet.jpg)";
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'double face')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-double.jpg)";
						}
									/////sans rainage recto HD////

						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd.jpg)";
						}
						...
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'oeillets')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-oeillet.jpg)";
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'rislans')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-rislan.jpg)";
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'crochets')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-crochet.jpg)";
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'double face')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-double.jpg)";
						}
						...
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s.jpg)";
						}
						...
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'oeillets')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-oeillet.jpg)";
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'rislans')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-rislan.jpg)";
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'crochets')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-crochet.jpg)";
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'double face')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-double.jpg)";
						}
									/////sans rainage rectoverso HD////

						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd.jpg)";
						}
						...
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'oeillets')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-oeillet.jpg)";
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'rislans')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-rislan.jpg)";
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'crochets')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-crochet.jpg)";
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'double face')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-double.jpg)";
						}*/
...
/*
						...
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'sans')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-1r.jpg)";
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'oeillets') && ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-oeillet-1r.jpg)";
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'rislans')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-rislan-1r.jpg)";
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'crochets')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-crochet-1r.jpg)";
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'double face')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-double-1r.jpg)";
						}
									/////1 rainage recto HD////
						...
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'sans')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-1r.jpg)";
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'oeillets')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-oeillet-1r.jpg)";
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'rislans')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-rislan-1r.jpg)";
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'crochets')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-crochet-1r.jpg)";
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'double face')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-double-1r.jpg)";
						}
						...
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'sans')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-1r.jpg)";
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'oeillets')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-oeillet-1r.jpg)";
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'rislans')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-rislan-1r.jpg)";
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'crochets')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-crochet-1r.jpg)";
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'double face')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-double-1r.jpg)";
						}
						...
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'sans')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-1r.jpg)";
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'oeillets')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-oeillet-1r.jpg)";
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'rislans')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-rislan-1r.jpg)";
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'crochets')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-crochet-1r.jpg)";
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'double face')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-double-1r.jpg)";
						}
            */
...
/////////////////////2 rainages//////////
						...
						/*if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'sans')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-2r.jpg)";
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'oeillets') && ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-oeillet-2r.jpg)";
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'rislans')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-rislan-2r.jpg)";
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'crochets')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-crochet-2r.jpg)";
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'double face')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-double-2r.jpg)";
						}
									/////2 rainages recto HD////
						...
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'sans')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-2r.jpg)";
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'oeillets')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-oeillet-2r.jpg)";
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'rislans')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-rislan-2r.jpg)";
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'crochets')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-crochet-2r.jpg)";
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'double face')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-double-2r.jpg)";
						}
						...
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'sans')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-2r.jpg)";
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'oeillets')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-oeillet-2r.jpg)";
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'rislans')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-rislan-2r.jpg)";
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'crochets')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-crochet-2r.jpg)";
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'double face')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-double-2r.jpg)";
						}
						...
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'sans')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-2r.jpg)";
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'oeillets')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-oeillet-2r.jpg)";
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'rislans')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-rislan-2r.jpg)";
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'crochets')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-crochet-2r.jpg)";
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'double face')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-double-2r.jpg)";
						}
						*/
...
/////////////////////3 rainages//////////
						...
						/*if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'sans')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-3r.jpg)";
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'oeillets') && ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-oeillet-3r.jpg)";
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'rislans')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-rislan-3r.jpg)";
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'crochets')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-crochet-3r.jpg)";
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'double face')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-double-3r.jpg)";
						}
									/////3 rainages recto HD////
						...
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'sans')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-3r.jpg)";
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'oeillets')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-oeillet-3r.jpg)";
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'rislans')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-rislan-3r.jpg)";
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'crochets')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-crochet-3r.jpg)";
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'double face')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-double-3r.jpg)";
						}
						...
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'sans')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-3r.jpg)";
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'oeillets')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-oeillet-3r.jpg)";
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'rislans')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-rislan-3r.jpg)";
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'crochets')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-crochet-3r.jpg)";
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'double face')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-double-3r.jpg)";
						}
						...
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'sans')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-3r.jpg)";
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'oeillets')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-oeillet-3r.jpg)";
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'rislans')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-rislan-3r.jpg)";
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'crochets')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-crochet-3r.jpg)";
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'double face')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.backgroundImage="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-double-3r.jpg)";
						}*/
