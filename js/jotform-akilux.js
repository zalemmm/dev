...
/////////////////////sans rainage//////////
						...
						if ($('input_0').value == 'recto') {
							...
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r.jpg) no-repeat";							
						}

										/////sans rainage recto standard////
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s.jpg) no-repeat";							
						}
						...
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'oeillets')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-oeillet.jpg) no-repeat";							
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'rislans')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-rislan.jpg) no-repeat";							
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'crochets')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-crochet.jpg) no-repeat";							
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'double face')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-double.jpg) no-repeat";							
						}
									/////sans rainage recto HD////
					
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd.jpg) no-repeat";							
						}
						...
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'oeillets')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-oeillet.jpg) no-repeat";							
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'rislans')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-rislan.jpg) no-repeat";							
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'crochets')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-crochet.jpg) no-repeat";							
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'double face')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-double.jpg) no-repeat";							
						}
						...
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s.jpg) no-repeat";							
						}
						...
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'oeillets')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-oeillet.jpg) no-repeat";							
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'rislans')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-rislan.jpg) no-repeat";							
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'crochets')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-crochet.jpg) no-repeat";							
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'double face')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-double.jpg) no-repeat";							
						}
									/////sans rainage rectoverso HD////
						
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd.jpg) no-repeat";							
						}
						...
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'oeillets')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-oeillet.jpg) no-repeat";							
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'rislans')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-rislan.jpg) no-repeat";							
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'crochets')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-crochet.jpg) no-repeat";							
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'double face')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-double.jpg) no-repeat";							
						}
...
/////////////////////1 rainage//////////
						...
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'sans')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-1r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'oeillets') && ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-oeillet-1r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'rislans')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-rislan-1r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'crochets')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-crochet-1r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'double face')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-double-1r.jpg) no-repeat";							
						}
									/////1 rainage recto HD////		
						...
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'sans')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-1r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'oeillets')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-oeillet-1r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'rislans')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-rislan-1r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'crochets')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-crochet-1r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'double face')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-double-1r.jpg) no-repeat";							
						}
						...
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'sans')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-1r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'oeillets')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-oeillet-1r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'rislans')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-rislan-1r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'crochets')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-crochet-1r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'double face')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-double-1r.jpg) no-repeat";							
						}
						...
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'sans')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-1r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'oeillets')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-oeillet-1r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'rislans')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-rislan-1r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'crochets')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-crochet-1r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'double face')&& ($('input_5').value == '1 rainage')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-double-1r.jpg) no-repeat";							
						}
...
/////////////////////2 rainages//////////
						...
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'sans')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-2r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'oeillets') && ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-oeillet-2r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'rislans')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-rislan-2r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'crochets')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-crochet-2r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'double face')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-double-2r.jpg) no-repeat";							
						}
									/////2 rainages recto HD////		
						...
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'sans')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-2r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'oeillets')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-oeillet-2r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'rislans')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-rislan-2r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'crochets')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-crochet-2r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'double face')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-double-2r.jpg) no-repeat";							
						}
						...
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'sans')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-2r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'oeillets')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-oeillet-2r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'rislans')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-rislan-2r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'crochets')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-crochet-2r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'double face')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-double-2r.jpg) no-repeat";							
						}
						...
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'sans')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-2r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'oeillets')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-oeillet-2r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'rislans')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-rislan-2r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'crochets')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-crochet-2r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'double face')&& ($('input_5').value == '2 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-double-2r.jpg) no-repeat";							
						}
...
/////////////////////3 rainages//////////
						...
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'sans')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-3r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'oeillets') && ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-oeillet-3r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'rislans')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-rislan-3r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'crochets')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-crochet-3r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'standard') && ($('input_4').value == 'double face')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-s-double-3r.jpg) no-repeat";							
						}
									/////3 rainages recto HD////		
						...
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'sans')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-3r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'oeillets')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-oeillet-3r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'rislans')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-rislan-3r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'crochets')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-crochet-3r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'recto') && ($('input_HD').value == 'HD') && ($('input_4').value == 'double face')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-r-hd-double-3r.jpg) no-repeat";							
						}
						...
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'sans')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-3r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'oeillets')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-oeillet-3r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'rislans')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-rislan-3r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'crochets')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-crochet-3r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'standard') && ($('input_4').value == 'double face')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-s-double-3r.jpg) no-repeat";							
						}
						...
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'sans')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-3r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'oeillets')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-oeillet-3r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'rislans')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-rislan-3r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'crochets')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-crochet-3r.jpg) no-repeat";							
						}
						if (($('input_0').value == 'rectoverso') && ($('input_HD').value == 'HD') && ($('input_4').value == 'double face')&& ($('input_5').value == '3 rainages')) {
							var imag = $("preview_imag");
							imag.style.background="url(http://www.france-banderole.com/wp-content/plugins/fbshop/images/akilux/3mm/akilux3mm-rv-hd-double-3r.jpg) no-repeat";							
						}
