...
//		niepokazuj=2;
	...
	if ( ($('input_3').value == 'bache 500g M1') && (szerokosc > 4) && (wysokosc > 4) ) {
		var blad = document.getElementById("id_3");		
		var blad2 = document.getElementById("id_14");		
		blad.style.background = "#FFAAAA";
		blad.style.border = "1px solid #FFAAAA";
	...
	if ( ($('input_4').value == 'bache 500g M1') && (szerokosc > 4) && (wysokosc > 4) ) {
		var blad = document.getElementById("id_3");		
		var blad2 = document.getElementById("id_14");		
		blad.style.background = "#FFAAAA";
		blad.style.border = "1px solid #FFAAAA";
	...
	if ( ($('input_5').value == 'bache 500g M1') && (szerokosc > 4) && (wysokosc > 4) ) {
		var blad = document.getElementById("id_3");		
		var blad2 = document.getElementById("id_14");		
		blad.style.background = "#FFAAAA";
		blad.style.border = "1px solid #FFAAAA";
...
if (($('input_0').value == 'recto') || ($('input_0').value == 'rectoverso')) {
	...
	///// Akilux 3mm recto 60x40 /////
	if (($('input_0').value == 'recto') && ($('input_1').value == '60x40')){
		opis += '<br />- Akilux 3mm recto <br />- 60x40cm';
		if ($('input_32').value == '1'){pu=9.36; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=9.36; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=7.80; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=7.80; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=7.02; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=7.02; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=7.02; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=6.24; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=6.24; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=6.24; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=6.24; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=5.30; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=5.30; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=5.30; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=5.30; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=4.68; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=4.68; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=4.68; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=4.68; opis += '<br />- 19 exemplaires';}
	...
	///// Akilux 3mm recto/verso 60x40/////
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == '60x40')){
		opis += '<br />- Akilux 3mm recto/verso <br />- 60x40cm';
		if ($('input_32').value == '1'){pu=15.48; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=15.48; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=12.90; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=12.90; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=11.61; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=11.61; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=11.61; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=10.32; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=10.32; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=10.32; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=10.32; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=8.77; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=8.77; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=8.77; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=8.77; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=7.74; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=7.74; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=7.74; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=7.74; opis += '<br />- 19 exemplaires';}
	...
	///// Akilux 3mm recto 60x80 /////
	if (($('input_0').value == 'recto') && ($('input_1').value == '60x80')){
		opis += '<br />- Akilux 3mm recto <br />- 60x80cm ';
		if ($('input_32').value == '1'){pu=15.60; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=14.04; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=13.42; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=12.48; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=11.86; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=11.23; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=10.61; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=10.61; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=9.98; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=9.98; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=9.36; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=9.36; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=9.36; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=8.74; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=8.74; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=8.74; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=8.11; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=8.11; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=7.79; opis += '<br />- 19 exemplaires';}
	...
	///// Akilux 3mm recto/verso 60x80 /////
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == '60x80')){
		opis += '<br />- Akilux 3mm recto/verso <br />- 60x80cm ';
		if ($('input_32').value == '1'){pu=25.80; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=23.22; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=22.19; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=20.64; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=19.61; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=18.58; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=17.54; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=17.54; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=16.51; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=16.51; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=15.48; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=15.48; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=15.48; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=14.45; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=14.45; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=14.45; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=13.42; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=13.42; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=12.38; opis += '<br />- 19 exemplaires';}
	...
	///// Akilux 3mm recto 120x40 /////
	if (($('input_0').value == 'recto') && ($('input_1').value == '120x40')){
		opis += '<br />- Akilux 3mm recto <br />- 120x40cm';
		if ($('input_32').value == '1'){pu=15.60; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=14.04; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=13.42; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=12.48; opis += '<br />- 4 exemplaires';}
	...
	///// Akilux 3mm recto/verso 120x40 UV/////
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == '120x40')){
		opis += '<br />- Akilux 3mm recto/verso <br />- 120x40cm ';
		if ($('input_32').value == '1'){pu=25.80; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=23.22; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=22.19; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=20.64; opis += '<br />- 4 exemplaires';}
	...
	///// Akilux 3mm recto 120x80/////
	if (($('input_0').value == 'recto') && ($('input_1').value == '120x80')){
		opis += '<br />- Akilux 3mm recto <br />- 120x80cm ';
		if ($('input_32').value == '1'){pu=26.83; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=25.58; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=24.96; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=22.46; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=21.84; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=21.22; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=20.59; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=19.97; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=19.34; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=18.72; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=18.10; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=17.47; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=16.85; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=16.22; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=15.60; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=15.60; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=14.98; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=14.98; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=14.35; opis += '<br />- 19 exemplaires';}
	...
	///// Akilux 3mm recto/verso 120x80 /////
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == '120x80')){
		opis += '<br />- Akilux 3mm recto/verso <br />- 120x80cm';
		if ($('input_32').value == '1'){pu=44.38; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=42.31; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=41.28; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=37.15; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=36.12; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=35.09; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=34.06; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=33.02; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=31.99; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=30.96; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=29.93; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=28.90; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=27.86; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=26.83; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=25.80; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=25.80; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=24.77; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=24.77; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=23.74; opis += '<br />- 19 exemplaires';}
	...
	///// Akilux 3mm recto 160x80/////
	if (($('input_0').value == 'recto') && ($('input_1').value == '160x80')){
		opis += '<br />- Akilux 3mm recto <br />- 160x80cm';
		if ($('input_32').value == '1'){pu=35.78; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=34.11; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=33.28; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=29.95; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=29.12; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=28.29; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=27.46; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=26.62; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=25.79; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=24.96; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=24.13; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=23.30; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=22.46; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=21.63; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=20.80; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=20.80; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=19.97; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=19.97; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=19.14; opis += '<br />- 19 exemplaires';}
	...
	///// Akilux 3mm recto/verso 160x80 /////
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == '160x80')){
		opis += '<br />- Akilux 3mm recto/verso <br />- 160x80cm ';
		if ($('input_32').value == '1'){pu=59.17; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=56.42; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=55.04; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=49.54; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=48.16; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=46.78; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=45.41; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=44.03; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=42.66; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=41.28; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=39.90; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=38.53; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=37.15; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=35.78; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=34.40; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=34.40; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=33.02; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=33.02; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=31.65; opis += '<br />- 19 exemplaires';}
	...
	///// Akilux 3mm recto 160x120 /////
	if (($('input_0').value == 'recto') && ($('input_1').value == '160x120')){
		opis += '<br />- Akilux 3mm recto <br />- 160x120cm';
		if ($('input_32').value == '1'){pu=49.92; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=48.67; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=47.42; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=43.68; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=41.18; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=39.94; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=37.44; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=34.94; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=34.94; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=31.20; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=31.20; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=29.95; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=29.95; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=27.46; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=27.46; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=26.21; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=26.21; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=24.96; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=24.96; opis += '<br />- 19 exemplaires';}
	...
	///// Akilux 3mm recto/verso 160x120/////
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == '160x120')){
		opis += '<br />- Akilux 3mm recto/verso <br />- 160x120cm ';
		if ($('input_32').value == '1'){pu=82.56; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=80.50; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=78.43; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=72.24; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=68.11; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=66.05; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=61.92; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=57.79; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=57.79; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=51.60; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=51.60; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=49.54; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=49.54; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=45.41; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=45.41; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=43.34; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=43.34; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=41.28; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=41.28; opis += '<br />- 19 exemplaires';}
	...
	///// Akilux 3mm recto personnalisée /////
	if (($('input_0').value == 'recto') && ($('input_1').value == 'personnalisée')){
		opis += '<br />- Akilux 3mm recto<br />- Taille Personnalisée';
	...
	///// Akilux 3mm recto/verso personnalisée /////
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == 'personnalisée')){
		opis += '<br />- Akilux 3mm recto/verso  <br />- Taille Personnalisée';
		if ($('input_32perso').value == '1'){pu=0; opis += '<br />- 1 exemplaire';}
		if ($('input_32perso').value == '2'){pu=0; opis += '<br />- 2 exemplaires';}
		if ($('input_32perso').value == '3'){pu=0; opis += '<br />- 3 exemplaires';}
		if ($('input_32perso').value == '4'){pu=0; opis += '<br />- 4 exemplaires';}
	...
	puoption = (pu*0.85)+fixations+rainage; ////*0.85 car -15%////
...
if (($('input_0').value == 'recto') || ($('input_0').value == 'rectoverso')) {
	...
	///// Akilux 3,5mm recto 60x40 /////
	if (($('input_0').value == 'recto') && ($('input_1').value == '60x40')){
		opis += '<br />- Akilux 3,5mm recto <br />- 60x40cm ';
		if ($('input_32').value == '1'){pu=9.36; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=9.36; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=7.80; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=7.80; opis += '<br />- 4 exemplaires';}
	...
	///// Akilux 3,5mm recto/verso 60x40 /////
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == '60x40')){
		opis += '<br />- Akilux 3,5mm recto/verso <br />- 60x40cm ';
		if ($('input_32').value == '1'){pu=15.48; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=15.48; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=12.90; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=12.90; opis += '<br />- 4 exemplaires';}
	...
	///// Akilux 3,5mm recto/verso 60x80/////
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == '60x80')){
		opis += '<br />- Akilux 3,5mm recto/verso <br />- 60x80cm ';
		if ($('input_32').value == '1'){pu=25.80; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=23.22; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=22.19; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=20.64; opis += '<br />- 4 exemplaires';}
	...
	///// Akilux 3,5mm recto 120x40 UV/////
	if (($('input_0').value == 'recto') && ($('input_1').value == '120x40')){
		opis += '<br />- Akilux 3,5mm recto <br />- 120x40cm';
		if ($('input_32').value == '1'){pu=15.60; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=14.04; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=13.42; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=12.48; opis += '<br />- 4 exemplaires';}
	...
	///// Akilux 3,5mm recto/verso 120x40 /////
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == '120x40')){
		opis += '<br />- Akilux 3,5mm recto/verso <br />- 120x40cm';
		if ($('input_32').value == '1'){pu=25.80; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=23.22; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=22.19; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=20.64; opis += '<br />- 4 exemplaires';}
	...
	///// Akilux 3,5mm recto 120x80 /////
	if (($('input_0').value == 'recto') && ($('input_1').value == '120x80')){
		opis += '<br />- Akilux 3,5mm recto <br />- 120x80cm ';
		if ($('input_32').value == '1'){pu=26.83; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=25.58; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=24.96; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=22.46; opis += '<br />- 4 exemplaires';}
		...
		if ($('input_32').value == '18'){pu=14.98; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=14.35; opis += '<br />- 19 exemplaires';}
		if ($('input_32').value == '20'){pu=14.35; opis += '<br />- 20 exemplaires';}
	...
	///// Akilux 3,5mm recto/verso 120x80 /////
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == '120x80')){
		opis += '<br />- Akilux 3,5mm recto/verso <br />- 120x80cm';
		if ($('input_32').value == '1'){pu=44.38; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=42.31; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=41.28; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=37.15; opis += '<br />- 4 exemplaires';}
		...
		if ($('input_32').value == '18'){pu=24.77; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=23.74; opis += '<br />- 19 exemplaires';}
		if ($('input_32').value == '20'){pu=23.74; opis += '<br />- 20 exemplaires';}
		if ($('input_32').value == '12'){pu=15.48; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '20'){pu=14.76; opis += '<br />- 20 exemplaires';}
		if ($('input_32').value == '40'){pu=14.40; opis += '<br />- 40 exemplaires';}
		if ($('input_32').value == '60'){pu=12.96; opis += '<br />- 60 exemplaires';}
	...
	///// Akilux 3,5mm recto 160x80 /////
	if (($('input_0').value == 'recto') && ($('input_1').value == '160x80')){
		opis += '<br />- Akilux 3,5mm recto <br />- 160x80cm';
		if ($('input_32').value == '1'){pu=35.78; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=34.11; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=33.28; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=29.95; opis += '<br />- 4 exemplaires';}
	...
	///// Akilux 3,5mm recto/verso 160x80 /////
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == '160x80')){
		opis += '<br />- Akilux 3,5mm recto/verso <br />- 160x80cm';
		if ($('input_32').value == '1'){pu=59.17; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=56.42; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=55.04; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=49.54; opis += '<br />- 4 exemplaires';}
		...
		if ($('input_32').value == '18'){pu=33.02; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=31.65; opis += '<br />- 19 exemplaires';}
		if ($('input_32').value == '20'){pu=31.65; opis += '<br />- 20 exemplaires';}
	...
	///// Akilux 3,5mm recto 160x120/////
	if (($('input_0').value == 'recto') && ($('input_1').value == '160x120')){
		opis += '<br />- Akilux 3,5mm recto <br />- 160x120cm ';
		if ($('input_32').value == '1'){pu=49.92; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=48.67; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=47.42; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=43.68; opis += '<br />- 4 exemplaires';}
		...
		if ($('input_32').value == '18'){pu=24.96; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=24.96; opis += '<br />- 19 exemplaires';}
		if ($('input_32').value == '20'){pu=24.96; opis += '<br />- 20 exemplaires';}
	...
	///// Akilux 3,5mm recto/verso 160x120/////
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == '160x120')){
		opis += '<br />- Akilux 3,5mm recto/verso <br />- 160x120cm';
		if ($('input_32').value == '1'){pu=82.56; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=80.50; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=78.43; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=72.24; opis += '<br />- 4 exemplaires';}
		...
		if ($('input_32').value == '18'){pu=41.28; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=41.28; opis += '<br />- 19 exemplaires';}
		if ($('input_32').value == '20'){pu=41.28; opis += '<br />- 20 exemplaires';}
	...
	///// Akilux 3,5mm recto personnalisée /////
	if (($('input_0').value == 'recto') && ($('input_1').value == 'personnalisée')){
		opis += '<br />- Akilux 3,5mm recto <br />- Taille Personnalisée';
		if ($('input_32perso').value == '1'){pu=0; opis += '<br />- 1 exemplaire';}
		if ($('input_32perso').value == '2'){pu=0; opis += '<br />- 2 exemplaires';}
		if ($('input_32perso').value == '3'){pu=0; opis += '<br />- 3 exemplaires';}
		if ($('input_32perso').value == '4'){pu=0; opis += '<br />- 4 exemplaires';}
	...
	///// Akilux 3,5mm recto/verso personnalisée /////
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == 'personnalisée')){
		opis += '<br />- Akilux 3,5mm recto/verso <br />- Taille Personnalisée';
		if ($('input_32perso').value == '1'){pu=0; opis += '<br />- 1 exemplaire';}
		if ($('input_32perso').value == '2'){pu=0; opis += '<br />- 2 exemplaires';}
		if ($('input_32perso').value == '3'){pu=0; opis += '<br />- 3 exemplaires';}
		if ($('input_32perso').value == '4'){pu=0; opis += '<br />- 4 exemplaires';}
	...
	puoption = (pu*1.105)+fixations+rainage; ////*1.105 car +30% pa rapport au 3mm////
	puoption2 = puoption+(maquette/ilosc);
	cena = (puoption*ilosc)+maquette;
...
if (($('input_0').value == 'recto') || ($('input_0').value == 'rectoverso')) {
	...
	///// Akilux 10mm recto 60x40 /////
	if (($('input_0').value == 'recto') && ($('input_1').value == '60x40')){
		opis += '<br />- Akilux 10mm recto <br />- 60x40cm ';
		if ($('input_32').value == '1'){pu=10.80; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=10.80; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=10.80; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=10.80; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=10.80; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=10.80; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=10.80; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=10.80; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=10.80; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=10.80; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=10.80; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=10.80; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=10.80; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=10.80; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=10.80; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=10.80; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=10.80; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=10.80; opis += '<br />- 18 exemplaires';}
		...
		if ($('input_32').value == '80'){pu=10.80; opis += '<br />- 80 exemplaires';}
		if ($('input_32').value == '100'){pu=10.80; opis += '<br />- 100 exemplaires';}
		if ($('input_32').value == '150'){pu=10.80; opis += '<br />- 150 exemplaires';}
		if ($('input_32').value == '200'){pu=10.80; opis += '<br />- 200 exemplaires';}
		if ($('input_32').value == '300'){pu=10.80; opis += '<br />- 300 exemplaires';}
		if ($('input_32').value == '400'){pu=10.80; opis += '<br />- 400 exemplaires';}
		if ($('input_32').value == '500'){pu=10.80; opis += '<br />- 500 exemplaires';}
		if ($('input_32').value == '750'){pu=10.80; opis += '<br />- 750 exemplaires';}
		if ($('input_32').value == '1000'){pu=10.80; opis += '<br />- 1000 exemplaires';}
		if ($('input_32').value == '1500'){pu=10.80; opis += '<br />- 1500 exemplaires';}
		if ($('input_32').value == '2000'){pu=10.80; opis += '<br />- 2000 exemplaires';}
		if ($('input_32').value == '3000'){pu=10.80; opis += '<br />- 3000 exemplaires';}
		if ($('input_32').value == '4000'){pu=10.80; opis += '<br />- 4000 exemplaires';}
		if ($('input_32').value == '5000'){pu=10.80; opis += '<br />- 5000 exemplaires';}
		if ($('input_32').value == '7500'){pu=10.80; opis += '<br />- 7500 exemplaires';}
		if ($('input_32').value == '10000'){pu=10.80; opis += '<br />- 10000 exemplaires';}
		poids = 1.28*0.24; ////grammage x m²///
		poidstotal = poids*ilosc;			
	}
	///// Akilux 10mm recto/verso 60x40 /////
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == '60x40')){
		opis += '<br />- Akilux 10mm recto/verso <br />- 60x40cm ';
		if ($('input_32').value == '1'){pu=14.40; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=14.40; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=14.40; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=14.40; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=14.40; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=14.40; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=14.40; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=14.40; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=14.40; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=14.40; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=14.40; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=14.40; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=14.40; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=14.40; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=14.40; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=14.40; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=14.40; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=14.40; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=14.40; opis += '<br />- 19 exemplaires';}
		if ($('input_32').value == '20'){pu=14.40; opis += '<br />- 20 exemplaires';}
		if ($('input_32').value == '40'){pu=14.40; opis += '<br />- 40 exemplaires';}
		if ($('input_32').value == '60'){pu=14.40; opis += '<br />- 60 exemplaires';}
		if ($('input_32').value == '80'){pu=14.40; opis += '<br />- 80 exemplaires';}
		if ($('input_32').value == '100'){pu=14.40; opis += '<br />- 100 exemplaires';}
		if ($('input_32').value == '150'){pu=14.40; opis += '<br />- 150 exemplaires';}
		if ($('input_32').value == '200'){pu=14.40; opis += '<br />- 200 exemplaires';}
		if ($('input_32').value == '300'){pu=14.40; opis += '<br />- 300 exemplaires';}
		if ($('input_32').value == '400'){pu=14.40; opis += '<br />- 400 exemplaires';}
		if ($('input_32').value == '500'){pu=14.40; opis += '<br />- 500 exemplaires';}
		if ($('input_32').value == '750'){pu=14.40; opis += '<br />- 750 exemplaires';}
		if ($('input_32').value == '1000'){pu=14.40; opis += '<br />- 1000 exemplaires';}
		if ($('input_32').value == '1500'){pu=14.40; opis += '<br />- 1500 exemplaires';}
		if ($('input_32').value == '2000'){pu=14.40; opis += '<br />- 2000 exemplaires';}
		if ($('input_32').value == '3000'){pu=14.40; opis += '<br />- 3000 exemplaires';}
	...
	///// Akilux 10mm recto 60x80 /////
	if (($('input_0').value == 'recto') && ($('input_1').value == '60x80')){
		opis += '<br />- Akilux 10mm recto';
		if ($('input_32').value == '1'){pu=21.60; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=21.60; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=21.60; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=21.60; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=21.60; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=21.60; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=21.60; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=21.60; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=21.60; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=21.60; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=21.60; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=21.60; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=21.60; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=21.60; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=21.60; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=21.60; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=21.60; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=21.60; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=21.60; opis += '<br />- 19 exemplaires';}
		if ($('input_32').value == '20'){pu=21.60; opis += '<br />- 20 exemplaires';}
		if ($('input_32').value == '40'){pu=21.60; opis += '<br />- 40 exemplaires';}
		if ($('input_32').value == '60'){pu=21.60; opis += '<br />- 60 exemplaires';}
		if ($('input_32').value == '80'){pu=21.60; opis += '<br />- 80 exemplaires';}
		if ($('input_32').value == '100'){pu=21.60; opis += '<br />- 100 exemplaires';}
		if ($('input_32').value == '150'){pu=21.60; opis += '<br />- 150 exemplaires';}
		if ($('input_32').value == '200'){pu=21.60; opis += '<br />- 200 exemplaires';}
		if ($('input_32').value == '300'){pu=21.60; opis += '<br />- 300 exemplaires';}
		if ($('input_32').value == '400'){pu=21.60; opis += '<br />- 400 exemplaires';}
		if ($('input_32').value == '500'){pu=21.60; opis += '<br />- 500 exemplaires';}
		if ($('input_32').value == '750'){pu=21.60; opis += '<br />- 750 exemplaires';}
		if ($('input_32').value == '1000'){pu=21.60; opis += '<br />- 1000 exemplaires';}
		if ($('input_32').value == '1500'){pu=21.60; opis += '<br />- 1500 exemplaires';}
		if ($('input_32').value == '2000'){pu=21.60; opis += '<br />- 2000 exemplaires';}
		if ($('input_32').value == '3000'){pu=21.60; opis += '<br />- 3000 exemplaires';}
		if ($('input_32').value == '4000'){pu=21.60; opis += '<br />- 4000 exemplaires';}
		if ($('input_32').value == '5000'){pu=21.60; opis += '<br />- 5000 exemplaires';}
		if ($('input_32').value == '7500'){pu=21.60; opis += '<br />- 7500 exemplaires';}
		if ($('input_32').value == '10000'){pu=21.60; opis += '<br />- 10000 exemplaires';}
		poids = 1.28*0.48; ////grammage x m²///
		poidstotal = poids*ilosc;			
	}
	///// Akilux 10mm recto/verso 60x80/////
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == '60x80')){
		opis += '<br />- Akilux 10mm recto/verso <br />- 60x80cm ';
		if ($('input_32').value == '1'){pu=28.80; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=28.80; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=28.80; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=28.80; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=28.80; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=28.80; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=28.80; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=28.80; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=28.80; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=28.80; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=28.80; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=28.80; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=28.80; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=28.80; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=28.80; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=28.80; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=28.80; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=28.80; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=28.80; opis += '<br />- 19 exemplaires';}
		if ($('input_32').value == '20'){pu=28.80; opis += '<br />- 20 exemplaires';}
		if ($('input_32').value == '40'){pu=28.80; opis += '<br />- 40 exemplaires';}
		if ($('input_32').value == '60'){pu=28.80; opis += '<br />- 60 exemplaires';}
		if ($('input_32').value == '80'){pu=28.80; opis += '<br />- 80 exemplaires';}
		if ($('input_32').value == '100'){pu=28.80; opis += '<br />- 100 exemplaires';}
		if ($('input_32').value == '150'){pu=28.80; opis += '<br />- 150 exemplaires';}
		if ($('input_32').value == '200'){pu=28.80; opis += '<br />- 200 exemplaires';}
		if ($('input_32').value == '300'){pu=28.80; opis += '<br />- 300 exemplaires';}
		if ($('input_32').value == '400'){pu=28.80; opis += '<br />- 400 exemplaires';}
		if ($('input_32').value == '500'){pu=28.80; opis += '<br />- 500 exemplaires';}
		if ($('input_32').value == '750'){pu=28.80; opis += '<br />- 750 exemplaires';}
		if ($('input_32').value == '1000'){pu=28.80; opis += '<br />- 1000 exemplaires';}
		if ($('input_32').value == '1500'){pu=28.80; opis += '<br />- 1500 exemplaires';}
		if ($('input_32').value == '2000'){pu=28.80; opis += '<br />- 2000 exemplaires';}
		if ($('input_32').value == '3000'){pu=28.80; opis += '<br />- 3000 exemplaires';}
		if ($('input_32').value == '4000'){pu=28.80; opis += '<br />- 4000 exemplaires';}
		if ($('input_32').value == '5000'){pu=28.80; opis += '<br />- 5000 exemplaires';}
		if ($('input_32').value == '7500'){pu=28.80; opis += '<br />- 7500 exemplaires';}
		if ($('input_32').value == '10000'){pu=28.80; opis += '<br />- 10000 exemplaires';}
		poids = 1.28*0.48; ////grammage x m²///
		poidstotal = poids*ilosc;		
	}

	///// Akilux 10mm recto 120x40 UV/////
	if (($('input_0').value == 'recto') && ($('input_1').value == '120x40')){
		opis += '<br />- Akilux 10mm recto <br />- 120x40cm';
		if ($('input_32').value == '1'){pu=21.60; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=21.60; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=21.60; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=21.60; opis += '<br />- 4 exemplaires';}
	...
	///// Akilux 10mm recto/verso 120x40 /////
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == '120x40')){
		opis += '<br />- Akilux 10mm recto/verso <br />- 120x40cm';
		if ($('input_32').value == '1'){pu=28.80; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=28.80; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=28.80; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=28.80; opis += '<br />- 4 exemplaires';}
	...
	///// Akilux 10mm recto 120x80 /////
	if (($('input_0').value == 'recto') && ($('input_1').value == '120x80')){
		opis += '<br />- Akilux 10mm recto <br />- 120x80cm ';
		if ($('input_32').value == '1'){pu=43.20; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=43.20; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=43.20; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=43.20; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=43.20; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=43.20; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=43.20; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=43.20; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=43.20; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=43.20; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=43.20; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=43.20; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=43.20; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=43.20; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=43.20; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=43.20; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=43.20; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=43.20; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=43.20; opis += '<br />- 19 exemplaires';}
		if ($('input_32').value == '20'){pu=43.20; opis += '<br />- 20 exemplaires';}
		if ($('input_32').value == '12'){pu=43.20; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '20'){pu=43.20; opis += '<br />- 20 exemplaires';}
		if ($('input_32').value == '40'){pu=43.20; opis += '<br />- 40 exemplaires';}
		if ($('input_32').value == '60'){pu=43.20; opis += '<br />- 60 exemplaires';}
		if ($('input_32').value == '80'){pu=43.20; opis += '<br />- 80 exemplaires';}
		if ($('input_32').value == '100'){pu=43.20; opis += '<br />- 100 exemplaires';}
		if ($('input_32').value == '150'){pu=43.20; opis += '<br />- 150 exemplaires';}
		if ($('input_32').value == '200'){pu=43.20; opis += '<br />- 200 exemplaires';}
		if ($('input_32').value == '300'){pu=43.20; opis += '<br />- 300 exemplaires';}
		if ($('input_32').value == '400'){pu=43.20; opis += '<br />- 400 exemplaires';}
		if ($('input_32').value == '500'){pu=43.20; opis += '<br />- 500 exemplaires';}
		if ($('input_32').value == '750'){pu=43.20; opis += '<br />- 750 exemplaires';}
		if ($('input_32').value == '1000'){pu=43.20; opis += '<br />- 1000 exemplaires';}
		if ($('input_32').value == '1500'){pu=43.20; opis += '<br />- 1500 exemplaires';}
		if ($('input_32').value == '2000'){pu=43.20; opis += '<br />- 2000 exemplaires';}
		if ($('input_32').value == '3000'){pu=43.20; opis += '<br />- 3000 exemplaires';}
		if ($('input_32').value == '4000'){pu=43.20; opis += '<br />- 4000 exemplaires';}
		if ($('input_32').value == '5000'){pu=43.20; opis += '<br />- 5000 exemplaires';}
		if ($('input_32').value == '7500'){pu=43.20; opis += '<br />- 7500 exemplaires';}
		if ($('input_32').value == '10000'){pu=43.20; opis += '<br />- 10000 exemplaires';}
		poids = 1.28*0.96; ////grammage x m²///
		poidstotal = poids*ilosc;			
	}
	///// Akilux 10mm recto/verso 120x80 /////
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == '120x80')){
		opis += '<br />- Akilux 10mm recto/verso <br />- 120x80cm';
		if ($('input_32').value == '1'){pu=57.60; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=57.60; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=57.60; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=57.60; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=57.60; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=57.60; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=57.60; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=57.60; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=57.60; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=57.60; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=57.60; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=57.60; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=57.60; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=57.60; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=57.60; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=57.60; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=57.60; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=57.60; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=57.60; opis += '<br />- 19 exemplaires';}
		if ($('input_32').value == '20'){pu=57.60; opis += '<br />- 20 exemplaires';}
		if ($('input_32').value == '12'){pu=57.60; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '20'){pu=57.60; opis += '<br />- 20 exemplaires';}
		if ($('input_32').value == '40'){pu=57.60; opis += '<br />- 40 exemplaires';}
		if ($('input_32').value == '60'){pu=57.60; opis += '<br />- 60 exemplaires';}
		if ($('input_32').value == '80'){pu=57.60; opis += '<br />- 80 exemplaires';}
		...
		if ($('input_32').value == '300'){pu=57.60; opis += '<br />- 300 exemplaires';}
		if ($('input_32').value == '400'){pu=57.60; opis += '<br />- 400 exemplaires';}
		if ($('input_32').value == '500'){pu=57.60; opis += '<br />- 500 exemplaires';}
		if ($('input_32').value == '750'){pu=57.60; opis += '<br />- 750 exemplaires';}
		if ($('input_32').value == '1000'){pu=57.60; opis += '<br />- 1000 exemplaires';}
		if ($('input_32').value == '1500'){pu=57.60; opis += '<br />- 1500 exemplaires';}
		if ($('input_32').value == '2000'){pu=57.60; opis += '<br />- 2000 exemplaires';}
		if ($('input_32').value == '3000'){pu=57.60; opis += '<br />- 3000 exemplaires';}
		if ($('input_32').value == '4000'){pu=57.60; opis += '<br />- 4000 exemplaires';}
		if ($('input_32').value == '5000'){pu=57.60; opis += '<br />- 5000 exemplaires';}
		if ($('input_32').value == '7500'){pu=57.60; opis += '<br />- 7500 exemplaires';}
		if ($('input_32').value == '10000'){pu=57.60; opis += '<br />- 10000 exemplaires';}
		poids = 1.28*0.96; ////grammage x m²///
		poidstotal = poids*ilosc;		
	}
	
	///// Akilux 10mm recto 160x80 /////
	if (($('input_0').value == 'recto') && ($('input_1').value == '160x80')){
		opis += '<br />- Akilux 10mm recto <br />- 160x80cm';
		if ($('input_32').value == '1'){pu=57.60; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=57.60; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=57.60; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=57.60; opis += '<br />- 4 exemplaires';}
		...
		if ($('input_32').value == '7500'){pu=57.60; opis += '<br />- 7500 exemplaires';}
		if ($('input_32').value == '10000'){pu=57.60; opis += '<br />- 10000 exemplaires';}
		poids = 1.28*1.28; ////grammage x m²///
		poidstotal = poids*ilosc;			
	}
	///// Akilux 10mm recto/verso 160x80 /////
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == '160x80')){
		opis += '<br />- Akilux 10mm recto/verso <br />- 160x80cm';
		if ($('input_32').value == '1'){pu=76.80; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=76.80; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=76.80; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=76.80; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=76.80; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=76.80; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=76.80; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=76.80; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=76.80; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=76.80; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=76.80; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=76.80; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=76.80; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=76.80; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=76.80; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=76.80; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=76.80; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=76.80; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=76.80; opis += '<br />- 19 exemplaires';}
		if ($('input_32').value == '20'){pu=76.80; opis += '<br />- 20 exemplaires';}
		if ($('input_32').value == '12'){pu=76.80; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '20'){pu=76.80; opis += '<br />- 20 exemplaires';}
		if ($('input_32').value == '40'){pu=76.80; opis += '<br />- 40 exemplaires';}
		if ($('input_32').value == '60'){pu=76.80; opis += '<br />- 60 exemplaires';}
		if ($('input_32').value == '80'){pu=76.80; opis += '<br />- 80 exemplaires';}
		if ($('input_32').value == '100'){pu=76.80; opis += '<br />- 100 exemplaires';}
		if ($('input_32').value == '150'){pu=76.80; opis += '<br />- 150 exemplaires';}
		if ($('input_32').value == '200'){pu=76.80; opis += '<br />- 200 exemplaires';}
		if ($('input_32').value == '300'){pu=76.80; opis += '<br />- 300 exemplaires';}
		if ($('input_32').value == '400'){pu=76.80; opis += '<br />- 400 exemplaires';}
		if ($('input_32').value == '500'){pu=76.80; opis += '<br />- 500 exemplaires';}
		if ($('input_32').value == '750'){pu=76.80; opis += '<br />- 750 exemplaires';}
		if ($('input_32').value == '1000'){pu=76.80; opis += '<br />- 1000 exemplaires';}
		if ($('input_32').value == '1500'){pu=76.80; opis += '<br />- 1500 exemplaires';}
		if ($('input_32').value == '2000'){pu=76.80; opis += '<br />- 2000 exemplaires';}
		if ($('input_32').value == '3000'){pu=76.80; opis += '<br />- 3000 exemplaires';}
		if ($('input_32').value == '4000'){pu=76.80; opis += '<br />- 4000 exemplaires';}
		if ($('input_32').value == '5000'){pu=76.80; opis += '<br />- 5000 exemplaires';}
		if ($('input_32').value == '7500'){pu=76.80; opis += '<br />- 7500 exemplaires';}
		if ($('input_32').value == '10000'){pu=76.80; opis += '<br />- 10000 exemplaires';}
		poids = 1.28*1.28; ////grammage x m²///
		poidstotal = poids*ilosc;		
	}
	

	///// Akilux 10mm recto 160x120/////
	if (($('input_0').value == 'recto') && ($('input_1').value == '160x120')){
		opis += '<br />- Akilux 10mm recto <br />- 160x120cm ';
		if ($('input_32').value == '1'){pu=86.40; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=86.40; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=86.40; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=86.40; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=86.40; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=86.40; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=86.40; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=86.40; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=86.40; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=86.40; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=86.40; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=86.40; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=86.40; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=86.40; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=86.40; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=86.40; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=86.40; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=86.40; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=86.40; opis += '<br />- 19 exemplaires';}
		if ($('input_32').value == '20'){pu=86.40; opis += '<br />- 20 exemplaires';}
		if ($('input_32').value == '12'){pu=86.40; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '20'){pu=86.40; opis += '<br />- 20 exemplaires';}
		if ($('input_32').value == '40'){pu=86.40; opis += '<br />- 40 exemplaires';}
		if ($('input_32').value == '60'){pu=86.40; opis += '<br />- 60 exemplaires';}
		if ($('input_32').value == '80'){pu=86.40; opis += '<br />- 80 exemplaires';}
		if ($('input_32').value == '100'){pu=86.40; opis += '<br />- 100 exemplaires';}
		if ($('input_32').value == '150'){pu=86.40; opis += '<br />- 150 exemplaires';}
		if ($('input_32').value == '200'){pu=86.40; opis += '<br />- 200 exemplaires';}
		if ($('input_32').value == '300'){pu=86.40; opis += '<br />- 300 exemplaires';}
		if ($('input_32').value == '400'){pu=86.40; opis += '<br />- 400 exemplaires';}
		if ($('input_32').value == '500'){pu=86.40; opis += '<br />- 500 exemplaires';}
		if ($('input_32').value == '750'){pu=86.40; opis += '<br />- 750 exemplaires';}
		if ($('input_32').value == '1000'){pu=86.40; opis += '<br />- 1000 exemplaires';}
		if ($('input_32').value == '1500'){pu=86.40; opis += '<br />- 1500 exemplaires';}
		if ($('input_32').value == '2000'){pu=86.40; opis += '<br />- 2000 exemplaires';}
		if ($('input_32').value == '3000'){pu=86.40; opis += '<br />- 3000 exemplaires';}
		if ($('input_32').value == '4000'){pu=86.40; opis += '<br />- 4000 exemplaires';}
		if ($('input_32').value == '5000'){pu=86.40; opis += '<br />- 5000 exemplaires';}
		if ($('input_32').value == '7500'){pu=86.40; opis += '<br />- 7500 exemplaires';}
		if ($('input_32').value == '10000'){pu=86.40; opis += '<br />- 10000 exemplaires';}
		poids = 1.28*1.92; ////grammage x m²///
		poidstotal = poids*ilosc;			
	}
	///// Akilux 10mm recto/verso 160x120/////
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == '160x120')){
		opis += '<br />- Akilux 10mm recto/verso <br />- 160x120cm';
		if ($('input_32').value == '1'){pu=115.20; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=115.20; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=115.20; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=115.20; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=115.20; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=115.20; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=115.20; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=115.20; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=115.20; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=115.20; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=115.20; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=115.20; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=115.20; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=115.20; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=115.20; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=115.20; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=115.20; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=115.20; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=115.20; opis += '<br />- 19 exemplaires';}
		if ($('input_32').value == '20'){pu=115.20; opis += '<br />- 20 exemplaires';}
		if ($('input_32').value == '12'){pu=115.20; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '20'){pu=115.20; opis += '<br />- 20 exemplaires';}
		if ($('input_32').value == '40'){pu=115.20; opis += '<br />- 40 exemplaires';}
		if ($('input_32').value == '60'){pu=115.20; opis += '<br />- 60 exemplaires';}
		if ($('input_32').value == '80'){pu=115.20; opis += '<br />- 80 exemplaires';}
		if ($('input_32').value == '100'){pu=115.20; opis += '<br />- 100 exemplaires';}
		if ($('input_32').value == '150'){pu=115.20; opis += '<br />- 150 exemplaires';}
		if ($('input_32').value == '200'){pu=115.20; opis += '<br />- 200 exemplaires';}
		if ($('input_32').value == '300'){pu=115.20; opis += '<br />- 300 exemplaires';}
		if ($('input_32').value == '400'){pu=115.20; opis += '<br />- 400 exemplaires';}
		if ($('input_32').value == '500'){pu=115.20; opis += '<br />- 500 exemplaires';}
		if ($('input_32').value == '750'){pu=115.20; opis += '<br />- 750 exemplaires';}
		if ($('input_32').value == '1000'){pu=115.20; opis += '<br />- 1000 exemplaires';}
		if ($('input_32').value == '1500'){pu=115.20; opis += '<br />- 1500 exemplaires';}
		if ($('input_32').value == '2000'){pu=115.20; opis += '<br />- 2000 exemplaires';}
		if ($('input_32').value == '3000'){pu=115.20; opis += '<br />- 3000 exemplaires';}
		if ($('input_32').value == '4000'){pu=115.20; opis += '<br />- 4000 exemplaires';}
		if ($('input_32').value == '5000'){pu=115.20; opis += '<br />- 5000 exemplaires';}
		if ($('input_32').value == '7500'){pu=115.20; opis += '<br />- 7500 exemplaires';}
		if ($('input_32').value == '10000'){pu=115.20; opis += '<br />- 10000 exemplaires';}
		poids = 1.28*1.92; ////grammage x m²///
		poidstotal = poids*ilosc;		
	}
	...
	///// Akilux 10mm recto 300x200/////
	if (($('input_0').value == 'recto') && ($('input_1').value == '300x200')){
		opis += '<br />- Akilux 10mm recto <br />- 300x200cm ';
		if ($('input_32').value == '1'){pu=270.00; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=270.00; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=270.00; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=270.00; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=270.00; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=270.00; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=270.00; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=270.00; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=270.00; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=270.00; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=270.00; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=270.00; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=270.00; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=270.00; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=270.00; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=270.00; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=270.00; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=270.00; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=270.00; opis += '<br />- 19 exemplaires';}
		if ($('input_32').value == '20'){pu=270.00; opis += '<br />- 20 exemplaires';}
		if ($('input_32').value == '12'){pu=270.00; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '20'){pu=270.00; opis += '<br />- 20 exemplaires';}
		if ($('input_32').value == '40'){pu=270.00; opis += '<br />- 40 exemplaires';}
		if ($('input_32').value == '60'){pu=270.00; opis += '<br />- 60 exemplaires';}
		if ($('input_32').value == '80'){pu=270.00; opis += '<br />- 80 exemplaires';}
		if ($('input_32').value == '100'){pu=270.00; opis += '<br />- 100 exemplaires';}
		if ($('input_32').value == '150'){pu=270.00; opis += '<br />- 150 exemplaires';}
		if ($('input_32').value == '200'){pu=270.00; opis += '<br />- 200 exemplaires';}
		if ($('input_32').value == '300'){pu=270.00; opis += '<br />- 300 exemplaires';}
		if ($('input_32').value == '400'){pu=270.00; opis += '<br />- 400 exemplaires';}
		if ($('input_32').value == '500'){pu=270.00; opis += '<br />- 500 exemplaires';}
		if ($('input_32').value == '750'){pu=270.00; opis += '<br />- 750 exemplaires';}
		if ($('input_32').value == '1000'){pu=270.00; opis += '<br />- 1000 exemplaires';}
		if ($('input_32').value == '1500'){pu=270.00; opis += '<br />- 1500 exemplaires';}
		if ($('input_32').value == '2000'){pu=270.00; opis += '<br />- 2000 exemplaires';}
		if ($('input_32').value == '3000'){pu=270.00; opis += '<br />- 3000 exemplaires';}
		if ($('input_32').value == '4000'){pu=270.00; opis += '<br />- 4000 exemplaires';}
		if ($('input_32').value == '5000'){pu=270.00; opis += '<br />- 5000 exemplaires';}
		if ($('input_32').value == '7500'){pu=270.00; opis += '<br />- 7500 exemplaires';}
		if ($('input_32').value == '10000'){pu=270.00; opis += '<br />- 10000 exemplaires';}
		poids = 1.28*6; ////grammage x m²///
		poidstotal = poids*ilosc;			
	}
	///// Akilux 10mm recto/verso 300x200/////
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == '300x200')){
		opis += '<br />- Akilux 10mm recto/verso <br />- 300x200cm';
		if ($('input_32').value == '1'){pu=360.00; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=360.00; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=360.00; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=360.00; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=360.00; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=360.00; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=360.00; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=360.00; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=360.00; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=360.00; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=360.00; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=360.00; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=360.00; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=360.00; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=360.00; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=360.00; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=360.00; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=360.00; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=360.00; opis += '<br />- 19 exemplaires';}
		if ($('input_32').value == '20'){pu=360.00; opis += '<br />- 20 exemplaires';}
		if ($('input_32').value == '12'){pu=360.00; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '20'){pu=360.00; opis += '<br />- 20 exemplaires';}
		if ($('input_32').value == '40'){pu=360.00; opis += '<br />- 40 exemplaires';}
		if ($('input_32').value == '60'){pu=360.00; opis += '<br />- 60 exemplaires';}
		if ($('input_32').value == '80'){pu=360.00; opis += '<br />- 80 exemplaires';}
		if ($('input_32').value == '100'){pu=360.00; opis += '<br />- 100 exemplaires';}
		if ($('input_32').value == '150'){pu=360.00; opis += '<br />- 150 exemplaires';}
		if ($('input_32').value == '200'){pu=360.00; opis += '<br />- 200 exemplaires';}
		if ($('input_32').value == '300'){pu=360.00; opis += '<br />- 300 exemplaires';}
		if ($('input_32').value == '400'){pu=360.00; opis += '<br />- 400 exemplaires';}
		if ($('input_32').value == '500'){pu=360.00; opis += '<br />- 500 exemplaires';}
		if ($('input_32').value == '750'){pu=360.00; opis += '<br />- 750 exemplaires';}
		if ($('input_32').value == '1000'){pu=360.00; opis += '<br />- 1000 exemplaires';}
		if ($('input_32').value == '1500'){pu=360.00; opis += '<br />- 1500 exemplaires';}
		if ($('input_32').value == '2000'){pu=360.00; opis += '<br />- 2000 exemplaires';}
		if ($('input_32').value == '3000'){pu=360.00; opis += '<br />- 3000 exemplaires';}
		if ($('input_32').value == '4000'){pu=360.00; opis += '<br />- 4000 exemplaires';}
		if ($('input_32').value == '5000'){pu=360.00; opis += '<br />- 5000 exemplaires';}
		if ($('input_32').value == '7500'){pu=360.00; opis += '<br />- 7500 exemplaires';}
		if ($('input_32').value == '10000'){pu=360.00; opis += '<br />- 10000 exemplaires';}
		poids = 1.28*6; ////grammage x m²///
		poidstotal = poids*ilosc;		
	}
	
  
	///// Akilux 10mm recto personnalisée /////
	if (($('input_0').value == 'recto') && ($('input_1').value == 'personnalisée')){
		opis += '<br />- Akilux 10mm recto <br />- Taille Personnalisée';
		if ($('input_32perso').value == '1'){pu=0; opis += '<br />- 1 exemplaire';}
		if ($('input_32perso').value == '2'){pu=0; opis += '<br />- 2 exemplaires';}
		if ($('input_32perso').value == '3'){pu=0; opis += '<br />- 3 exemplaires';}
		if ($('input_32perso').value == '4'){pu=0; opis += '<br />- 4 exemplaires';}
		...
		if ($('input_32perso').value == '7500'){pu=0; opis += '<br />- 7500 exemplaires';}
		if ($('input_32perso').value == '10000'){pu=0; opis += '<br />- 10000 exemplaires';}
		poids = 1.28*0; ////grammage x m²///
		poidstotal = poids*ilosc;			
	}
	///// Akilux 10mm recto/verso personnalisée /////
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == 'personnalisée')){
		opis += '<br />- Akilux 10mm recto/verso <br />- Taille Personnalisée';
		if ($('input_32perso').value == '1'){pu=0; opis += '<br />- 1 exemplaire';}
		if ($('input_32perso').value == '2'){pu=0; opis += '<br />- 2 exemplaires';}
		if ($('input_32perso').value == '3'){pu=0; opis += '<br />- 3 exemplaires';}
		if ($('input_32perso').value == '4'){pu=0; opis += '<br />- 4 exemplaires';}
...
if (($('input_0').value == 'recto') || ($('input_0').value == 'rectoverso')) {
	...
	///// Forex 5mm recto 60x40 /////
	if (($('input_0').value == 'recto') && ($('input_1').value == '60x40')){
		opis += '<br />- Forex 5mm recto <br />- 60x40cm';
		if ($('input_32').value == '1'){pu=17.28; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=17.28; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=14.40; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=14.40; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=12.96; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=12.96; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=12.96; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=11.52; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=11.52; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=11.52; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=11.52; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=11.00; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=11.00; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=11.00; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=11.00; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=10.90; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=10.90; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=10.90; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=10.90; opis += '<br />- 19 exemplaires';}
		if ($('input_32').value == '20'){pu=10.90; opis += '<br />- 20 exemplaires';}
		if ($('input_32').value == '40'){pu=10.80; opis += '<br />- 40 exemplaires';}
		if ($('input_32').value == '60'){pu=10.80; opis += '<br />- 60 exemplaires';}
	...
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == '60x40')){
		opis += '<br />- Forex 5mm recto/verso <br />- 60x40cm';
		if ($('input_32').value == '1'){pu=24.48; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=24.48; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=20.40; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=20.40; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=18.36; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=18.36; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=18.36; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=16.32; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=16.32; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=16.32; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=16.32; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=13.87; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=13.87; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=13.87; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=13.87; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=12.24; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=12.24; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=12.24; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=12.24; opis += '<br />- 19 exemplaires';}
		if ($('input_32').value == '20'){pu=12.24; opis += '<br />- 20 exemplaires';}
	...
	if (($('input_0').value == 'recto') && ($('input_1').value == '100x50')){
		opis += '<br />- Forex 5mm recto <br />- 100x50cm';
		if ($('input_32').value == '1'){pu=30.00; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=27.00; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=25.80; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=24.00; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=24.00; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=24.00; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=24.00; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=22.80; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=22.80; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=22.80; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=22.80; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=21.60; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=21.60; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=21.60; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=21.60; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=20.40; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=20.40; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=20.40; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=20.40; opis += '<br />- 19 exemplaires';}
	...
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == '100x50')){
		opis += '<br />- Forex 5mm recto/verso <br />- 100x50cm';
		...
		if ($('input_31').value == '17'){pu=23.63; opis += '<br />- 17 exemplaires';}
		if ($('input_31').value == '18'){pu=23.63; opis += '<br />- 18 exemplaires';}
		if ($('input_31').value == '19'){pu=23.63; opis += '<br />- 19 exemplaires';}
	...
	if (($('input_0').value == 'recto') && ($('input_1').value == '150x75')){
		opis += '<br />- Forex 5mm recto <br />- 150x75cm';
		...
		if ($('input_32').value == '4'){pu=54.00; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=51.30; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=51.30; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=51.30; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=48.60; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=48.60; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=48.60; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=40.50; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=40.50; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=45.90; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=45.90; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=45.90; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=45.90; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=45.56; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=45.56; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=45.56; opis += '<br />- 19 exemplaires';}
	...
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == '150x75')){
		opis += '<br />- Forex 5mm recto/verso <br />- 150x75cm ';
		if ($('input_32').value == '1'){pu=95.63; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=86.06; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=82.24; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=76.50; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=72.68; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=68.85; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=65.03; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=65.03; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=61.20; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=61.20; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=57.38; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=57.38; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=57.38; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=53.55; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=53.55; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=53.55; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=53.16; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=53.16; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=53.16; opis += '<br />- 19 exemplaires';}
	...
	if (($('input_0').value == 'recto') && ($('input_1').value == '200x100')){
		opis += '<br />- Forex 5mm recto <br />- 200x100cm ';
		if ($('input_32').value == '1'){pu=100.80; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=98.40; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=96.00; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=86.40; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=84.00; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=81.60; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=81.60; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=76.80; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=76.80; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=76.80; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=76.80; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=74.40; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=74.40; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=74.40; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=74.40; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=74.40; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=73.80; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=73.80; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=73.80; opis += '<br />- 19 exemplaires';}
	...
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == '200x100')){
		opis += '<br />- Forex 5mm recto/verso <br />- 200x100cm ';
		if ($('input_32').value == '1'){pu=142.80; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=139.40; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=136.00; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=122.40; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=119.00; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=115.60; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=108.80; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=108.80; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=105.40; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=102.00; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=98.60; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=95.20; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=91.80; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=88.40; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=86.10; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=86.10; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=86.10; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=86.10; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=86.10; opis += '<br />- 19 exemplaires';}
	...
	if (($('input_0').value == 'recto') && ($('input_1').value == '200x150')){
		opis += '<br />- Forex 5mm recto <br />- 200x150cm';
		if ($('input_32').value == '1'){pu=154.80; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=147.60; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=144.00; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=129.60; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=126.00; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=122.40; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=118.80; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=115.20; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=115.20; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=115.20; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=115.20; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=111.60; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=111.60; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=111.60; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=111.60; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=110.70; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=110.70; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=110.70; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=110.70; opis += '<br />- 19 exemplaires';}
	...
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == '200x150')){
		opis += '<br />- Forex 5mm recto/verso <br />- 200x150cm';
		if ($('input_32').value == '1'){pu=219.30; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=209.10; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=204.00; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=183.60; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=178.50; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=173.40; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=168.30; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=163.20; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=158.10; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=153.10; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=147.90; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=142.80; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=137.70; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=132.60; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=132.60; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=129.15; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=129.15; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=129.15; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=129.15; opis += '<br />- 19 exemplaires';}
	...
	if (($('input_0').value == 'recto') && ($('input_1').value == '300x150')){
		opis += '<br />- Forex 5mm recto <br />- 300x150cm';
		if ($('input_32').value == '1'){pu=216.00; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=210.60; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=205.20; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=189.00; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=178.20; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=178.20; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=178.20; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=172.80; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=172.80; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=172.80; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=172.80; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=162.00; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=162.00; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=162.00; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=157.95; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=113.40; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=157.95; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=157.95; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=157.95; opis += '<br />- 19 exemplaires';}
	...
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == '300x150')){
		opis += '<br />- Forex 5mm recto/verso <br />- 300x150cm ';
		if ($('input_32').value == '1'){pu=306.00; opis += '<br />- 1 exemplaire';}
		if ($('input_32').value == '2'){pu=298.35; opis += '<br />- 2 exemplaires';}
		if ($('input_32').value == '3'){pu=290.70; opis += '<br />- 3 exemplaires';}
		if ($('input_32').value == '4'){pu=267.75; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=252.45; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=144.80; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=229.50; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=214.20; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=214.20; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=191.25; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=191.25; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=184.28; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=184.28; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=184.28; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=184.28; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=184.28; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=184.28; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=184.28; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=184.28; opis += '<br />- 19 exemplaires';}
	...
	if (($('input_0').value == 'recto') && ($('input_1').value == 'personnalisée')){
		opis += '<br />- Forex 5mm recto <br />- Taille Personnalisée';
		if ($('input_32perso').value == '1'){pu=0; opis += '<br />- 1 exemplaire';}
		if ($('input_32perso').value == '2'){pu=0; opis += '<br />- 2 exemplaires';}
		if ($('input_32perso').value == '3'){pu=0; opis += '<br />- 3 exemplaires';}
		if ($('input_32perso').value == '4'){pu=0; opis += '<br />- 4 exemplaires';}
	...
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == 'personnalisée')){
		opis += '<br />- Forex 5mm recto/verso  <br />- Taille Personnalisée';
		if ($('input_32perso').value == '1'){pu=0; opis += '<br />- 1 exemplaire';}
		if ($('input_32perso').value == '2'){pu=0; opis += '<br />- 2 exemplaires';}
		if ($('input_32perso').value == '3'){pu=0; opis += '<br />- 3 exemplaires';}
		if ($('input_32perso').value == '4'){pu=0; opis += '<br />- 4 exemplaires';}
...
if (($('input_0').value == 'recto') || ($('input_0').value == 'rectoverso')) {
	...
	if (($('input_0').value == 'recto') && ($('input_1').value == '60x40')){
		...
		if ($('input_32').value == '4'){pu=31.68; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=23.76; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=23.76; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=23.76; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=23.76; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=23.76; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=23.76; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=23.76; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=26.40; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=26.40; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=26.40; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=26.40; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=25.20; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=25.20; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=25.20; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=25.20; opis += '<br />- 19 exemplaires';}
	...
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == '60x40')){
		...
		if ($('input_32').value == '4'){pu=38.88; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=32.40; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=32.40; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=32.40; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=32.40; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=32.40; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=32.40; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=32.40; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=29.16; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=29.16; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=29.16; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=29.16; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=27.36; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=27.36; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=27.36; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=27.36; opis += '<br />- 19 exemplaires';}
	...
	if (($('input_0').value == 'recto') && ($('input_1').value == '100x50')){
		...
		if ($('input_32').value == '4'){pu=47.30; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=44.00; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=44.00; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=44.00; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=41.80; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=41.80; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=41.80; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=41.80; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=41.80; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=39.60; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=39.60; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=39.60; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=39.38; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=39.38; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=39.38; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=39.38; opis += '<br />- 19 exemplaires';}
	...
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == '100x50')){
		...
		if ($('input_32').value == '4'){pu=54.00; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=51.30; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=48.60; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=45.90; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=45.90; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=43.20; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=43.20; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=43.20; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=43.20; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=43.20; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=42.75; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=42.75; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=42.75; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=42.75; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=42.75; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=42.75; opis += '<br />- 19 exemplaires';}
	...
	if (($('input_0').value == 'recto') && ($('input_1').value == '150x75')){
		...
		if ($('input_32').value == '4'){pu=99.00; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=94.05; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=94.05; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=94.05; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=94.05; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=94.05; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=89.10; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=89.10; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=89.10; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=89.10; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=89.10; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=89.10; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=88.59; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=88.59; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=88.59; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=88.59; opis += '<br />- 19 exemplaires';}
	...
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == '150x75')){
		...
		if ($('input_32').value == '4'){pu=121.50; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=115.43; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=109.35; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=109.35; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=109.35; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=109.35; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=103.28; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=103.28; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=103.28; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=103.28; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=96.19; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=96.19; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=96.19; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=96.19; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=96.19; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=96.19; opis += '<br />- 19 exemplaires';}
	...
	if (($('input_0').value == 'recto') && ($('input_1').value == '200x100')){
		...
		if ($('input_32').value == '4'){pu=158.40; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=154.00; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=154.00; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=154.00; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=154.00; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=154.00; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=154.00; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=154.00; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=149.60; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=149.60; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=149.60; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=149.60; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=143.50; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=143.50; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=143.50; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=143.50; opis += '<br />- 19 exemplaires';}
	...
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == '200x100')){
		...
		if ($('input_32').value == '4'){pu=194.40; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=189.00; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=183.60; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=172.80; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=172.80; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=167.40; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=162.00; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=162.00; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=162.00; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=162.00; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=162.00; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=162.00; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=155.80; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=155.80; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=155.80; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=155.80; opis += '<br />- 19 exemplaires';}
	...
	if (($('input_0').value == 'recto') && ($('input_1').value == '200x150')){
		...
		if ($('input_32').value == '4'){pu=237.60; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=231.00; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=224.40; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=224.40; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=224.40; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=224.40; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=224.40; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=224.40; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=217.80; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=217.80; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=217.80; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=217.80; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=215.25; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=215.25; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=215.25; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=215.25; opis += '<br />- 19 exemplaires';}
	...
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == '200x150')){
		...
		if ($('input_32').value == '4'){pu=291.60; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=283.50; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=275.40; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=267.30; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=259.20; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=251.10; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=243.10; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=234.90; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=234.90; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=234.90; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=234.90; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=234.90; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=233.70; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=233.70; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=233.70; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=233.70; opis += '<br />- 19 exemplaires';}
	...
	if (($('input_0').value == 'recto') && ($('input_1').value == '300x150')){
		...
		if ($('input_32').value == '4'){pu=346.50; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=326.70; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=326.70; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=326.70; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=326.70; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=326.70; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=326.80; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=326.80; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=326.80; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=326.80; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=326.80; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=326.80; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=307.13; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=307.13; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=307.13; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=307.13; opis += '<br />- 19 exemplaires';}
	...
	if (($('input_0').value == 'rectoverso') && ($('input_1').value == '300x150')){
		...
		if ($('input_32').value == '4'){pu=425.25; opis += '<br />- 4 exemplaires';}
		if ($('input_32').value == '5'){pu=400.95; opis += '<br />- 5 exemplaires';}
		if ($('input_32').value == '6'){pu=388.80; opis += '<br />- 6 exemplaires';}
		if ($('input_32').value == '7'){pu=364.50; opis += '<br />- 7 exemplaires';}
		if ($('input_32').value == '8'){pu=340.20; opis += '<br />- 8 exemplaires';}
		if ($('input_32').value == '9'){pu=340.20; opis += '<br />- 9 exemplaires';}
		if ($('input_32').value == '10'){pu=340.20; opis += '<br />- 10 exemplaires';}
		if ($('input_32').value == '11'){pu=340.20; opis += '<br />- 11 exemplaires';}
		if ($('input_32').value == '12'){pu=340.20; opis += '<br />- 12 exemplaires';}
		if ($('input_32').value == '13'){pu=340.20; opis += '<br />- 13 exemplaires';}
		if ($('input_32').value == '14'){pu=340.20; opis += '<br />- 14 exemplaires';}
		if ($('input_32').value == '15'){pu=340.20; opis += '<br />- 15 exemplaires';}
		if ($('input_32').value == '16'){pu=333.45; opis += '<br />- 16 exemplaires';}
		if ($('input_32').value == '17'){pu=333.45; opis += '<br />- 17 exemplaires';}
		if ($('input_32').value == '18'){pu=333.45; opis += '<br />- 18 exemplaires';}
		if ($('input_32').value == '19'){pu=333.45; opis += '<br />- 19 exemplaires';}
		if ($('input_32').value == '20'){pu=333.45; opis += '<br />- 20 exemplaires';}
