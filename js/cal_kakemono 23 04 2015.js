...
////IX tens///	
	if (($('input_01').value == 'IX-Tens') && (($('input_110').value == '60cm de hauteur') || ($('input_111').value == '60cm de hauteur'))) {
		ilosc = $('input_4').value;
		if ($('input_4').value == '1') {prixcadre=1169;}
		if (($('input_4').value > 1) && ($('input_4').value < 4)){prixcadre=1152;}
		if (($('input_4').value > 3) && ($('input_4').value < 6)){prixcadre=1127;}
		if (($('input_4').value > 5) && ($('input_4').value < 8)){prixcadre=1111;}
		if (($('input_4').value > 7) && ($('input_4').value < 10)){prixcadre=1086;}
		if (($('input_4').value > 9) && ($('input_4').value < 21)){prixcadre=1057;}
		if (($('input_4').value > 20) && ($('input_4').value < 51)){prixcadre=875;}
		if (($('input_4').value > 50) && ($('input_4').value < 101)){prixcadre=810;}
		
		transport=72;
		opis += '<br />- IX\'Tens<br />- 60cm de hauteur';
	}
	
	if (($('input_01').value == 'IX-Tens') && (($('input_110').value == '80cm de hauteur') || ($('input_111').value == '80cm de hauteur'))) {
		ilosc = $('input_4').value;
		if ($('input_4').value == '1') {prixcadre=1211;}
		if (($('input_4').value > 1) && ($('input_4').value < 4)){prixcadre=1194;}
		if (($('input_4').value > 3) && ($('input_4').value < 6)){prixcadre=1168;}
		if (($('input_4').value > 5) && ($('input_4').value < 8)){prixcadre=1150;}
		if (($('input_4').value > 7) && ($('input_4').value < 10)){prixcadre=1125;}
		if (($('input_4').value > 9) && ($('input_4').value < 21)){prixcadre=1095;}
		if (($('input_4').value > 20) && ($('input_4').value < 51)){prixcadre=918;}
		if (($('input_4').value > 50) && ($('input_4').value < 101)){prixcadre=850;}
		
		transport=72;
		opis += '<br />- IX\'Tens<br />- 80cm de hauteur';
	}
	
	if (($('input_01').value == 'IX-Tens') && (($('input_110').value == '100cm de hauteur') || ($('input_111').value == '100cm de hauteur'))) {
		ilosc = $('input_4').value;
		if ($('input_4').value == '1') {prixcadre=1247;}
		if (($('input_4').value > 1) && ($('input_4').value < 4)){prixcadre=1230;}
		if (($('input_4').value > 3) && ($('input_4').value < 6)){prixcadre=1203;}
		if (($('input_4').value > 5) && ($('input_4').value < 8)){prixcadre=1185;}
		if (($('input_4').value > 7) && ($('input_4').value < 10)){prixcadre=1158;}
		if (($('input_4').value > 9) && ($('input_4').value < 21)){prixcadre=1129;}
		if (($('input_4').value > 20) && ($('input_4').value < 51)){prixcadre=945;}
		if (($('input_4').value > 50) && ($('input_4').value < 101)){prixcadre=875;}
		
		transport=72;
		opis += '<br />- IX\'Tens<br />- 100cm de hauteur';
	}
	
	if (($('input_01').value == 'IX-Tens') && (($('input_110').value == '120cm de hauteur') || ($('input_111').value == '120cm de hauteur'))) {
		ilosc = $('input_4').value;
		if ($('input_4').value == '1') {prixcadre=1284;}
		if (($('input_4').value > 1) && ($('input_4').value < 4)){prixcadre=1265;}
		if (($('input_4').value > 3) && ($('input_4').value < 6)){prixcadre=1238;}
		if (($('input_4').value > 5) && ($('input_4').value < 8)){prixcadre=1220;}
		if (($('input_4').value > 7) && ($('input_4').value < 10)){prixcadre=1192;}
		if (($('input_4').value > 9) && ($('input_4').value < 21)){prixcadre=1162;}
		if (($('input_4').value > 20) && ($('input_4').value < 51)){prixcadre=976;}
		if (($('input_4').value > 50) && ($('input_4').value < 101)){prixcadre=904;}
		
		transport=91;
		opis += '<br />- IX\'Tens<br />- 120cm de hauteur';
	}
	
	if (($('input_01').value == 'IX-Tens') && (($('input_110').value == '140cm de hauteur') || ($('input_111').value == '140cm de hauteur'))) {
		ilosc = $('input_4').value;
		if ($('input_4').value == '1') {prixcadre=1323;}
		if (($('input_4').value > 1) && ($('input_4').value < 4)){prixcadre=1304;}
		if (($('input_4').value > 3) && ($('input_4').value < 6)){prixcadre=1276;}
		if (($('input_4').value > 5) && ($('input_4').value < 8)){prixcadre=1257;}
		if (($('input_4').value > 7) && ($('input_4').value < 10)){prixcadre=1229;}
		if (($('input_4').value > 9) && ($('input_4').value < 21)){prixcadre=1196;}
		if (($('input_4').value > 20) && ($('input_4').value < 51)){prixcadre=1008;}
		if (($('input_4').value > 50) && ($('input_4').value < 101)){prixcadre=934;}
		
		transport=91;
		opis += '<br />- IX\'Tens<br />- 140cm de hauteur';
	}
	
	if (($('input_01').value == 'IX-Tens') && (($('input_110').value == '160cm de hauteur') || ($('input_111').value == '160cm de hauteur'))) {
		ilosc = $('input_4').value;
		if ($('input_4').value == '1') {prixcadre=1361;}
		if (($('input_4').value > 1) && ($('input_4').value < 4)){prixcadre=1341;}
		if (($('input_4').value > 3) && ($('input_4').value < 6)){prixcadre=1312;}
		if (($('input_4').value > 5) && ($('input_4').value < 8)){prixcadre=1293;}
		if (($('input_4').value > 7) && ($('input_4').value < 10)){prixcadre=1264;}
		if (($('input_4').value > 9) && ($('input_4').value < 21)){prixcadre=1230;}
		if (($('input_4').value > 20) && ($('input_4').value < 51)){prixcadre=1042;}
		if (($('input_4').value > 50) && ($('input_4').value < 101)){prixcadre=965;}
...
////banderole IX'tens///	
	...
	if ($('input_21').value == '60cm x 100cm'){
		banderole=20;
		opis += '<br />- Banderole 60x100cm';
	}
	if ($('input_21').value == '60cm x 200cm'){
		banderole=36;
		opis += '<br />- Banderole 60x200cm';
	}
	if ($('input_21').value == '60cm x 300cm'){
		banderole=51;
		opis += '<br />- Banderole 60x300cm';
	}
	if ($('input_21').value == '60cm x 400cm'){
		banderole=66;
		opis += '<br />- Banderole 60x400cm';
	}
	if ($('input_21').value == '60cm x 500cm'){
		banderole=81;
		opis += '<br />- Banderole 60x500cm';
	}
	if ($('input_21').value == '60cm x 600cm'){
		banderole=96;
		opis += '<br />- Banderole 60x600cm';
	}
	
	
	if ($('input_22').value == '80cm x 100cm'){
		banderole=28;
		opis += '<br />- Banderole 80x100cm';
	}
	if ($('input_22').value == '80cm x 200cm'){
		banderole=48;
		opis += '<br />- Banderole 80x200cm';
	}
	if ($('input_22').value == '80cm x 300cm'){
		banderole=68;
		opis += '<br />- Banderole 80x300cm';
	}
	if ($('input_22').value == '80cm x 400cm'){
		banderole=88;
		opis += '<br />- Banderole 80x400cm';
	}
	if ($('input_22').value == '80cm x 500cm'){
		banderole=108;
		opis += '<br />- Banderole 80x500cm';
	}
	if ($('input_22').value == '80cm x 600cm'){
		banderole=128;
		opis += '<br />- Banderole 80x600cm';
	}
	
	
	if ($('input_23').value == '100cm x 100cm'){
		banderole=35;
		opis += '<br />- Banderole 100x100cm';
	}
	if ($('input_23').value == '100cm x 200cm'){
		banderole=60;
		opis += '<br />- Banderole 100x200cm';
	}
	if ($('input_23').value == '100cm x 300cm'){
		banderole=85;
		opis += '<br />- Banderole 100x300cm';
	}
	if ($('input_23').value == '100cm x 400cm'){
		banderole=110;
		opis += '<br />- Banderole 100x400cm';
	}
	if ($('input_23').value == '100cm x 500cm'){
		banderole=135;
		opis += '<br />- Banderole 100x500cm';
	}
	if ($('input_23').value == '100cm x 600cm'){
		banderole=160;
		opis += '<br />- Banderole 100x600cm';
	}
	
	
	if ($('input_24').value == '120cm x 100cm'){
		banderole=42;
		opis += '<br />- Banderole 120x100cm';
	}
	if ($('input_24').value == '120cm x 200cm'){
		banderole=72;
		opis += '<br />- Banderole 120x200cm';
	}
	if ($('input_24').value == '120cm x 300cm'){
		banderole=102;
		opis += '<br />- Banderole 120x300cm';
	}
	if ($('input_24').value == '120cm x 400cm'){
		banderole=132;
		opis += '<br />- Banderole 120x400cm';
	}
	if ($('input_24').value == '120cm x 500cm'){
		banderole=162;
		opis += '<br />- Banderole 120x500cm';
	}
	if ($('input_24').value == '120cm x 600cm'){
		banderole=192;
		opis += '<br />- Banderole 120x600cm';
	}
	
	
	if ($('input_25').value == '120cm x 100cm'){
		banderole=49;
		opis += '<br />- Banderole 120x100cm';
	}
	if ($('input_25').value == '120cm x 200cm'){
		banderole=84;
		opis += '<br />- Banderole 120x200cm';
	}
	if ($('input_25').value == '120cm x 300cm'){
		banderole=119;
		opis += '<br />- Banderole 120x300cm';
	}
	if ($('input_25').value == '120cm x 400cm'){
		banderole=154;
		opis += '<br />- Banderole 120x400cm';
	}
	if ($('input_25').value == '120cm x 500cm'){
		banderole=189;
		opis += '<br />- Banderole 120x500cm';
	}
	if ($('input_25').value == '120cm x 600cm'){
		banderole=224;
		opis += '<br />- Banderole 120x600cm';
	}
	
	if ($('input_26').value == '120cm x 100cm'){
		banderole=56;
		opis += '<br />- Banderole 120x100cm';
	}
	if ($('input_26').value == '120cm x 200cm'){
		banderole=96;
		opis += '<br />- Banderole 120x200cm';
	}
	if ($('input_26').value == '120cm x 300cm'){
		banderole=136;
		opis += '<br />- Banderole 120x300cm';
	}
	if ($('input_26').value == '120cm x 400cm'){
		banderole=176;
		opis += '<br />- Banderole 120x400cm';
	}
	if ($('input_26').value == '120cm x 500cm'){
		banderole=216;
		opis += '<br />- Banderole 120x500cm';
	}
	if ($('input_26').value == '120cm x 600cm'){
		banderole=256;
		opis += '<br />- Banderole 120x600cm';
	}
...
////couleur///	
	...
	if (($('input_31').value == 'rouge') || ($('input_32').value == 'rouge') || ($('input_33').value == 'rouge') || ($('input_34').value == 'rouge')) {
	opis += '<br />- rouge';	
	prixcouleur	= (prixcadre*0.2)+prixcadre	
	}
	
	if (($('input_31').value == 'jaune') || ($('input_32').value == 'jaune') || ($('input_33').value == 'jaune') || ($('input_34').value == 'jaune')) {
	opis += '<br />- jaune';	
	prixcouleur	= (prixcadre*0.2)+prixcadre	
	}
	
	if (($('input_31').value == 'vert') || ($('input_32').value == 'vert') || ($('input_33').value == 'vert') || ($('input_34').value == 'vert')) {
	opis += '<br />- vert';	
	prixcouleur	= (prixcadre*0.2)+prixcadre	
	}
	
	if (($('input_31').value == 'orange') || ($('input_32').value == 'orange') || ($('input_33').value == 'orange') || ($('input_34').value == 'orange')) {
	opis += '<br />- orange';	
	prixcouleur	= (prixcadre*0.2)+prixcadre	
	}
	
	if (($('input_31').value == 'bleu marine') || ($('input_32').value == 'bleu marine') || ($('input_33').value == 'bleu marine') || ($('input_34').value == 'bleu marine')) {
	opis += '<br />- bleu marine';	
	prixcouleur	= (prixcadre*0.2)+prixcadre	
	}
	
	if (($('input_31').value == 'bleu ciel') || ($('input_32').value == 'bleu ciel') || ($('input_33').value == 'bleu ciel') || ($('input_34').value == 'bleu ciel')) {
	opis += '<br />- bleu ciel';	
	prixcouleur	= (prixcadre*0.2)+prixcadre	
	}
	
	if (($('input_31').value == 'noir') || ($('input_32').value == 'noir') || ($('input_33').value == 'noir') || ($('input_34').value == 'noir')) {
	opis += '<br />- noir';	
	prixcouleur	= (prixcadre*0.2)+prixcadre	
	}
	
	if (($('input_31').value == 'blanc') || ($('input_32').value == 'blanc') || ($('input_33').value == 'blanc') || ($('input_34').value == 'blanc')) {
	opis += '<br />- blanc';	
	prixcouleur	= (prixcadre*0.2)+prixcadre	
	}
	
	if (($('input_31').value == 'aluminium') || ($('input_32').value == 'aluminium') || ($('input_33').value == 'aluminium') || ($('input_34').value == 'aluminium')) {
	opis += '<br />- aluminium';
	...
	ilosc = $('input_4').value;
	prixunitaire=prixcouleur+banderole
...
if ( ($('input_1').value) ) {
	...
	var cenapojedyncza = (prixHT+marge);
	ilosc=$('input_9').value;
	cena=cenapojedyncza*ilosc;
	}
