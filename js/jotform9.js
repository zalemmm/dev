					...
					if(JotForm.checkValueByOperator(term.operator, term.value, value)){
						...
						if ($('input_0').value) {
							var preview_info_title = $("preview_info_title");
								...
								if ($('input_0').value == 'Tissu' ) { plik='3x5rv.jpg'; nazwa='Tissu Easy quick'; }
								if ($('input_0').value == 'Stand ExpoBag' ) { nazwa='Stand ExpoBag'; }
								if ($('input_0').value == 'PLV carton' ) { nazwa='PLV carton pliable'; }
								...
								if ($('input_1').value == '1b' ) { plik='Totem_oval.jpg'; li1='<span id="lista1"><li>Totem oval</li><li>Dimensions : 154x50cm</li></span>'; }	
								if ($('input_1').value == '2b' ) { plik='Totem_oval2.jpg'; li1='<span id="lista1"><li>Totem oval</li><li>Dimensions : 190x63cm</li></span>'; }	
								if ($('input_1').value == '3b' ) { plik='comptoir.jpg'; li1='<span id="lista1"><li>Comptoir</li><li>Dimensions : 69x99cm</li></span>'; }	
								if ($('input_1').value == '4b' ) { plik='arche.jpg'; li1='<span id="lista1"><li>Arche 2 colonnes et 1 top</li><li>Dimensions : 190x63cm & 200x50cm</li></span>'; }	
								if ($('input_1').value == '5b' ) { plik='pack1.jpg'; li1='<span id="lista1"><li>2 Petits Totems + Comptoir + Arche</li></span>'; }	
								if ($('input_1').value == '6b' ) { plik='pack2.jpg'; li1='<span id="lista1"><li>2 Grands Totems + Comptoir + Arche</li></span>'; }	
