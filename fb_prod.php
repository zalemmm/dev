...
/*  if (is_page('construction')) {
  ...
  if (is_page('cadre-tissu')) {
  echo '<script src="'.get_bloginfo("url").'/wp-content/plugins/fbshop/js/prototype.js" type="text/javascript"></script><script src="'.get_bloginfo("url").'/wp-content/plugins/fbshop/js/protoplus.js" type="text/javascript"></script><script src="'.get_bloginfo("url").'/wp-content/plugins/fbshop/js/protoplus-ui.js" type="text/javascript"></script>
  <script src="'.get_bloginfo("url").'/wp-content/plugins/fbshop/js/cal_kakemono.js?v26032013" type="text/javascript"></script><script src="'.get_bloginfo("url").'/wp-content/plugins/fbshop/js/jotform-cadre.js?v4" type="text/javascript"></script>
  <script type="text/javascript">
  JotForm.setConditions([
     {"type": "field", "link": "Any", "terms": [{"field": "1", "operator": "equals", "value": "Cadre tissu standard"},{"field": "1", "operator": "equals", "value": "Cadre (structure seule)"},{"field": "1", "operator": "equals", "value": "visuel (tissu imprimé)"}], "action": {"field": "6", "visibility": "Show"}},
   {"type": "field", "link": "All", "terms": [{"field": "1", "operator": "equals", "value": "Cadre tissu lumineux"}], "action": {"field": "21", "visibility": "Show"}},
   {"type": "field", "link": "Any", "terms": [{"field": "21", "operator": "isFilled", "value": false}], "action": {"field": "22", "visibility": "Show"}},
   {"type": "field", "link": "Any", "terms": [{"field": "22", "operator": "isFilled", "value": false}], "action": {"field": "maquette-led", "visibility": "Show"}},
   {"type": "field", "link": "Any", "terms": [{"field": "maquette-led", "operator": "isFilled", "value": false}], "action": {"field": "signature-led", "visibility": "Show"}},
   {"type": "field", "link": "Any", "terms": [{"field": "6", "operator": "isFilled", "value": false}], "action": {"field": "signature", "visibility": "Show"}},
   {"type": "field", "link": "Any", "terms": [{"field": "signature-led", "operator": "isFilled", "value": false}], "action": {"field": "4", "visibility": "Show"}},
   {"type": "field", "link": "Any", "terms": [{"field": "signature-led", "operator": "isFilled", "value": false}], "action": {"field": "8", "visibility": "Show"}},
   {"type": "field", "link": "Any", "terms": [{"field": "signature", "operator": "isFilled", "value": false}], "action": {"field": "23", "visibility": "Show"}},
   {"type": "field", "link": "Any", "terms": [{"field": "signature", "operator": "isFilled", "value": false}], "action": {"field": "4", "visibility": "Show"}},
   {"type": "field", "link": "Any", "terms": [{"field": "signature", "operator": "isFilled", "value": false}], "action": {"field": "8", "visibility": "Show"}}
  ]);
  JotForm.init();
 ...
 if (is_page('enseigne-suspendue-textile')) {
  echo '<script src="'.get_bloginfo("url").'/wp-content/plugins/fbshop/js/prototype.js" type="text/javascript"></script><script src="'.get_bloginfo("url").'/wp-content/plugins/fbshop/js/protoplus.js" type="text/javascript"></script><script src="'.get_bloginfo("url").'/wp-content/plugins/fbshop/js/protoplus-ui.js" type="text/javascript"></script>
  <script src="'.get_bloginfo("url").'/wp-content/plugins/fbshop/js/cal_kakemono.js?v26032013" type="text/javascript"></script><script src="'.get_bloginfo("url").'/wp-content/plugins/fbshop/js/jotform-enseigne-suspendue.js?v4" type="text/javascript"></script>
  <script type="text/javascript">
  JotForm.setConditions([

   {"type": "field", "link": "All", "terms": [{"field": "1", "operator": "equals", "value": "Rond"}], "action": {"field": "21", "visibility": "Show"}},
   {"type": "field", "link": "All", "terms": [{"field": "1", "operator": "equals", "value": "Carré"}], "action": {"field": "22", "visibility": "Show"}},
   {"type": "field", "link": "All", "terms": [{"field": "1", "operator": "equals", "value": "Triangle"}], "action": {"field": "23", "visibility": "Show"}},
   {"type": "field", "link": "Any", "terms": [{"field": "21", "operator": "isFilled", "value": false}], "action": {"field": "6", "visibility": "Show"}},
  ...
  JotForm.setConditions([
    ...
    {"type": "field", "link": "Any", "terms": [{"field": "1", "operator": "equals", "value": "Extérieur"}], "action": {"field": "2", "visibility": "Show"}},
	  ...
	  {"type": "field", "link": "Any", "terms": [{"field": "1", "operator": "equals", "value": "Photocall"}], "action": {"field": "26", "visibility": "Show"}},
...
function generate_page ($page, $pageid) {
  ...
  if ($page=='Stand-expo-et-plv') {
    $h1name='PLV intérieur : Stands exposition, Kakemonos Roll-ups et totems';
    $imghead1='kakemonos1';
    $imghead2='kakemonos2';
    $imghead3='kakemonos3';
    $mini='bt-merge-int';
    $info_title='Stand exposition et PLV Intérieur';
    $info_info='<span class="prezHide">Tous nos supports de communication en intérieur: du roll-up à prix mini au stand exposition tissu complet, avec valise de transports et bank d\'accueil.</span>  <div class="helpMenu"><a href="'.get_bloginfo("url").'/en-cours/" target="_blank" class="notice modal-link"  title=""><i class="fa fa-lightbulb-o" aria-hidden="true"></i> <span class="textHide">AIDE</span></a>  <a href="'.get_bloginfo("url").'/notice-en-cours/" target="_blank" class="notice modal-link"  title=""><i class="fa fa-wrench" aria-hidden="true"></i> <span class="textHide">Notice technique</span></a> <a href="'.get_bloginfo("url").'/gabarits-en-cours/" target="_blank" class="notice modal-link"  title=""><i class="fa fa-object-group" aria-hidden="true"></i> <span class="textHide">Gabarits</span></a></div>';
  }

  if ($page=='Signaletique-exterieur') {
    $h1name='Signalétique extérieur : enseignes, oriflammes & tentes publicitaires';
    $imghead1='kakemonos1';
    $imghead2='kakemonos2';
    $imghead3='kakemonos3';
    $mini='bt-merge-ext';
    $info_title='Signalétique extérieur';
    $info_info='<span class="prezHide">Tous nos supports de communication en extérieur: enseignes boutiques ou tentes pour évennementiel et orfilammes.<br />Nos impressions sont garanties 2 ans en extérieur.</span>  <div class="helpMenu"><a href="'.get_bloginfo("url").'/en-cours/" target="_blank" class="notice modal-link"  title=""><i class="fa fa-lightbulb-o" aria-hidden="true"></i> <span class="textHide">AIDE</span></a>  <a href="'.get_bloginfo("url").'/notice-en-cours/" target="_blank" class="notice modal-link"  title=""><i class="fa fa-wrench" aria-hidden="true"></i> <span class="textHide">Notice technique</span></a> <a href="'.get_bloginfo("url").'/gabarits-en-cours/" target="_blank" class="notice modal-link"  title=""><i class="fa fa-object-group" aria-hidden="true"></i> <span class="textHide">Gabarits</span></a></div>';
  }
  ...
  if ($page=='Imprimerie-Papier') {
    $h1name='Imprimerie papier et affiches';
    $imghead1='kakemonos1';
    $imghead2='kakemonos2';
    $imghead3='kakemonos3';
    $mini='bt-merge-papier';
    $info_title='Imprimerie papier';
    $info_info='<span class="prezHide">Toutes nos impressions papier: Affiches, flyers, dépliants et cartes de visite.</span>  <div class="helpMenu"><a href="'.get_bloginfo("url").'/en-cours/" target="_blank" class="notice modal-link"  title=""><i class="fa fa-lightbulb-o" aria-hidden="true"></i> <span class="textHide">AIDE</span></a>  <a href="'.get_bloginfo("url").'/notice-en-cours/" target="_blank" class="notice modal-link"  title=""><i class="fa fa-wrench" aria-hidden="true"></i> <span class="textHide">Notice technique</span></a> <a href="'.get_bloginfo("url").'/gabarits-en-cours/" target="_blank" class="notice modal-link"  title=""><i class="fa fa-object-group" aria-hidden="true"></i> <span class="textHide">Gabarits</span></a></div>';
  }
  ...
  if ($page=='Banderoles') {
   ...
   if ($page=='cadre-tissu') {
		...
		$imghead3='kakemonos3';
		$mini='cadre-textile';
		$info_title='Cadre tissu pour habillage de stand.';
		$info_info='<span class="prezHide">France Banderole fabricant de cadre textile pour l’habillage de stand. Le cadre tissu vous permettra une décoration murale ou un habillage de cloison de stand pré-monté. Facilité de montage entre la structure et le visuel grâce au jonc incorporé sur le tissu.</span>   <div class="helpMenu"><a href="'.get_bloginfo("url").'/en-cours/" target="_blank"  class="notice modal-link"  title="Cadre textile : Tout savoir" ><i class="fa fa-lightbulb-o" aria-hidden="true"></i> <span class="textHide">AIDE</span></a>  <a href="'.get_bloginfo("url").'/notice-en-cours/" target="_blank" class="notice modal-link" title="Banderole : Tout savoir"><i class="fa fa-wrench" aria-hidden="true"></i> <span class="textHide">Notice technique</span></a> <a href="'.get_bloginfo("url").'/gabarits-en-cours/" target="_blank" class="notice modal-link" title="Enseigne stand suspendue : gabarit-enseigne stand suspendue"><i class="fa fa-object-group" aria-hidden="true"></i> <span class="textHide">Gabarits</span></a></div>';
		$formularz = get_cadre_form();
	}


	 if ($page=='enseigne-suspendue-textile') {
		$h1name='enseigne suspendue tissu pour stand';
		$imghead1='kakemonos1';
		$imghead2='kakemonos2';
		$imghead3='kakemonos3';
		$mini='enseigne-suspendue';
		$info_title='Enseigne suspendue textile pour stand d’exposition';
		$info_info='<span class="prezHide">France Banderole fabricant d’enseignes suspendues</span>   <div class="helpMenu"><a href="'.get_bloginfo("url").'/en-cours/" target="_blank"  class="notice modal-link"  title="Banderole : Tout savoir" ><i class="fa fa-lightbulb-o" aria-hidden="true"></i> <span class="textHide">AIDE</span></a>  <a href="'.get_bloginfo("url").'/notice-technique-enseigne-textile-suspendue/" target="_blank" class="notice modal-link" title="Banderole : Tout savoir"><i class="fa fa-wrench" aria-hidden="true"></i> <span class="textHide">Notice technique</span></a> <a href="'.get_bloginfo("url").'/gabarits-enseignes-suspendues/" target="_blank" class="notice modal-link" title="Enseigne stand suspendue : gabarit-enseigne stand suspendue"><i class="fa fa-object-group" aria-hidden="true"></i> <span class="textHide">Gabarits</span></a></div>';
		$formularz = get_enseigne_suspendue_form();
	}


  if (($page=='Stand-expo-et-plv') || ($page=='Signaletique-exterieur') || ($page=='Imprimerie-Papier') || ($page=='panneaux-forex-dibond') || ($page=='panneaux-akilux') || ($page=='Stickers')) {
	  $wycena = '';
	} else {
...
function print_devis_verification($products, $prolog, $epilog) {
  ...
  $fb_tablename_promo = $prefix."fbs_codepromo";
    ...
    if (!empty($_SESSION['loggeduser']) && (($exist_remise && $client_remise != 0 ) || !isRowEmpty($cat))) {
    ...
    if(isset($_POST['codeProm'] )) {
  		...
  		$exist_remise = $wpdb->get_row("SELECT * FROM `$fb_tablename_users_cf` WHERE att_name = 'client_remise' AND uid = '$uid'");
      $client_remise = $exist_remise->att_value;
      if (!empty($_SESSION['loggeduser']) && $exist_remise && $client_remise != 0) {
...
function print_devis($products, $prolog, $epilog) {
  ...
  $fb_tablename_shorturl = $prefix."fbs_shorturl";
    ...
    if (!empty($_SESSION['loggeduser']) && (($exist_remise && $client_remise != 0 ) || !isRowEmpty($cat))) {
      // si l'utilisateur est connecté et bénéficie déjà d'une remise, aucune remise intégrée
    }else{ //sinon
      if ($totalHT < 50) {
        $calculCode = 0;
        $miss = 50-$totalHT;
            ...
            if($curdate > $reduction->date) { // si le code a expiré:
              ...
              if($promoCat !== ('Tous')){ // si la réduction s'applique à une catégorie de produits:
                ...
                if($reduction->remise != 0) { // si la remise est en pourcentage
                  ...
                  $calculCode = $reducEu; // applique la réduction en euros
                  $checkcode = '<div class="box_info">Ce code applique une réduction de <strong>'.$reduction->reduction.' €</strong> sur les produits de type <strong>'.$promoCat.'</strong>, vous économisez <strong>'.$reducEu.' &euro;</strong> sur cette commande!</div>';
                }
                ...
                if($reduction->remise != 0) { // si la remise est en pourcentage
                  ...
                  $calculCode = $reduction->reduction; // applique la réduction en euros
                  $checkcode = '<div class="box_info">Ce code applique une réduction de <strong>'.$reduction->reduction.' €</strong> sur l\'ensemble de votre commande.</div>';
                }
              }
