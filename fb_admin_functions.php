...
function traitement_passage_paiement_recu($number,$fb_tablename_order,$fb_tablename_topic,$fb_tablename_mails,$fb_tablename_comments,$fb_tablename_comments_new,$fb_tablename_cf,$fb_tablename_users){
		...
		echo "///uzytSQL="."SELECT * FROM ".$fb_tablename_users." WHERE id = '".$ktoryuser."'";
		echo "///uzyt=".print_r($uzyt);
		echo "///ktoryuser=".$ktoryuser;
		echo "///ktoryuser=".print_r($ktoryuser);
		echo "///ktoryuser=".print_r($ktoryuser);
		*/
...
';	
		...
		mail($uzyt->email, stripslashes($temat), stripslashes($zawar), $header);
		//EN DEV: 
		/*mail("contact@tempopasso.com", stripslashes($temat), "VARIABLES:".
													"///type_expedition=".$type_expedition.
													"///wheresql=".$wheresql.
													"///adresse_relais_colis=".$adresse_relais_colis.
													"///type=".$type.
													"///valeur=".$valeur.
													"///reqtype_expedition=SELECT * FROM `$fb_tablename_cf` WHERE unique_id = $number".
													"///valeur=".$valeur.
													"///numberTNT_commande->tnt=".$numberTNT_commande->tnt.
													"///numberTNT_commande=SELECT tnt FROM `$fb_tablename_order` WHERE unique_id = $number"
...
function traitement_passage_cloture($number,$fb_tablename_order,$fb_tablename_topic,$fb_tablename_mails,$fb_tablename_comments,$fb_tablename_comments_new,$fb_tablename_cf,$fb_tablename_users,$fb_tablename_address){
		...
		echo "///ktoryuser=".print_r($ktoryuser);
		echo "MAIL=".$uzyt->email;
		echo "l_name=".$uzyt->l_name;
		echo "l_comp=".$uzyt->l_comp;
		echo "l_address=".$uzyt->l_address;
		echo "l_code=".$uzyt->l_code;
		echo "l_city=".$uzyt->l_city;
		
		
		echo "///REQ USER TABLE ADDRESS="."SELECT * FROM `$fb_tablename_address` WHERE unique_id = '$number'";
		echo "l_name=".$userZZ->l_name;
		echo "l_comp=".$userZZ->l_comp;
		echo "l_address=".$userZZ->l_address;
		echo "l_code=".$userZZ->l_code;
		echo "l_city=".$userZZ->l_city;
		*/
