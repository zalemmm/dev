...
new Vue({
  ...
  methods: {
    ...
    calculer: function(value) {
        ...
        if      (this.choixMurs == '1x Demi-mur')              cena+= (demimurA+barredmA)*1.6*this.qte;
        else if (this.choixMurs == '2x Demi-mur')              cena+= (demimurA+barredmA+demimurA+barredmB)*1.6*this.qte;
        else if (this.choixMurs == '1x Mur sup')               cena+= (mur)*1.6*this.qte;
        else if (this.choixMurs == '2x Mur sup')               cena+= (mur+mur)*1.6*this.qte;
        else if (this.choixMurs == '1x Mur sup + 1x Demi-mur') cena+= (mur+demimurA+barredmA)*1.6*this.qte;
        else if (this.choixMurs == 'sans mur')                 cena = (structure+canopi)*1.6*this.qte;

        //------------------------------------------------ prix impression recto

        if (this.impression == 'Mur de fond')                                                                 cena+= (murperso)*2.6*this.qte;
        if (this.impression == 'Murs et demi-murs' && this.choixMurs == '1x Demi-mur')                  cena+= (murperso+demimurAperso)*2.6*this.qte;
        if (this.impression == 'Murs et demi-murs' && this.choixMurs == '2x Demi-mur')                  cena+= (murperso+demimurAperso+demimurAperso)*2.6*this.qte;
        if (this.impression == 'Murs et demi-murs' && this.choixMurs == '1x Mur sup')                   cena+= (murperso+murperso)*2.6*this.qte;
        if (this.impression == 'Murs et demi-murs' && this.choixMurs == '2x Mur sup')                   cena+= (murperso+murperso+murperso)*2.6*this.qte;
        if (this.impression == 'Murs et demi-murs' && this.choixMurs == '1x Mur sup + 1x Demi-mur')     cena+= (murperso+murperso+demimurAperso)*2.6*this.qte;
        if (this.impression == 'Fronton')                                                             cena+= (frontonperso)*2.6*this.qte;
        if (this.impression == 'Full Graphic' && this.choixMurs == 'sans option')                     cena+= (frontonperso+murperso)*2.6*this.qte;
        if (this.impression == 'Full Graphic' && this.choixMurs == '1x Mur sup')                      cena+= (frontonperso+murperso+murperso)*2.6*this.qte;
        if (this.impression == 'Full Graphic' && this.choixMurs == '2x Mur sup')                      cena+= (frontonperso+murperso+murperso+murperso)*2.6*this.qte;
      	if (this.impression == 'Full Graphic' && this.choixMurs == '1x Demi-mur')       	            cena+= (frontonperso+murperso+demimurAperso)*2.6*this.qte;
        if (this.impression == 'Full Graphic' && this.choixMurs == '2x Demi-mur')                     cena+= (frontonperso+murperso+demimurAperso+demimurAperso)*2.6*this.qte;
        if (this.impression == 'Full Graphic' && this.choixMurs == '1x Mur sup + 1x Demi-mur')        cena+= (frontonperso+murperso+murperso+demimurAperso)*2.6*this.qte;
