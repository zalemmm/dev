<div id="prodApp">
	<div class="row">
		<div class="column" id="choicesContainer"> <!--bloc formulaire-->
			...
			<h3>Votre devis en ligne sticker prédécoupé</h3>
						...
						<li class="formSelect">
							...
							<transition name="slideDown">
								<div class="boutonsSelect" v-show="toggleProd">
									<div @mouseover="hoPw(1,'4')" @mouseout="hout(1)" v-tooltip.bottom="$global.vype" @click="reset(); selectProd('permanent',4);">
										<img :src="$global.img+'/stickers/4.png'" /><span>blanc permanent</span>
									</div>
									<div @mouseover="hoPw(1,'4')" @mouseout="hout(1)" v-tooltip.bottom="$global.vysp" @click="reset(); selectProd('semi-permanent',4);">
										<img :src="$global.img+'/stickers/4.png'" /><span>blanc semi-permanent</span>
									</div>
									<div @mouseover="hoPw(1,'4')" @mouseout="hout(1)" v-tooltip.bottom="$global.vy75" @click="reset(); selectProd('permanent 75μ',4);">
										<img :src="$global.img+'/stickers/4.png'" /><span>blanc permanent 75μ</span>
									</div>
								</div>
							</transition>
...
<script src="../wp-content/plugins/fbshop/prod_pages/sticker-predecoupe.vue.js?v=3.0"></script>
