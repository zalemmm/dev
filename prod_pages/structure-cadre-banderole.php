						...
						<li class="formSelect">
							...
							<transition name="slideDown">
								<div class="boutonsSelect" v-show="toggleProd">
									<div @mouseover="hoPw(1,'structure-banderole')" @mouseout="hout(1)" v-tooltip.bottom="$global.cstd" @click="reset(); selectProd('cadre mural');">
										<img :src="$global.img+'/structure-bache/structure-banderole.png'" /><span>Cadre mural</span>
									</div>
									<div @mouseover="hoPw(1,'structure-banderole-pied')" @mouseout="hout(1)" v-tooltip.bottom="$global.clum" @click="reset(); selectProd('cadre sur pied');">
...
<script src="../wp-content/plugins/fbshop/prod_pages/vue.structure-cadre-banderole.js?v=2.6"></script>
