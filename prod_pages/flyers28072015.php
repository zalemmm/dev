        ...
        <div class="form-all">
            <ul class="form-section">
                ...
                <li class="form-line" id="id_1">
                    ...
                    <a href="#grammage"><img style="float:right" border="0" title="Cliquez pour plus d'infos" src="http://www.france-banderole.com/wp-content/plugins/fbshop/images/interrogation.png"></a>
                ...
                <li class="form-line" id="id_21">
                    ...
                    <a href="#taille"><img style="float:right" border="0" title="Cliquez pour plus d'infos" src="http://www.france-banderole.com/wp-content/plugins/fbshop/images/interrogation.png"></a>
                    <select class="form-dropdown validate[required]" id="input_21" name="q21_usage" onchange="getElementById('preview_info_ul').innerHTML = '';JKakemono.czyscpola();">
                        <option value="">choisir...</option>
                        <option style="background-color:#e8e8e9" value="1">A7 (7,4 x 10,5 cm) Recto</option>
                        <option style="background-color:#e8e8e9" value="2">A7 (7,4 x 10,5 cm) Recto/Verso</option>
                        <option value="3">A6 (10,5 x 14,8 cm) Recto</option>
                        <option value="4">A6 (10,5 x 14,8 cm) Recto/Verso</option>
                        <option style="background-color:#e8e8e9" value="5">A5 (14,8 x 21 cm) Recto</option>
                        <option style="background-color:#e8e8e9" value="6">A5 (14,8 x 21 cm) Recto/Verso</option>
                        <option value="7">A4 (21 x 29,7 cm) Recto</option>
                        <option value="8">A4 (21 x 29,7 cm) Recto/Verso</option>
                        <option style="background-color:#e8e8e9" value="9">DIN long (10 x 21 cm) Recto</option>
                        <option style="background-color:#e8e8e9" value="10">DIN long (10 x 21 cm) Recto/Verso</option>
                ...
                <li class="form-line" id="id_5">
                    ...
                    <img style="float:right" border="0" title="Cliquez pour plus d'infos" src="http://www.france-banderole.com/wp-content/plugins/fbshop/images/interrogationbis.png">
                ...
                <li id="id_101" class="form-line optionsformline">
                    ...
                    <span class="options_single" style="margin-top: 14px;">
                        <span class="optionsleft" style="border: 1px solid #9FA3A8; font-weight: bold; width: 48%;">
                            ...
                            <label class="form-label-left" id="label_fedex" for="fedex">Livraison gratuite<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;avec Fedex</label>
                            ...
                            <span class="helpButton" onmouseover="pokazt('helpTextfedex');" onmouseout="ukryjt('helpTextfedex');">
                                <span class="helpText" id="helpTextfedex" style="visibility:hidden;">Livraison gratuite avec Fedex en 7 à 9 jours ouvrés (non compatible avec les délais Rush, et Relais colis).</span>
                            </span>
                        </span>
                        <span class="optionsright">
                            <label class="form-label-left" id="label_tnt" for="tnt">Livraison avec TNT</label>
                            ...
                            <span class="helpButton" onmouseover="pokazt('helpTexttnt');" onmouseout="ukryjt('helpTexttnt');">
                                <span class="helpText" id="helpTexttnt" style="visibility:hidden;">Livraison payante avec TNT en 6 à 8 jours ouvrés (non compatible avec un colis hors-norme*)</span>
                            </span>
                        </span>
                    </span>
                </li>
                <li class="form-line" id="id_26a" style="margin-top: 20px;">
