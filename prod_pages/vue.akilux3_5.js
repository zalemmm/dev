...
new Vue({
  ...
  methods: {
    ...
    calculer: function(value) {
        ...
        if (metraz <= 0.24) {
          if (np <= 1) {
            if (this.qte <=1)                  coupe = -8*this.qte;
            if (this.qte > 1 && this.qte <= 2) coupe = -1.5*this.qte;
            if (this.qte > 2 && this.qte <= 3) coupe = -0.5*this.qte;
            if (this.qte > 3 && this.qte <= 4) coupe = -0.2*this.qte;
            if (this.qte > 4)                  coupe = 1*this.qte;
          }

          if (np > 1 && np <= 2) {
            if (this.qte <=9)                   coupe = 0.3*this.qte;
            if (this.qte > 9 && this.qte <= 10) coupe = 0.2*this.qte;
            if (this.qte > 10)                  coupe = 1*this.qte;
          }
          ...
          if (np > 7   && np <= 8)   coupe = 0.4*this.qte;
          if (np > 8   && np <= 9)   coupe = 0.5*this.qte;
          ...
          if (np > 24  && np <= 25)  coupe = 0.08*this.qte;
          if (np > 25  && np <= 31)  coupe = 0.05*this.qte;
          if (np > 31  && np <= 99)  coupe = 0.0*this.qte;
        ...
        if (metraz > 0.24 && metraz <= 0.48) {
          if (np <= 1){
            if (this.qte <= 1)                 coupe = -5*this.qte;
            if (this.qte > 1 && this.qte <=2 ) coupe = -2*this.qte;
            if (this.qte > 2)                  coupe = 0.5*this.qte;
          }

          if (np > 1 && np <=2){
            if (this.qte <= 5) coupe = 0.0*this.qte;
            if (this.qte >  5) coupe = 0.5*this.qte;
          }

          if (np > 2   && np <= 3)   coupe = 0.3*this.qte;
          if (np > 3   && np <= 4)   coupe = 0.5*this.qte;
          if (np > 4   && np <= 6)   coupe = 0.5*this.qte;
          if (np > 6   && np <= 7)   coupe = 0.25*this.qte;
          if (np > 7   && np <= 8)   coupe = 0.2*this.qte;
          if (np > 8   && np <= 9)   coupe = 0.3*this.qte;
          if (np > 9   && np <= 16)  coupe = 0.25*this.qte;
          if (np > 16  && np <= 17)  coupe = 0.38*this.qte;
          if (np > 17  && np <= 18)  coupe = 0.42*this.qte;
          if (np > 18  && np <= 21)  coupe = 0.28*this.qte;
          if (np > 21  && np <= 22)  coupe = 0.25*this.qte;
          if (np > 22  && np <= 24)  coupe = 0.20*this.qte;
          ...
          if (np > 74  && np <= 90)  coupe = 0.12*this.qte;
        ...
        if (metraz > 0.48 && metraz <= 0.96) {
          ...
          if (np > 1 && np <= 2) {
            if (this.qte <=3) coupe = -0.5*this.qte;
            if (this.qte > 3) coupe = 1.5*this.qte;
          }

          if (np > 2   && np <= 3)   coupe = 0.20*this.qte;
          if (np > 3   && np <= 4)   coupe = 0.5*this.qte;
          if (np > 4   && np <= 6)   coupe = 0.5*this.qte;
          if (np > 6   && np <= 7)   coupe = 0.25*this.qte;
          if (np > 7   && np <= 8)   coupe = 0.2*this.qte;
          ...
          if (np > 24  && np <= 25)  coupe = 0.15*this.qte;
          if (np > 25  && np <= 31)  coupe = 0.10*this.qte;
          if (np > 31  && np <= 39)  coupe = 0.50*this.qte;
          if (np > 39  && np <= 62)  coupe = 0.15*this.qte;
        ...
        if (metraz > 1.92 && metraz <= 3){
          if (np <=1)                  coupe = 2*this.qte;
          if (np > 1 && np <= 2)       coupe = 1.8*this.qte;
          if (np > 2 && np <= 1000000) coupe = 1.2*this.qte;
        }
        ...
        } else if ( this.hauteur > 150 && this.largeur > 150) {
  				this.errorMessage = '<i class="fa fa-warning"></i> Attention nos panneaux font au maximum 200x150cm!';
  				this.erreurType=1; this.reqHaut = this.reqLarg = 'required';

  			} else if ( this.hauteur > 200 || this.largeur > 200) {
  				this.errorMessage = '<i class="fa fa-warning"></i> Attention nos panneaux font au maximum 200x150cm!';
  				this.erreurType=1; this.reqHaut = this.reqLarg = 'required';
