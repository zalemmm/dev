			...
			<form class="vueForm" action="" method="post" name="vueForm" id="vueForm" accept-charset="utf-8">
				<div class="form-all">
					<ul class="formSection">
						...
						<li class="formSelect" v-show="showAccr && mur">

							<button type="button" class="toggle" :class="reqAccr" @click="toggleAccr = !toggleAccr">
								{{ choixAccr }} <i class="fa fa-caret-down"></i>
							</button>

							<transition name="slideDown">
								<div class="boutonsSelect" v-show="toggleAccr">

									<div @mouseover="hoPw(9,'Accroches murales')" @mouseout="hout(9)" v-tooltip.bottom="$global.b550m2" @click="reset(); selectAccr('Accroches murales');">
										<i class="fa fa-wrench"></i><span>Accroches murales</span>
									</div>
									<div @mouseover="hoPw(9,'Accroches bardages')"  @mouseout="hout(9)" v-tooltip.bottom="$global.microm2" @click="reset(); selectAccr
									('Accroches bardages');">
										<i class="fa fa-wrench"></i><span>Accroches bardages</span>
									</div>
								</div>
							</transition>
						...
						<li class="formSelect" v-show="showProj">

							<button type="button" class="toggle" :class="reqProj" @click="toggleProj = !toggleProj">
								{{ choixProj }} <i class="fa fa-caret-down"></i>
							</button>

							<transition name="slideDown">
								<div class="boutonsSelect" v-show="toggleProj">
									<div @mouseover="hoPw(9,'Sans option projecteurs')" @mouseout="hout(9)" v-tooltip.bottom="$global.projecteurssans" @click="reset(); selectProj('Sans option projecteurs');">
										<i class="fa fa-ban"></i><span>Pas d'option projecteurs</span>
									</div>
									<div @mouseover="hoPw(9,'Supports avec tubes 0.5m')" @mouseout="hout(9)" v-tooltip.bottom="$global.projecteurs05" @click="reset(); selectProj('Supports avec tubes 0.5m');">
										<i class="fa fa-volume-off fa-rotate-90"></i><span>Supports avec tubes 0.5m</span>
									</div>
									<div @mouseover="hoPw(9,'Supports avec tubes 1m')"  @mouseout="hout(9)" v-tooltip.bottom="$global.projecteurs10" @click="reset(); selectProj('Supports avec tubes 1m');">
										<i class="fa fa-volume-off fa-rotate-90"></i><span>Supports avec tubes 1m</span>
									</div>
									<div @mouseover="hoPw(9,'Supports avec tubes 1.5m')"  @mouseout="hout(9)" v-tooltip.bottom="$global.projecteurs15" @click="reset(); selectProj('Supports avec tubes 1.5m');">
										<i class="fa fa-volume-off fa-rotate-90"></i><span>Supports avec tubes 1.5m</span>
									</div>
								</div>
							</transition>
...
<script src="../wp-content/plugins/fbshop/prod_pages/structure-cadre-banderole.vue.js?v=3.0"></script>
