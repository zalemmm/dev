...
<form class="jotform-form" action="" method="post" name="form_1060900217" id="1060900217" accept-charset="utf-8" onsubmit="JKakemono.cal_akilux10mm(); return false;">
    <div class="form-all">
			...
			<li class="form-line" id="id_1">
                <label class="form-label-left" id="label_1" for="input_1">dimensions: </label>
                    <select class="form-dropdown validate[required]" id="input_1" name="q1_usage" onchange="JKakemono.czyscpola(); ">
                        ...
                        <option value="160x60">160x60cm</option>
            ...
            <li class="form-line" id="id_32">
                <label class="form-label-left" id="label_32" for="input_32">quantité: </label>
                    <select class="form-dropdown validate[required]" id="input_32" name="q32_usage" onchange="JKakemono.czyscpola(); ">
                        ...
                        <option style="background-color:#e8e8e9" value="11">11</option>
                        <option value="12">12</option>
                        <option style="background-color:#e8e8e9" value="13">13</option>
                        <option value="14">14</option>
                        <option style="background-color:#e8e8e9" value="15">15</option>
                        <option value="16">16</option>
                        <option style="background-color:#e8e8e9" value="17">17</option>
                        <option value="18">18</option>
                        <option style="background-color:#e8e8e9" value="19">19</option>
