    ...
    <ul class="form-section">
      ...
      <li id="id_101" class="form-line optionsformlineOld">
        ...
        <span class="options_single">
          ...
          <span class="optionsright"><label class="form-label-left" id="label_etiquette" for="etiquette">Retrait colis à l'Atelier</label>
          ...
          <span class="optionsleft"><label class="form-label-left" id="label_rush24" for="rush24">Délai Rush 24/48H</label>
            ...
            <span class="helpButton" onmouseover="pokazt('helpTextRush24');" onmouseout="ukryjt('helpTextRush24');">
              <span class="helpText" id="helpTextRush24" style="visibility:hidden;">Pour toute commande passée et réglée avant midi du lundi au jeudi, le colis sera livré le lendemain ou surlendemain avant 13h00 par TNT Express à l’adresse indiquée par le client.</span>
            </span>
          </span>
          ...
          <span class="optionsleft"><label class="form-label-left" id="label_economique" for="economique">Délai économique 6 à 8 jours ouvrés</label>
            <input type="checkbox" class="form-checkbox" id="economique" name="economique[]" value="" onchange="JKakemono.rushcheckboxeconomique();; JKakemono.czyscpola(); ">
            <span class="helpButton" onmouseover="pokazt('helpTextRush72');" onmouseout="ukryjt('helpTextRush72');">
              <span class="helpText" id="helpTextRush72" style="visibility: hidden;">Vous n’êtes pas pressé et souhaitez économiser 30%, vos délais de livraison seront de 6 à 8 jours ouvrés.</span>
            </span>
          </span>
