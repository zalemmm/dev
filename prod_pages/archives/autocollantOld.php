	...
	jQuery(document).ready(function(){
		jQuery('.delivery , .production').click(function(){
			...
			if ( ($('input_1').value == 'permanent') ) {
				designation='Autocollant (carré/rectangulaire)';
...
if (($('input_1').value == 'permanent') || ($('input_1').value == 'semi-permanent') || ($('input_1').value == 'permanent75μ') )  {
			...
			if ( ($('input_1').value == 'vinyle magnètique') && (largeur > 60) ) {
