<div id="prodApp">
	<div class="row">
		<div class="column" id="choicesContainer"> <!--bloc formulaire-->
			...
			<h3>Votre devis en ligne Forex 5mm</h3>
		...
		<div class="column" id="previewContainer">
			<div class="helpMenu">
				...
				<a :href="$global.url+'/gabarit-forex-5mm/'" class="notice modal-link"  title="gabarits maquette">
			...
			<div id="previewImg">
				...
				<transition name="slideLeft" mode="out-in">
					<div class="preview_imag1" :style="bg1" v-show="pr1">
						...
						<img   v-show="calqueImage" :src="detImg" alt="détail qualité impression" id="zoomImg" style="cursor: zoom-in" />
					</div>
				</transition>
...
<script src="../wp-content/plugins/fbshop/prod_pages/vue.forex5.js?v=3.0"></script>
