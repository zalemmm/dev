<div id="buying">
	...
	<form class="jotform-form" action="" method="post" name="form_1060900217" id="1060900217" accept-charset="utf-8" onsubmit="JKakemono.cal_dibond(); return false;">
		...
		<div class="form-all">
				...
				<li class="form-line select" id="id_HD">
					<span class="helpButton"><img class="helpImg" src="../wp-content/plugins/fbshop/images/question.png">
						<span class="helpText" id="helpTextHD" style="visibility:hidden;">
							...
							• <span class="highlight"><u><b>Impression dibond standard :</b></u></span><br/>impression directe UV 600x600Dpi. Pour une impression dibond pas cher de très bonne qualité à 1 mètre.<a href="../wp-content/uploads/2016/12/impression-HD-panneaux-akylux-pas-cher-big.jpg" title="impression Haute définition panneaux dibond pas cher"><img class="" title="impressio HD panneaux akylux pas cher" alt="panneaux imprimés dibond pas cher" src="../wp-content/uploads/2016/12/impression-HD-panneaux-akylux-pas-cher.jpg"></a><br/>
						</span>
					</span>
          ...
          <span class="helpButton">
              ...
              <b>Perçage:</b><br/>
							Nous perçons votre panneau dibond pour faciliter sa pose.<br/>
							<b>Pelliculage:</b><br/>
							Nous posons un film de protecttion sur votre panneau dibond. Ce pelliculage offre à votre support d’impression une protection optimale contre les éléments climatiques (abrasion, UV, rayures, vandalisme…). Vous aurez le choix entre une <strong>pelliculage brillant, mate, ou anti graffiti</strong><br/>
						</span>
					</span>
	...
	<div id="preview">
		  ...
		  <div id="container">
		   ...
		   <div id="slides">
					<li><img src="../wp-content/plugins/fbshop/images/enseignes/slide/panneau-alu-dibond.jpg" alt="panneau alu dibond publicitaire" title="impression panneau alu dibond pas cher" /></li>
		      <li><img src="../wp-content/plugins/fbshop/images/enseignes/slide/enseigne-alu-dibond.jpg" alt="panneau alu dibond meilleur prix" title="panneau alu dibond imprimé haute défintion"  /></li>
              <li><img src="../wp-content/plugins/fbshop/images/enseignes/slide/enseigne-dibond.jpg" alt="panneaux enseigne dibond pas cher" title="enseigne dibond imprimée haute défintion"  /></li>
...
<script type="text/javascript">
	...
	jQuery(document).ready(function(){
		...
		///////////////////////////////////////////////////////////////////////////
				...
				poids = 4.20*metraz; ////grammage x m²///
      ...
      //////////////////////////////////////////////////////////////////////////
			...
			if ( (hauteur > 100) || (largeur > 100) ) {
					warning += '- Enseigne livrée découpée en mètre linéaire.<br />Si vous souhaitez votre enseigne en 1 morceau, veuillez cocher l\'option "Grand format livré entier" (uniquement pour une enseigne inférieure à 200x300cm).<br />';
			...
			if ( ((hauteur > 200) && (largeur > 300)) || ((hauteur > 300) && (largeur > 200)) ) {
					warning += '- Votre enseigne est supérieure à 200x300cm, elle sera donc produite sur plusieurs plaques<br />';
					aBox.style.display="block";
					erreurType=0;
			}
