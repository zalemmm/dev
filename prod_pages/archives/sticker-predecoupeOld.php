		...
		<div class="form-all">
			<ul class="form-section">
				...
				<li class="form-line select" id="id_1">
					<span class="helpButton"><img class="helpImg" src="http://www.france-banderole.com/wp-content/plugins/fbshop/images/question.png"><span class="helpText" id="helpTextsupport" style="visibility:hidden;">Support</span></span>
          ...
          <span class="helpButton">
            <img class="helpImg" src="../wp-content/plugins/fbshop/images/question.png">
              ...
              <b>Pelliculage anti graffiti:</b><br/>
					...
					<select class="form-dropdown validate[required]" id="input_lamination" name="lamination_usage" onclick="JKakemono.czyscpola(); ">
                        ...
                        <option value="sans">sans pelliculage</option>
            ...
            <option value="pelliculage laqué anti graffiti">pelliculage anti graffiti</option>
				...
				<li class="form-line select" id="id_4">
					<span class="helpButton"><img class="helpImg" src="http://www.france-banderole.com/wp-content/plugins/fbshop/images/question.png"><span class="helpText" id="helpTextoption" style="visibility:hidden;">Option</span></span>
	...
	jQuery(document).ready(function(){
		jQuery('.delivery , .production').click(function(){
			...
			//////////////////////////////////////////////////////////////////// lamination//
				...
				if ((hauteur < 160) && (largeur < 160) && (largeur <= hauteur) ) {Prixlamination= 160*(largeur*0.0008);}
				if ((hauteur < 160) && (largeur < 160) && (hauteur <= largeur) ) {Prixlamination= 160*(hauteur*0.0008);}
				if ((hauteur < 160) && (largeur >= 160) ) {Prixlamination= 160*(largeur*0.0008);}
				if ((largeur < 160) && (hauteur >= 160) ) {Prixlamination= 160*(hauteur*0.0008);}

				if ((hauteur < 160) && (largeur == 160) ) {Prixlamination= metraz*0.0008;}
				if ((largeur < 160) && (hauteur == 160) ) {Prixlamination= metraz*0.0008;}
				...
				if ((hauteur < 160) && (largeur < 160) && (largeur <= hauteur) ) {Prixlamination= 160*(largeur*0.0010);}
				if ((hauteur < 160) && (largeur < 160) && (hauteur <= largeur) ) {Prixlamination= 160*(hauteur*0.0010);}
				if ((hauteur < 160) && (largeur >= 160) ) {Prixlamination= 160*(largeur*0.0010);}
				if ((largeur < 160) && (hauteur >= 160) ) {Prixlamination= 160*(hauteur*0.0010);}

				if ((hauteur < 160) && (largeur == 160) ) {Prixlamination= metraz*0.0010;}
				if ((largeur < 160) && (hauteur == 160) ) {Prixlamination= metraz*0.0010;}
				...
				if ((hauteur < 160) && (largeur < 160) && (largeur <= hauteur) ) {Prixlamination= 160*(largeur*0.0018);}
				if ((hauteur < 160) && (largeur < 160) && (hauteur <= largeur) ) {Prixlamination= 160*(hauteur*0.0018);}
				if ((hauteur < 160) && (largeur >= 160) ) {Prixlamination= 160*(largeur*0.0018);}
				if ((largeur < 160) && (hauteur >= 160) ) {Prixlamination= 160*(hauteur*0.0018);}

				if ((hauteur < 160) && (largeur == 160) ) {Prixlamination= metraz*0.0018;}
				if ((largeur < 160) && (hauteur == 160) ) {Prixlamination= metraz*0.0018;}

				if ((hauteur < 160) && (largeur < 160) && (hauteur <= largeur) ) {Prixlamination= 160*(hauteur*0.0018);}
				if ((hauteur >= 160) && (largeur >= 160) ) {Prixlamination= metraz*0.0018;}
				opis += '<br />- pelliculage laqué anti graffiti';
				}
				if ($('input_lamination').value == 'sans')  {Prixlamination= 0;}
				cena+=Prixlamination;
			...
			//////////////////////////////////////////////////// messages d'erreur  //
			if ( (largeur > 152) && (hauteur > 152) ) {
				eBox.innerHTML = '<button class="closeButton"><i class="ion-ios-close-empty" aria-hidden="true"></i></button><img src="//www.france-banderole.com/wp-content/themes/fb/images/exclamation-octagon.png" class="exclam" alt="attention" /> Hauteur ou Largeur doit être inférieure à 152cm!';
				niepokazuj=1;
			}
			...
			if ( ($('input_4').value == 'tape') && (largeur > 130) && (hauteur > 130) ) {
				eBox.innerHTML = '<button class="closeButton"><i class="ion-ios-close-empty" aria-hidden="true"></i></button><img src="//www.france-banderole.com/wp-content/themes/fb/images/exclamation-octagon.png" class="exclam" alt="attention" /> Avec le TAPE Hauteur ou Largeur doit être inférieure à 130cm!';
				niepokazuj=1;
			}
			...
			if ((niepokazuj==0) && ((DeliveryType == '2-3') || (DeliveryType == '1-1') || (DeliveryType == '3-4'))){
				...
				dodajkoszyk.innerHTML = '<input type="hidden" name="addtocart" value="addtocart" /><input type="hidden" name="rodzaj" value="Sticker prédécoupé" /><input type="hidden" name="opis" value="- '+$('input_1').value+'<br />- '+designation+'<br />- '+maquette+cedzik+etiqdesc+prliv+opis+'</br>- H|'+hauteur+' x L|'+largeur+' cm" /><input type="hidden" name="ilosc" value="'+ilosc+'" /><input type="hidden" name="prix" value="'+cena2+' &euro;" /><input type="hidden" name="option" value="'+option2+'" /><input type="hidden" name="remise" value="'+rabat2+'" /><input type="hidden" name="total" value="'+suma2+' &euro;" /><input type="hidden" name="transport" value="'+transport+' &euro;" /><input type="hidden" name="hauteur" value="'+hauteur+'" /><input type="hidden" name="largeur" value="'+largeur+'" /><button id="submit_cart" type="submit"><i class="fa fa-shopping-cart" aria-hidden="true"></i> ajouter au panier</button> ';
