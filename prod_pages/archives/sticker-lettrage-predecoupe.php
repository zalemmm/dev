<div id="prodApp">
	<div class="row">
		<div class="column" id="choicesContainer"> <!--bloc formulaire-->
			...
			<h3>Votre devis en ligne sticker lettrage prédécoupé</h3>
			...
			<form class="vueForm" action="" method="post" name="vueForm" id="vueForm" accept-charset="utf-8">
				<div class="form-all">
					<ul class="formSection">
						...
						<li class="formSelect">
							...
							<transition name="slideDown">
								<div class="boutonsSelect" v-show="toggleProd">
									<div @mouseover="hoPw(1,'5')" @mouseout="hout(1)" v-tooltip.bottom="$global.vype" @click="reset(); selectProd('permanent',5);">
										<img :src="$global.img+'/stickers/5.png'" /><span>blanc permanent</span>
									</div>
									<div @mouseover="hoPw(1,'5')" @mouseout="hout(1)" v-tooltip.bottom="$global.vysp" @click="reset(); selectProd('semi-permanent',5);">
										<img :src="$global.img+'/stickers/5.png'" /><span>blanc semi-permanent</span>
									</div>
									<div @mouseover="hoPw(1,'5')" @mouseout="hout(1)" v-tooltip.bottom="$global.vy75" @click="reset(); selectProd('permanent 75μ',5);">
										<img :src="$global.img+'/stickers/5.png'" /><span>blanc permanent 75μ</span>
									</div>
								</div>
							</transition>
						...
						<li class="formSelect" v-show="showLami">
							...
							<transition name="slideDown">
								<div class="boutonsSelect" v-show="toggleLami">
									<div @mouseover="hoPw(9,'sans pelliculage');" @mouseout="hout(9)" v-tooltip.bottom="$global.pbri" @click="reset(); selectLami('sans pelliculage', 'sans');">
										<i class="fa fa-ban"></i><span>sans pelliculage</span>
									</div>
									...
									<div @mouseover="hoPw(3,'brillant');" @mouseout="hout(3)" v-tooltip.bottom="$global.pgrf" @click="reset(); selectLami('pelliculage laqué anti graffiti', 'brillant');">
										<img :src="$global.img+'/enseignes/brillant.svg'" /></i><span>pelliculage anti graffiti</span>
									</div>
								</div>
							</transition>
						...
						<li class="formSelect" v-show="showColor">

							<button type="button" class="toggle" :class="reqColor" @click="toggleColor = !toggleColor">
								{{ choixColor }} <i class="fa fa-caret-down"></i>
							</button>

							<transition name="slideDown">
								<div class="boutonsSelect" v-show="toggleColor" >
									<div @mouseover="hoPw(9,'lettrage blanc');" @mouseout="hout(9)" v-tooltip.bottom="$global.psi" @click="reset(); selectColor('lettrage blanc');">
										<i class="fa fa-ban" aria-hidden="true"></i><span>lettrage blanc</span>
									</div>
									<div @mouseover="hoPw(9,'lettrage couleur');" @mouseout="hout(9)" v-tooltip.bottom="$global.pne" @click="reset(); selectColor('lettrage couleur');">
										<i class="fa fa-tint" aria-hidden="true"></i><span>lettrage couleur</span>
									</div>
								</div>
							</transition>
...
<script src="../wp-content/plugins/fbshop/prod_pages/vue.sticker-lettrage.js?v=3.0"></script>
