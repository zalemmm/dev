      ...
      <ul class="form-section">
        ...
        <li class="form-line optionsformline4" id="id_4">
          ...
          <select class="form-dropdown validate[required]" id="input_4" name="4_usage" onclick="JKakemono.czyscpola(); ">
            ...
            <option value="crochets">crochets invisibles</option>
        ...
        <li class="form-line select" id="id_5">
          ...
          <li class="form-line optionsformline2" id="id_13" data-trigger="spinner">
            ...
            <input type="text" class="form-textbox textboxPush validate[required, Numeric]" id="input_13" name="q13_quantite" size="20" value="1" onclick="JKakemono.czyscpola(); "   data-rule="quantity" />
					...
					<li id="id_9" class="form-line optionsformline2" style="nothing">
					<label class="form-label-left label-highlight" id="label_9" for="input_9">taille :<strong><span class="highlight small"><br />(centimètres)</span></strong></label>
					<input type="text" class="taille form-textbox validate[required, Numeric]" placeholder="hauteur" id="input_9" name="q9_taile" size="20" value="1" onclick="JKakemono.czyscpola();" />
					<span class="mLeft highlight">cm</span><span class="heusepar">x</span>
					<input type="text" class="taille form-textbox2 validate[required, Numeric]" id="input_10" placeholder="largeur" name="q10_taile" size="20" value="1" onclick="JKakemono.czyscpola();" /><span class="mRight highlight">cm</span>
				</li>
          ...
          <li id="id_7" class="form-line optionsformline" style="z-index:100">
            ...
            <span class="options_single">
              ...
              <span class="optionsleft roll dis0"><label class="form-label-left" id="label_roll" for="roll">Grand format livré entier</label>
							<input type="checkbox" class="form-checkbox" id="roll" name="roll[]" value="" onclick="JKakemono.czyscpola();" />
							<span class="helpButton">
								<span class="helpText" id="helpTextpalette" style="visibility:hidden;"><strong><u>Forfait palettisation:</u></strong> <span class="highlight">dès 160€ HT</span><br />
 ...
 jQuery('#adresse').click(function() {
  ...
  function Masquer()   {
    ...
    divInfo.style.display = 'none';
  	...
  	///////////////////////////////////////// affichage option roll //

	jQuery('.taille').keyup(function(){
		jQuery(this).val(jQuery(this).val().replace(/,/g, '.'));

		var taille = jQuery(this).val();
		var hauteur = jQuery("#input_9").val();
		var largeur = jQuery("#input_10").val();

		if (  parseInt(hauteur) + parseInt(largeur) >= 200.00 ) {
  ...
  jQuery(document).ready(function(){
    jQuery('.delivery , .production').click(function(){
	  ...
	  if ( parseInt(largeur) + parseInt(hauteur)  >= 210) {
			
					warning += '- Nos panneaux sont livrés en mètre linéaire, si vous souhaitez votre panneau en 1 seul morceau cochez l\'option "Grand format livré entier"<br />';
