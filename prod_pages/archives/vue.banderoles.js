...
new Vue({
  ...
  methods: {
    ...
    selectSupport: function(value) {
        ...
        if (this.support == 'bache 100% écologique M1 dos noir') this.bg1 = {backgroundImage: 'url('+this.$global.img+'/banderole/eco.png)'};
    ...
    checkSize: function(input, value) {
        if (value < 0.1 || isNaN(value) || value == '' || value >= 50) {
    ...
    calculer: function(value) {
        ...
        //------------------------- prix de la banderole en fonction de la laize
    		...
    		if (perteH < perteL){
    			...
    			////bache 100% écologique M1 dos noir
    			if ((this.support == 'bache 100% écologique M1 dos noir' ) && (h1<=1.00) ){plm =18.69 ;}
    			if ((this.support == 'bache 100% écologique M1 dos noir' ) && ((h1>=1.01)&&(h1<=1.60)) ){plm =19.62 ;}
    			if ((this.support == 'bache 100% écologique M1 dos noir' ) && ((h1>=1.61)&&(h1<=2.00))){plm =20.56 ;}
    			if ((this.support == 'bache 100% écologique M1 dos noir' ) && ((h1>=2.01)&&(h1<=2.50))){plm =21.49 ;}
    			if ((this.support == 'bache 100% écologique M1 dos noir' ) && (h1>=2.51)){plm =22.43 ;}
    			////capotoile
    			...
    			////bache 100% écologique M1 dos noir
    			if ((this.support == 'bache 100% écologique M1 dos noir' ) && (l1<=1.00) ){plm =18.69 ;}
    			if ((this.support == 'bache 100% écologique M1 dos noir' ) && ((l1>=1.01)&&(l1<=1.60)) ){plm =19.62 ;}
    			if ((this.support == 'bache 100% écologique M1 dos noir' ) && ((l1>=1.61)&&(l1<=2.00))){plm =20.56 ;}
    			if ((this.support == 'bache 100% écologique M1 dos noir' ) && ((l1>=2.01)&&(l1<=2.50))){plm =21.49 ;}
    			if ((this.support == 'bache 100% écologique M1 dos noir' ) && (l1>=2.51)){plm =22.43 ;}
    			////capotoile
    		...
    		//--------------------------------------------------------------100% éco
    		if (this.support == 'bache 100% écologique M1 dos noir' ) {
    			if (metragefinal < 1.99) {cenatotal = this.prixTotal;}
    			if ((metragefinal > 1.99) && (metragefinal <= 3.99)) {cenatotal = this.prixTotal*0.99;}
    			if ( (metragefinal > 3.99) && (metragefinal <= 5.99) ) {cenatotal = this.prixTotal*0.98;}
    			if ( (metragefinal > 5.99) && (metragefinal <= 7.99) ) {cenatotal = this.prixTotal*0.97;}
    			...
    			if ( (metragefinal > 399.99) && (metragefinal <= 499.99) ) {cenatotal = this.prixTotal*0.79;}
    			if (metragefinal > 499.99) {cenatotal = this.prixTotal*0.78;}
    			bacheType = '- bache 100% écologique M1 dos noir'
    		}
        ...
        if (this.largeur > 1.6 && this.hauteur > 1.6 && this.relais == true) {
  				this.errorMessage = '<i class="fa fa-warning"></i> Pour la livraison en relais colis, Hauteur ou Largeur doit être inférieure à 1.6m!';
        ...
        //--------------------------------------------------------------ecotoile
  			...
  			//-------------------------------------------------------100% écologique
  			else if ( this.support == 'bache 100% écologique M1 dos noir' && this.largeur > 2.5 && this.hauteur > 2.5 ) {
  				this.errorMessage = '<i class="fa fa-warning"></i> Hauteur ou Largeur doit être inférieure à 2.5m!';
  				this.erreurType = 1; this.reqHaut = this.reqLarg = 'required';
  			}
        //-------------------------------------------------------jet 550 enduite
