    ...
    calculer: function(value) {
        ...
        if (this.produit == 'Tissu droit' || this.produit == 'Tissu courbe') {
          ...
          //------------------------------------------------------------------------
            ...
            scratch = (this.hauteur*4)+(this.largeur*2);
        		structure = 75;
		  ...
		  hauteurtextile = this.hauteur+31;///// hauteur utilisé
		  scratch = (this.hauteur*4)+(this.largeur*2)+(verso*2);//// scratch utilisé
		  textile = (hauteurtextile*this.largeur)+(hauteurtextile*verso);//// textile utilisé
		  surfaceprint = (this.largeur*this.hauteur)+(verso*this.hauteur);
		  ///////COEF PRIX//
		  printprix = surfaceprint*3.50; ////COEF print
		  if (this.support == 'tissu 220g' ) {textileprix=textile*2.1} ////COEF 220g utilisé
		  if (this.support == 'tissu 260g' ) {textileprix=textile*4.5} ////COEF 260g utilisé
		  scratchprix = scratch*0.40; ////COEF scratch
		  structureprix = structure*1.75; ////COEF structure
		  piedprix = pied*1.75; ////COEF pied
		  
		  
          if (this.support == 'tissu 220g' ) {			  
            cena = textileprix+printprix+structureprix+scratchprix+piedprix+trans;
            support = 'tissu 220g';
          }
