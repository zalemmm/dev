<div id="buying">
	...
	<!-- <a href="../wp-content/enseignes/"><<<pRetour enseignes</a> -->
	<form class="jotform-form" action="" method="post" name="form_1060900217" id="1060900217" accept-charset="utf-8" onsubmit="JKakemono.cal_forex3mm(); return false;">
		...
		<div class="form-all">
				...
				<li class="form-line select" id="id_HD">
					<span class="helpButton"><img class="helpImg" src="../wp-content/plugins/fbshop/images/question.png">
						<span class="helpText" id="helpTextHD" style="visibility:hidden;">
							• <span class="highlight"><u><b>Impression forex Haute définition :</b></u></span><br/>impression directe UV HD 1200x1200Dpi. Pour une impression akylux parfaite même de très près.<br />
							• <span class="highlight"><u><b>Impression forex standard :</b></u></span><br/>impression directe UV 600x600Dpi. Pour une impression forex pas cher de très bonne qualité à 1 mètre.<a href="../wp-content/uploads/2016/12/impression-HD-panneaux-akylux-pas-cher-big.jpg" title="impression Haute définition panneaux forex pas cher"><img class="" title="impressio HD panneaux akylux pas cher" alt="panneaux imprimés forex pas cher" src="../wp-content/uploads/2016/12/impression-HD-panneaux-akylux-pas-cher.jpg"></a><br/>
						</span>
					</span>
          ...
          <span class="helpButton">
              ...
              <b>Perçage:</b>	Nous perçons votre panneau forex pour faciliter sa pose.<br/>
							<b>Pelliculage:</b> Nous posons un film de protecttion sur votre panneau forex. Ce pelliculage offre à votre support d’impression une protection optimale contre les éléments climatiques (abrasion, UV, rayures, vandalisme…). Vous aurez le choix entre une pelliculage brillant, mate, ou anti graffiti<br/>
						</span>
					</span>
        ...
        <li class="form-line select" id="id_lamination">
          <span class="helpButton">
            <img class="helpImg" src="../wp-content/plugins/fbshop/images/question.png">
            	...
            	<b>Pelliculage brillant:</b> Le pelliculage brillant offre des couleurs plus vives et plus éclatantes.<br/>
							<b>Pelliculage mat:</b>	Le pelliculage mat rend les couleurs plus chaudes et évite les reflets au soleil ou aux néons.<br/>
            	<b>Pelliculage anti graffiti:</b>	Composé à 100% de polyester d’une épaisseur de 36µ, ce pelliculage haut de gamme brillant offre à votre support d’impression une protection renforcé contre tous les éléments climatiques et extérieur.<br/>
						</span>
					</span>
	...
	<div id="preview">
		  ...
		  <div id="container">
			...
			<div id="preview_imag1"></div><!--forex-->
	...
	jQuery(document).ready(function(){
		...
		var warning = '';
			...
			if ( (hauteur > 100) || (largeur > 100) ) {
					warning += '- Enseigne livrée découpée en mètre linéaire.<br />Si vous souhaitez votre enseigne en 1 morceau, veuillez cocher l\'option "Grand format livré entier" (uniquement pour une enseigne inférieure à 150x300cm).<br />';
			...
			if ( ((hauteur > 150) && (largeur > 300)) || ((hauteur > 300) && (largeur > 150)) ) {
					warning += '- Votre enseigne est supérieure à 150x300cm, elle sera donc produite sur plusieurs plaques<br />';
					aBox.style.display="block";
					erreurType=0;
			}
