<div id="prodApp">
	<div class="row">
		<div class="column" id="choicesContainer"> <!--bloc formulaire-->
			...
			<h3>Votre devis en ligne autocollant</h3>
						...
						<li class="formSelect">
							...
							<transition name="slideDown">
								<div class="boutonsSelect" v-show="toggleProd">
									<div @mouseover="hoPw(1,'1')" @mouseout="hout(1)" v-tooltip.bottom="$global.vype" @click="reset(); selectProd('permanent',1);">
										<img :src="$global.img+'/stickers/1.png'" /><span>blanc permanent</span>
									</div>
									<div @mouseover="hoPw(1,'1')" @mouseout="hout(1)" v-tooltip.bottom="$global.vysp" @click="reset(); selectProd('semi-permanent',1);">
										<img :src="$global.img+'/stickers/1.png'" /><span>blanc semi-permanent</span>
									</div>
									<div @mouseover="hoPw(1,'2')" @mouseout="hout(1)" v-tooltip.bottom="$global.vymp" @click="reset(); selectProd('micro-perforé',2);">
										<img :src="$global.img+'/stickers/2.png'" /><span>micro-perforé M1 dos noir</span>
									</div>
									<div @mouseover="hoPw(1,'1')" @mouseout="hout(1)" v-tooltip.bottom="$global.vy75" @click="reset(); selectProd('permanent 75μ',1);">
										<img :src="$global.img+'/stickers/1.png'" /><span>blanc permanent 75μ</span>
									</div>
									<div @mouseover="hoPw(1,'1')" @mouseout="hout(1)" v-tooltip.bottom="$global.vymg" @click="reset(); selectProd('magnétique',1);">
										<img :src="$global.img+'/stickers/1.png'" /><span>magnétique 500μ</span>
									</div>
									<div @mouseover="hoPw(1,'3')" @mouseout="hout(1)" v-tooltip.bottom="$global.vytr" @click="reset(); selectProd('transparent',3);">
										<img :src="$global.img+'/stickers/3.png'" /><span>transparent</span>
									</div>
...
<script src="../wp-content/plugins/fbshop/prod_pages/vue.autocollant.js?v=3.0"></script>
