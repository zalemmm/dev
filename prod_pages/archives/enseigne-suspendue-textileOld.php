<div id="buying">
  ...
  <div id="preview">
    ...
    <div id="container">
      <div id="slides">
        <li><img src="../wp-content/plugins/fbshop/images/enseigne-suspendue/slide/enseigne-suspendue01.jpg" alt="enseigne suspendue" title="enseigne publicitaire tissu impression" /></li>
  		<li><img src="../wp-content/plugins/fbshop/images/enseigne-suspendue/slide/enseigne-suspendue02.jpg" alt="enseigne-suspendue" title="enseigne suspendue"  /></li>
  		<li><img src="../wp-content/plugins/fbshop/images/enseigne-suspendue/slide/enseigne-suspendue03.jpg" alt="enseigne-suspendue" title="enseigne-suspendue tissu pas cher"  /></li>
  		<li><img src="../wp-content/plugins/fbshop/images/enseigne-suspendue/slide/devis-en-ligne.png" alt="commencez votre devis en ligne" title="devis impression grand format" /></li>
      </div>
    </div>
...
<script type="text/javascript">
 ...
 jQuery(document).ready(function(){
	...
	if (($('input_21').value == 'Diamètre 152cm - Hauteur 76cm')) {structure=99; m2tissu= (1.60*3.15)*0.76*2; ref = '20170270';}
	if (($('input_21').value == 'Diamètre 305cm - Hauteur 61cm')) {structure=137; m2tissu= (3.10*3.15)*0.61*2; ref = '20170271';}
	if (($('input_21').value == 'Diamètre 610cm - Hauteur 122cm')) {structure=386; m2tissu= (6.2*3.15)*1.22*2; ref = '20170272';}
	...
	if (($('input_22').value == 'Largeur 244cm - Hauteur 107cm')) {structure=176; m2tissu= (2.50*1.07)*4*2; ref = '20170273';}
	if (($('input_22').value == 'Largeur 488cm - Hauteur 122cm')) {structure=296; m2tissu= (5*1.22)*4*2; ref = '20170274';}
	if (($('input_22').value == 'Largeur 610cm - Hauteur 122cm')) {structure=570; m2tissu= (6.2*1.22)*4*2; ref = '20170275';}
	...
	if (($('input_23').value == 'Largeur 305cm - Hauteur 107cm')) {structure=155; m2tissu= (3.10*1.07)*3*2; ref = '20170276';}
	if (($('input_23').value == 'Largeur 463cm - Hauteur 107cm')) {structure=207; m2tissu= (4.70*1.07)*3*2; ref = '20170277';}
	if (($('input_23').value == 'Largeur 610cm - Hauteur 122cm')) {structure=411; m2tissu= (6.20*1.22)*3*2; ref = '20170278';}
    ...
    if(production && delivery){
      ...
      if(jQuery('#id_8').css('display') != 'none') {
        jQuery('#estdate_8').html('Date de livraison max : '+output+'  <a class="linkUppercase modal-link" href="../etre-livre-rapidement/" target="_blank"><i class="fa fa-info-circle" aria-hidden="true"></i></a>');
      }
        ...
        if(!document.documentMode){ // ne pas charger ce script sous IE
          ...
          function sendData() {
            dodajkoszyk.innerHTML += '<input type="hidden" name="image" value="'+base64+'" />';
				...
				dodajkoszyk.innerHTML = '<input type="hidden" name="addtocart" value="addtocart" /><input type="hidden" name="rodzaj" value="Enseigne stand suspendue" /><input type="hidden" name="opis" value="- '+$('input_1').value+' - '+designation+details+'<br />- '+maquette+opis+optliv+etiqdesc+prliv+'" /><input type="hidden" name="ilosc" value="'+ilosc+'" /><input type="hidden" name="prix" value="'+cena2+' &euro;" /><input type="hidden" name="option" value="-" /><input type="hidden" name="remise" value="'+rabat2+'" /><input type="hidden" name="total" value="'+suma2+' &euro;" /><input type="hidden" name="transport" value="'+transport+' &euro;" /><input type="hidden" name="hauteur" value="'+hauteur+'" /><input type="hidden" name="largeur" value="'+largeur+'" /><input type="hidden" name="reference" value="'+ref+'" /><button id="submit_cart" type="submit"><i class="fa fa-shopping-cart" aria-hidden="true"></i> ajouter au panier</button> ';
