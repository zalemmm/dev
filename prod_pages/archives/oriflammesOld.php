<div id="buying">
    ...
    <form class="jotform-form" action="" method="post" name="form_1060900215" id="1060900215" accept-charset="utf-8" onsubmit="JKakemono.cal_oriflamme(); return false;">
      ...
      <div class="form-all">
        <ul class="form-section">
          ...
          <li class="form-line select" id="id_20">
          ...
          <li class="form-line select" id="id_3">
            ...
            <select class="form-dropdown validate[required]" id="input_3" name="q3" onclick="JKakemono.czyscpola(); ">
              ...
              <option value="Structure seule">Structure seule</option>
            </select>
          </li>
          ...
          <li class="form-line select" id="id_43">
            <span class="helpButton"><img class="helpImg" src="http://www.france-banderole.com/wp-content/plugins/fbshop/images/question.png"><span class="helpText" id="helpText43" style="visibility:hidden;">• <u><b>Drapeaux grand format vertical</u></b><br/>4 dimensions au choix pour un drapeau vertical<br /></span></span>
          ...
          <li class="form-line select" id="id_44">
            <span class="helpButton"><img class="helpImg" src="http://www.france-banderole.com/wp-content/plugins/fbshop/images/question.png"><span class="helpText" id="helpText44" style="visibility:hidden;">• <u><b>Drapeaux grand format Horizontal</u></b><br/>5 dimensions au choix pour un drapeau horizontal<br /></span></span>
          ...
          <li class="form-line select" id="id_8">
          ...
          <li class="form-line select" id="id_9" data-trigger="spinner">
            <label class="form-label-left label-highlight" id="label_9" for="input_9">quantité :<br /><span class="small">(par visuel)</span></label>
            <input type="text" class="form-textbox validate[required, Numeric]" id="input_9" name="q9_quantite" size="20" value="1" onclick="JKakemono.czyscpola();"  data-rule="quantity" />
          ...
          <li id="id_10" class="form-line optionsformline">
            ...
            <span class="options_single">
              ...
              <span class="optionsleft">
                <label class="form-label-left" id="label_antifeu" for="antifeu">Voile anti-feu B1</label>
                <input type="checkbox" class="form-checkbox" id="antifeu" name="antifeu[]" value="" onclick="JKakemono.czyscpola(); " />
                <span class="helpButton">
                  <span class="helpText" id="helpTextantifeu" style="visibility:hidden;">Voile non inflammable B1.</span>
                </span>
              </span>
    ...
    <div id="preview">
      ...
      <div id="container">
        <div id="slides">
          <li><img src="../wp-content/plugins/fbshop/images/oriflamme/slide/oriflamme-1.jpg" alt="oriflamme pas cher" title="beachflag pas cher" /></li>
          <li><img src="../wp-content/plugins/fbshop/images/oriflamme/slide/oriflamme-2.jpg" alt="beachflag personnalisé" title="devis oriflamme" /></li>
          <li><img src="../wp-content/plugins/fbshop/images/oriflamme/slide/oriflamme-3.jpg" alt="windflag pas cher" title="oriflamme devis en ligne" /></li>
  ...
  jQuery(document).ready(function(){
    ...
    ///////////////////////////////////////////////////////// drapeaux à agiter //
  	...
  	if ($('input_1').value == 'drapeaux grand format') {
  		designation='Drapeaux grand format';
  	...
  	if ($('input_1').value == 'oriflamme') {
  		designation='Oriflamme aile d’avion';
      //--------------------------------------------------------------------------
    ...
    ////////////////////////////////////////////////////////////// goutte d'eau //
  		...
  		designation='Beachflag goutte d’eau';
    ...
    //////////////////////////////////////////////////// windflag rectangulaire //
  	...
  	if ($('input_1').value == 'windflag') {
  		designation='Windflag rectangulaire';
      //--------------------------------------------------------------------------
    ...
    /////////////////////////////////////////////////////////////////// Pieds //
  	...
  	if ($('input_6').value == 'Embase 8kg') {
  			pied=27;
  			p3=8;
  			optionPied='<br />- Embase 8kg';
  		}
  	if ($('input_6').value == 'Embase carrée 13,5kg') {
  			pied=37;
  			p3=13.5;
  			optionPied='<br />- Embase carrée 13,5kg';

  		}
  	if ($('input_6').value == 'Pied 4 branches + bouée') {
  			pied=18;
  			p3=0.2;
  			optionPied='<br />- Pied 4 branches + bouée';
  		}
  	if ($('input_6').value == 'Pied piquet') {
  			pied=16;
  			optionPied='<br />- Pied piquet';
  			p3=1.3;
  		}
  	if ($('input_6').value == 'Pied voiture') {
  			pied=16;
  			p3=1.65;
  			optionPied='<br />- Pied voiture';
  		}
  	if ($('input_6').value == 'Pied à visser') {
  			pied=10;
  			p3=0.75;
  			optionPied='<br />- Pied à visser';
  		}

  	if ($('input_6').value == 'Pied parasol 23L') {
  			pied=14;
  			p3=1.2;
  			optionPied='<br />- Pied parasol 23L';
  		}
    ...
    //////////////////////////////////////////////////////////////////// Kits //
  	...
  	if ($('input_3').value == 'Structure seule') {
		...
		designation= ($('input_22').value) || ($('input_21').value)
  		}
  	if ($('input_1').value == 'windflag') {
  		prixHT=structure+impression;
    ...
    ///////////////////////////////////////////////////////////////// options //
  	...
  	if (antifeu == true) {
  		...
  		optliv += '<br />- Voile anti-feu';
  	}

  	var colis = $$('#colis').collect(function(e){ return e.checked; }).any();
  	if (colis == true) {
  		if ( !$('revendeur') && !$('revendeurRC') ) {cena += 2.00*ilosc;}
    ...
    if ((niepokazuj==0) && ((DeliveryType == '2-3') || (DeliveryType == '1-1') || (DeliveryType == '3-4'))){
      ...
      if(!document.documentMode){ // ne pas charger ce script sous IE
    	...
    	dodajkoszyk.innerHTML = '<input type="hidden" name="addtocart" value="addtocart" /><input type="hidden" name="rodzaj" value="Oriflamme" /><input type="hidden" name="opis" value="- '+designation+' '+formatProd+'<br />- '+composant+optionPied+ktodaje+optliv+etiqdesc+colisr+opis+'<br />'+prliv+'" /><input type="hidden" name="ilosc" value="'+ilosc+'" /><input type="hidden" name="prix" value="'+cena2+' &euro;" /><input type="hidden" name="option" value="-" /><input type="hidden" name="remise" value="'+rabat2+'" /><input type="hidden" name="total" value="'+suma2+' &euro;" /><input type="hidden" name="transport" value="'+transport+' &euro;" /><input type="hidden" name="hauteur" value="'+hauteur+'" /><input type="hidden" name="largeur" value="'+largeur+'" /><input type="hidden" name="reference" value="'+ref+'" /><button id="submit_cart" type="submit"><i class="fa fa-shopping-cart" aria-hidden="true"></i> ajouter au panier</button> ';
    }
    /*<div id="submit_cart" type="submit" style="background:#ea2a6a;border:0">Rupture stock</div>
