          ...
          <span class="helpButton">
            ...
            <option value="pelliculage laqué anti graffiti">pelliculage anti graffiti</option>
				...
				<li class="form-line select" id="id_2">
					<span class="helpButton"><img class="helpImg" src="http://www.france-banderole.com/wp-content/plugins/fbshop/images/question.png"><span class="helpText" id="helpTextcouleur" style="visibility:hidden;">Option</span></span>
					<select class="form-dropdown validate[required]" id="input_2" name="q2_support2" onclick="JKakemono.czyscpola(); ">
						...
						<option value="lettrage couleur">lettrage couleur</option>
					</select>
				</li>
	...
	jQuery(document).ready(function(){
		jQuery('.delivery , .production').click(function(){
			...
			if ( ($('input_1').value == 'permanent') && ($('input_4').value == 'Pas de film de pose') ) {
				designation='Sticker lettrage prédécoupé';
			...
			//------------------------------------------------------------------------
			if (($('input_2').value == 'lettrage blanc')) {
				opis='<br />- Blanc';
				cena -= (cena*20)/100;
			}
