<div id="prodApp">
	<div class="row">
		<div class="column" id="choicesContainer"> <!--bloc formulaire-->
			...
			<h3>Votre devis en ligne PVC 300 microns</h3>
						...
						<li class="formSelect" v-show="showOpts">
							...
							<transition name="slideDown">
								<div class="boutonsSelect" v-show="toggleOpts">
									...
									<div @mouseover="hoPw(2,'oeuil2');"  @mouseout="hout(2)" v-tooltip.bottom="$global.oeil" @click="reset(); selectOpts('2 oeillets');">
										<i class="fa fa-circle-o" aria-hidden="true"></i><span>2 oeillets (en haut)</span>
									</div>
									<div @mouseover="hoPw(2,'oeuil4');"  @mouseout="hout(2)" v-tooltip.bottom="$global.oeil" @click="reset(); selectOpts('4 oeillets');">
										<i class="fa fa-circle-o" aria-hidden="true"></i><span>4 oeillets</span>
									</div>
								</div>
							</transition>
...
<script src="../wp-content/plugins/fbshop/prod_pages/vue.pvc300.js?v=3.0"></script>
