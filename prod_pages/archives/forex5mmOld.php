				...
				<li class="form-line select" id="id_4">
					<span class="helpButton">
						...
						<span class="helpText" id="helpTextoption" style="visibility:hidden;">
							<b>Perçage:</b><br/>
							Nous perçons votre panneau forex pour faciliter sa pose.<br/>
							<b>Pelliculage:</b><br/>
							Nous posons un film de protecttion sur votre panneau forex. Ce pelliculage offre à votre support d’impression une protection optimale contre les éléments climatiques (abrasion, UV, rayures, vandalisme…). Vous aurez le choix entre une <strong>pelliculage brillant, mate, ou anti graffiti</strong><br/>
						</span>
					</span>
...
jQuery(document).ready(function(){
	jQuery('.delivery , .production').click(function(){
		...
		poids = 2.43*metraz; ////grammage x m²///
