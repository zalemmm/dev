	...
	<div class="row">
							...
							<transition name="slideDown">
								<div v-show="toggleSupp">
									...
									<div class="boutonsSelect" >
										...
										<div class="clEco" @mouseover="hoPw(1,'ecotoile')" @mouseout="hout(1)" v-tooltip.bottom="$global.ecotm2" @click="reset(); selectSupport('ecotoile');" v-show="swEco">
										...
										<div class="clEco" @mouseover="hoPw(1,'eco')"      @mouseout="hout(1)" v-tooltip.bottom="$global.becom2" @click="reset(); selectSupport('bache 100% écologique M1');" v-show="swEco || swFeu">
											<div class="corneco"><i class="fa fa-leaf" aria-hidden="true"></i></div>
											<img :src="$global.img+'/banderole/eco.png'" /><span>100% éco. 250g M1</span>
										</div>
										<div class="clEco" @mouseover="hoPw(1,'capotoile')"@mouseout="hout(1)" v-tooltip.bottom="$global.capom2" @click="reset(); selectSupport('capotoile');" v-show="swEco || swFeu">
											<div class="corneco"><i class="fa fa-leaf" aria-hidden="true"></i></div>
											<img :src="$global.img+'/banderole/capotoile.png'" /><span>Capotoile 280g M1 Ecocert</span>
										</div>

										<div class="clNml" @mouseover="hoPw(1,'440g')"     @mouseout="hout(1)" v-tooltip.bottom="$global.b440m2" @click="reset(); selectSupport('bache 440g');" v-show="swNml">
											<img :src="$global.img+'/banderole/440g.png'" /><span>bâche 440g</span>
										</div>
										<div class="clNml" @mouseover="hoPw(1,'550g')"     @mouseout="hout(1)" @click="reset(); selectSupport('jet 550 enduite');" v-show="swNml" v-if="swRvd"> <!-- cacher aux non revendeurs-->
											<img :src="$global.img+'/banderole/550g.png'" /><span>bâche 550g enduite</span>
										</div>
										<div class="clNml" @mouseover="hoPw(1,'jet550')"   @mouseout="hout(1)" v-tooltip.bottom="$global.b550m2" @click="reset(); selectSupport('jet 550');" v-show="swNml">
											<img :src="$global.img+'/banderole/jet550.png'" /><span>Dickson Jet 550g</span>
										</div>
										<div class="clNml" @mouseover="hoPw(1,'micro')"    @mouseout="hout(1)" v-tooltip.bottom="$global.microm2" @click="reset(); selectSupport('bache micro perforée M1/B1');" v-show="swNml">
											<img :src="$global.img+'/banderole/micro.png'" /><span>micro perforée 300g</span>
										</div>
										<div class="clNml" @mouseover="hoPw(1,'150g')"     @mouseout="hout(1)" v-tooltip.bottom="$global.b150m2"  @click="reset(); selectSupport('bache nontissé 150g');" v-show="swNml">
											<img :src="$global.img+'/banderole/150g.png'" /><span>nontissé 150g</span>
										</div>

										<div class="clFeu" @mouseover="hoPw(1,'450g')"     @mouseout="hout(1)" @click="reset(); selectSupport('bache 450 M1');" v-show="swFeu" v-if="swRvd"> <!-- cacher aux non revendeurs -->
										...
										<div class="clFeu" @mouseover="hoPw(1,'jet520')"   @mouseout="hout(1)" v-tooltip.bottom="$global.b520m2" @click="reset(); selectSupport('jet 520 M1');" v-show="swFeu">
											<div class="cornfire"><i class="fa fa-fire-extinguisher" aria-hidden="true"></i></div>
											<img :src="$global.img+'/banderole/jet520.png'" /><span>Dickson Jet 520g M1</span>
										</div>
										<div class="clFeu" @mouseover="hoPw(1,'750g')"     @mouseout="hout(1)" v-tooltip.bottom="$global.lacom2" @click="reset(); selectSupport('lacopac');" v-show="swFeu">
											<div class="cornfire"><i class="fa fa-fire-extinguisher" aria-hidden="true"></i></div>
											<img :src="$global.img+'/banderole/750g.png'" /><span>Lacopac 680g M2/B1</span>
										</div>
										<div class="clFeu" @mouseover="hoPw(1,'750g')"     @mouseout="hout(1)" v-tooltip.bottom="$global.lacom2" @click="reset(); selectSupport('lacopac recto verso');" v-show="swFeu">
											<div class="cornfire"><i class="fa fa-fire-extinguisher" aria-hidden="true"></i></div>
											<img :src="$global.img+'/banderole/750g.png'" /><span>Lacopac 680g recto/verso</span>
										</div>

										<div class="clTis" @mouseover="hoPw(1,'220g')"     @mouseout="hout(1)" v-tooltip.bottom="$global.t220m2" @click="reset(); selectSupport('tissu 220g');" v-show="swTis">
											<img :src="$global.img+'/banderole/220g.png'" /><span>tissu stretch léger 220g B1</span>
										</div>
										<div class="clTis" @mouseover="hoPw(1,'260g')"     @mouseout="hout(1)" v-tooltip.bottom="$global.t260m2" @click="reset(); selectSupport('tissu 260g');" v-show="swTis">
											<img :src="$global.img+'/banderole/260g.png'" /><span>tissu stretch ext. 260g B1</span>
										</div>
						...
						<li class="formSelect" v-show="showFfix">
							...
							<transition name="slideDown">
								<div class="boutonsSelect" v-show="toggleFfix">
									...
									<div @mouseover="hoPw(5,'tendeur')"    @mouseout="hout(5)" @click="reset(); selectFfix('tendeurs H/B tous les mètres');" >
						...
						<li class="formSelect" v-show="showOrlt">
							...
							<transition name="slideDown">
								<div class="boutonsSelect" v-show="toggleOrlt">
									...
									<div @mouseover="hoPw(3,'ourlets')"   @mouseout="hout(3)" v-tooltip.bottom="$global.ourlpr" @click="reset(); selectOrlt('ourlet de renfort périmétrique');"  v-show="ourletsP">
										<i class="fa fa-circle-o" aria-hidden="true"></i><span>ourlet de renfort périmétrique</span>
									</div>
								</div>
							</transition>
						</li>
						...
						<li class="formSelect" v-show="showScra">
							...
							<transition name="slideDown">
								<div class="boutonsSelect" v-show="toggleScra">
									...
									<div @mouseover="hoPw(3,'ourlets')"   @mouseout="hout(3)" @click="reset(); selectScra('scratch périmétrique');" v-tooltip.bottom="$global.scrapr">
										<i class="fa fa-circle-o" aria-hidden="true"></i><span>scratch périmétrique</span>
									</div>
								</div>
							</transition>
						</li>
						...
						<li class="formSelect" v-show="showFixx">
							...
							<transition name="slideDown">
								<div class="boutonsSelect" v-show="toggleFixx">
									...
									<div @mouseover="hoPw(5,'drissep')"    @mouseout="hout(5)" @click="reset(); selectFixx('drisse périmétrique');">
										<img :src="$global.img+'/banderole/drissed.png'" /><span>drisse périmétrique</span>
									</div>
							...
							<transition name="slideDown">
								<div class="boutonsSelect" v-show="toggleFxqt">
									<div @click="reset(); selectFxqt(2);">
										<img :src="tendORrisl" /><span>2</span>
									</div>
									...
									<div @click="reset(); selectFxqt('22');">
										<img :src="tendORrisl" /></i><span>22</span>
									</div>
									<div @click="reset(); selectFxqt('26');">
										<img :src="tendORrisl" /></i><span>26</span>
									</div>
					...
					<ul class="optionsBlock" v-show="showOptions">
						...
						<li class="optLi optSize">
							<div class="sizeContainer" :class="reqHaut">
								...
								<input type="text" placeholder="ex: 0.85" class="sizeInput" v-model.number="hauteur" @click="reset" />
							</div>

							<div class="sizeContainer" :class="reqLarg">
								<label class="sizeLabel" :class="reqLarg">largeur <span class="small">(en mètres)</span></label>
								<input type="text" placeholder="ex: 1.70" class="sizeInput" v-model.number="largeur" @click="reset" />
							</div>
						</li>
		...
		<div class="column" id="previewContainer">
			<div id="previewImg">
				...
				<transition name="slideLeft"><div class="preview_imagH" :style="bgH" v-show="prH"><p v-show="calqueTexte"><span>{{ calqueContent }}</span></p></div></transition>
...
<script src="../wp-content/plugins/fbshop/prod_pages/vue.globals.js"></script>
<script src="../wp-content/plugins/fbshop/prod_pages/vue.banderoles.js"></script>
