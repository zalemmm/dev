      ...
      <li class="form-line select" id="id_0">
			...
			<li class="form-line select" id="id_1">
				...
				<select class="form-dropdown validate[required]" id="input_1" name="q1_usage" onchange="getElementById('preview_info_ul').innerHTML = '';JKakemono.czyscpola();">
					...
					<option value="Flyers 80g">80g</option>
					<option value="Flyers 135g">135g</option>
					<option value="Flyers 170g">170g</option>
					<option value="Flyers 250g">250g</option>
					<option value="Flyers 350g">350g</option>
					<option value="Flyers 120µ">Indéchirable 120µ</option>
					<option value="Flyers 270µ">Indéchirable 270µ</option>
					<option value="Flyers 350µ">Indéchirable 350µ</option>
				</select>
			</li>

			<li class="form-line select" id="id_21">

				<a href="#taille"><img class="helpImg" title="Cliquez pour plus d'infos" src="../wp-content/plugins/fbshop/images/question.png"></a>
				<select class="form-dropdown validate[required]" id="input_21" name="q21_usage" onchange="getElementById('preview_info_ul').innerHTML = '';JKakemono.czyscpola();">
					...
					<option value="Dinlong">DIN long (10,5 x 21 cm)</option>
			...
			<li class="form-line select" id="id_22">
				...
				<a href="#impression"><img class="helpImg" title="Cliquez pour plus d'infos" src="../wp-content/plugins/fbshop/images/question.png"></a>
			...
			<li class="form-line select" id="id_32">
				...
				<a href="#type"><img class="helpImg" title="Cliquez pour plus d'infos" src="../wp-content/plugins/fbshop/images/question.png"></a>
			...
			<li class="form-line select" id="id_41">
				<span class="helpButton"><img class="helpImg" src="../wp-content/plugins/fbshop/images/question.png">
					<span class="helpText" id="helpTextmaquette41" style="visibility:hidden;"></span>
				</span>
			...
			<li class="form-line select" id="id_42">
				<span class="helpButton"><img class="helpImg" src="../wp-content/plugins/fbshop/images/question.png">
					<span class="helpText" id="helpTextmaquette42" style="visibility:hidden;"></span>
				</span>
			...
			<li class="form-line select" id="id_43">
				<span class="helpButton"><img class="helpImg" src="../wp-content/plugins/fbshop/images/question.png">
					<span class="helpText" id="helpTextmaquette43" style="visibility:hidden;"></span>
				</span>
			...
			<li class="form-line select" id="id_44">
				<span class="helpButton"><img class="helpImg" src="../wp-content/plugins/fbshop/images/question.png">
					<span class="helpText" id="helpTextmaquette44" style="visibility:hidden;"></span>
				</span>
			...
			<li class="form-line select" id="id_1depliant">
				...
				<select class="form-dropdown validate[required]" id="input_1depliant" name="q1depliant_usage" onchange="getElementById('preview_info_ul').innerHTML = '';JKakemono.czyscpola();">
					...
					<!--<option value="depliants 250g">250g</option> -->
				</select>
			</li>
			...
			<li class="form-line select" id="id_21depliant">
				...
				<select class="form-dropdown validate[required]" id="input_21depliant" name="q21depliant_usage" onchange="getElementById('preview_info_ul').innerHTML = '';JKakemono.czyscpola();">
					<option value="">choisir le format...</option>
					<option value="Din long">21x21cm ouvert -> 10,5x21cm fermé</option>
					<option value="A3">A3 ouvert -> A4 fermé</option>
					<option value="A4">A4 ouvert -> A5 fermé</option>
					<option value="A4 3 volets">A4 ouvert -> 3 volets 10x21cm fermé</option>
					<option value="A5">A5 ouvert -> A6 fermé</option>
				</select>
			</li>
			...
			<li class="form-line select" id="id_41depliant">
				<span class="helpButton"><img class="helpImg" src="../wp-content/plugins/fbshop/images/question.png">
					<span class="helpText" id="helpTextmaquette41depliant" style="visibility:hidden;"></span>
				</span>
				<select class="form-dropdown validate[required]" id="input_41depliant" name="q41depliant_maquette41depliant" onchange="JKakemono.czyscpola(); ">
					<option value="">fichier d'impression...</option>
					<option value="sansbat">j’ai mon fichier, je ne souhaite pas de BAT</option>
					<option value="user">j’ai mon fichier, je souhaite un BAT +5,00€</option>
					<option value="config">je crée ma maquette en ligne +5,00€</option>
			...
			<li class="form-line select" id="id_42depliant">
				<span class="helpButton"><img class="helpImg" src="../wp-content/plugins/fbshop/images/question.png">
					<span class="helpText" id="helpTextmaquette42depliant" style="visibility:hidden;"></span>
				</span>
				<select class="form-dropdown validate[required]" id="input_42depliant" name="q42depliant_maquette42depliant" onchange="JKakemono.czyscpola(); ">
					<option value="">fichier d'impression...</option>
					<option value="sansbat">j’ai mon fichier, je ne souhaite pas de BAT</option>
					<option value="user">j’ai mon fichier, je souhaite un BAT +5,00€</option>
					<option value="config">je crée ma maquette en ligne +5,00€</option>
			...
			<li class="form-line select" id="id_signature">
				<span class="helpButton">
					...
					<span class="helpText" id="helpTextsignature" style="visibility:hidden;">
						...
						<img src="../wp-content/plugins/fbshop/images/signature.png" alt="signature France Banderole">
					</span>
				</span>
...
<div id="preview">
	...
	<div id="container">
		...
		<div id="slides">
			<li><img src="../wp-content/plugins/fbshop/images/flyer/flyer.png" alt="flyer" /></li>
			<li><img src="../wp-content/plugins/fbshop/images/flyer/depliant.png" alt="dépliant" /></li>
			<li><img src="../wp-content/plugins/fbshop/images/slidedefault/1.png" alt="commencez votre devis en ligne" /></li>
			<li><img src="../wp-content/plugins/fbshop/images/slidedefault/2.png" alt="commencez votre devis en ligne" /></li>
			<li><img src="../wp-content/plugins/fbshop/images/slidedefault/3.png" alt="commencez votre devis en ligne" /></li>
		</div>
	</div>
...
<script>
	...
	jQuery(document).ready(function(){
		...
		jQuery('.delivery , .production').click(function(){
			...
			//////////////////////////////////////////////////////////////////////////
			if ($('input_21').value == 'A7' || $('input_21depliant').value == 'A7') {ref = '20171007';};
			if ($('input_21').value == 'A6' || $('input_21depliant').value == 'A6') {ref = '20171006';};
			if ($('input_21').value == 'A5' || $('input_21depliant').value == 'A5') {ref = '20171005';};
			if ($('input_21').value == 'A4' || $('input_21depliant').value == 'A4' || $('input_21depliant').value == 'A4 3 volets') {ref = '20171004';};
			if ($('input_21').value == 'A3' || $('input_21depliant').value == 'A3') {ref = '20171003';};
			if ($('input_21').value == 'Dinlong' || $('input_21depliant').value == 'Din long') {ref = '20171001';};
			...
			if ($('input_1').value == 'Flyers 80g') {
				if ($('input_21').value == 'A7'){
					...
					if (ilosc == '100') { cena1=17.45;}
					if (ilosc == '250') { cena1=17.78;}
					if (ilosc == '500') { cena1=17.14;}
					if (ilosc == '1000') { cena1=19.43 ;}
					if (ilosc == '1250') { cena1=21.71;}
					if (ilosc == '2000') { cena1=21.75;}
					if (ilosc == '2500') { cena1=22.86;}
					if (ilosc == '5000') { cena1=28.32;}
					if (ilosc == '10000') { cena1=40.06;}
					if (ilosc == '15000') { cena1=45.89;}
					if (ilosc == '20000') { cena1=51.71;}
					if (ilosc == '25000') { cena1=62.02;}
					if (ilosc == '30000') { cena1=72.32;}
					if (ilosc == '35000') { cena1=82.62;}
					if (ilosc == '40000') { cena1=92.00;}
					if (ilosc == '45000') { cena1=103.00;}
					if (ilosc == '50000') { cena1=113.00;}
				...
				if ($('input_21').value == 'A6')
					...
					if (ilosc == '100') { cena1=18.63;}
					if (ilosc == '250') { cena1=19.03;}
					if (ilosc == '500') { cena1=19.72;}
					if (ilosc == '1000') { cena1=21.08;}
					if (ilosc == '1250') { cena1=23.97;}
					if (ilosc == '2000') { cena1=24.20;}
					if (ilosc == '2500') { cena1=25.42;}
					if (ilosc == '5000') { cena1=32.22;}
					if (ilosc == '10000') { cena1=47.02;}
					if (ilosc == '15000') { cena1=54.50;}
					if (ilosc == '20000') { cena1=61.93;}
					if (ilosc == '25000') { cena1=75.50;}
					if (ilosc == '30000') { cena1=89.02;}
					if (ilosc == '35000') { cena1=102.62;}
					if (ilosc == '40000') { cena1=116.18;}
					if (ilosc == '45000') { cena1=129.75;}
					if (ilosc == '50000') { cena1=143.00;}
				...
				if ($('input_21').value == 'A5'){
					...
					if (ilosc == '100') { cena1=24.89;}
					if (ilosc == '250') { cena1=25.87 ;}
					if (ilosc == '500') { cena1=27.50;}
					if (ilosc == '1000') { cena1=30.76 ;}
					if (ilosc == '1250') { cena1=38.80;}
					if (ilosc == '2000') { cena1=39.80;}
					if (ilosc == '2500') { cena1=42.82;}
					if (ilosc == '5000') { cena1=59.13;}
					if (ilosc == '10000') { cena1=87.10;}
					if (ilosc == '15000') { cena1=108.44;}
					if (ilosc == '20000') { cena1=129.94;}
					if (ilosc == '25000') { cena1=159.91;}
					if (ilosc == '30000') { cena1=188.90;}
					if (ilosc == '35000') { cena1=218.88;}
					if (ilosc == '40000') { cena1=248.87;}
					if (ilosc == '45000') { cena1=278.85;}
					if (ilosc == '50000') { cena1=308.83;}
				...
				if ($('input_21').value == 'A4')
					...
					if (ilosc == '250') { cena1=30.42 ;}
					if (ilosc == '500') { cena1=32.58;}
					if (ilosc == '1000') { cena1=37.85 ;}
					if (ilosc == '1250') { cena1=49.54;}
					if (ilosc == '2000') { cena1=50.39;}
					if (ilosc == '2500') { cena1=55.34;}
					if (ilosc == '5000') { cena1=84.34;}
					if (ilosc == '10000') { cena1=135.11;}
					if (ilosc == '15000') { cena1=238.50;}
					if (ilosc == '20000') { cena1=310.16;}
					if (ilosc == '25000') { cena1=383.84;}
					if (ilosc == '30000') { cena1=457.91;}
					if (ilosc == '35000') { cena1=530.97;}
					if (ilosc == '40000') { cena1=604.74;}
					if (ilosc == '45000') { cena1=678.11;}
					if (ilosc == '50000') { cena1=751.68;}
				...
				if ($('input_21').value == 'Dinlong')
					...
					if (ilosc == '25') { cena1=22.17;}
					if (ilosc == '50') { cena1=22.29;}
					if (ilosc == '100') { cena1=22.53;}
					if (ilosc == '250') { cena1=23.60;}
					if (ilosc == '500') { cena1=24.28;}
					if (ilosc == '1000') { cena1=27.42;}
					if (ilosc == '1250') { cena1=32.16;}
					if (ilosc == '2000') { cena1=32.80;}
					if (ilosc == '2500') { cena1=34.53;}
					if (ilosc == '5000') { cena1=46.65;}
					if (ilosc == '10000') { cena1=69.83;}
					if (ilosc == '15000') { cena1=89.90;}
					if (ilosc == '20000') { cena1=109.00;}
					if (ilosc == '25000') { cena1=132.00;}
					if (ilosc == '30000') { cena1=156.00;}
					if (ilosc == '35000') { cena1=179.00;}
					if (ilosc == '40000') { cena1=202.00;}
					if (ilosc == '45000') { cena1=225.09 ;}
					if (ilosc == '50000') { cena1=248.00 ;}
				...
				if ($('input_21').value == 'A3')
					...
					if (ilosc == '100') { cena1=38.26;}
					if (ilosc == '250') { cena1=51.56;}
					if (ilosc == '500') { cena1=54.33;}
					if (ilosc == '1000') { cena1=67.72 ;}
					if (ilosc == '1250') { cena1=96.91;}
					if (ilosc == '2000') { cena1=97.13;}
					if (ilosc == '2500') { cena1=110.81;}
					if (ilosc == '5000') { cena1=192.22;}
					if (ilosc == '10000') { cena1=350.75;}
					if (ilosc == '15000') { cena1=499.83;}
					if (ilosc == '20000') { cena1=656.38;}
					if (ilosc == '25000') { cena1=794.59;}
					if (ilosc == '30000') { cena1=933.81;}
					if (ilosc == '35000') { cena1=1058.04;}
					if (ilosc == '40000') { cena1=1184.26;}
					if (ilosc == '45000') { cena1=1309.48;}
					if (ilosc == '50000') { cena1=1434.70;}
		...
		if ( ($('input_1').value == 'Flyers 350µ') && ($('input_22').value == 'Recto')  ) {P350µ=4.73;}
			...
			if ($('input_1').value == 'Flyers 120µ') {
					...
					if ($('input_21').value == 'A5'){ cena1=(ilosc/4)*P120µ; opis += '<br />- A5 120µ | Quadri';}
					if ($('input_21').value == 'A4'){ cena1=(ilosc/2)*P120µ; opis += '<br />- A4 120µ | Quadri';}
					if ($('input_21').value == 'Dinlong'){ cena1=(ilosc/6)*P120µ; opis += '<br />- Din long 120µ | Quadri';}
					if ($('input_21').value == 'A3'){ cena1=(ilosc/1)*P120µ; opis += '<br />- A3 120µ | Quadri';}
					if ((ilosc == '25') || (ilosc == '50') || (ilosc == '100') || (ilosc == '250')){ cena1*=1.15;}
					if ((ilosc == '500') || (ilosc == '1000') || (ilosc == '1250') || (ilosc == '2000')){cena1*=1;}
			...
			if ($('input_1').value == 'Flyers 270µ') {
					...
					if ($('input_21').value == 'A7'){ cena1=(ilosc/16)*P270µ; opis += '<br />- A7 270µ | Quadri';}
					if ($('input_21').value == 'A6'){ cena1=(ilosc/8)*P270µ; opis += '<br />- A6 270µ | Quadri';}
					if ($('input_21').value == 'A5'){ cena1=(ilosc/4)*P270µ; opis += '<br />- A5 270µ | Quadri';}
					if ($('input_21').value == 'A4'){ cena1=(ilosc/2)*P270µ; opis += '<br />- A4 270µ | Quadri';}
					if ($('input_21').value == 'Dinlong'){ cena1=(ilosc/6)*P270µ; opis += '<br />- 270µ | Quadri';}
					if ($('input_21').value == 'A3'){ cena1=(ilosc/1)*P270µ; opis += '<br />- Din long 270µ | Quadri';}
					if ((ilosc == '25') || (ilosc == '50') || (ilosc == '100') || (ilosc == '250')){ cena1*=1.15;}
					if ((ilosc == '500') || (ilosc == '1000') || (ilosc == '1250') || (ilosc == '2000')){ cena*=1;}
					if ((ilosc == '5000') || (ilosc == '7500') || (ilosc == '10000')){ cena1*=0.95;}
					if ((ilosc == '15000') || (ilosc == '20000')){ cena1*=0.90;}
					if ((ilosc == '25000') || (ilosc == '30000')){ cena1*=0.85;}
					if ((ilosc == '40000') || (ilosc == '50000')){ cena1*=0.80;}
			...
			if ($('input_1').value == 'Flyers 350µ') {
					...
					if ($('input_21').value == '7'){ cena1=(ilosc/2)*P350µ; opis += '<br />- Recto<br />- 350µ | Quadri';}
					if ($('input_21').value == '9'){ cena1=(ilosc/6)*P350µ; opis += '<br />- Recto<br />- 350µ | Quadri';}
					if ($('input_21').value == '11'){ cena1=(ilosc/1)*P350µ; opis += '<br />- Recto<br />- 350µ | Quadri';}
					if ((ilosc == '25') || (ilosc == '50') || (ilosc == '100') || (ilosc == '250')){ cena1*=1.15;}
					if ((ilosc == '500') || (ilosc == '1000') || (ilosc == '1250') || (ilosc == '2000')){ cena1*=1;}
					if ((ilosc == '5000') || (ilosc == '7500') || (ilosc == '10000')){ cena1*=0.95;}
					if ((ilosc == '15000') || (ilosc == '20000')){ cena1*=0.90;}
			...
			// formats A -------------------------------------------------------------
			if (($('input_21').value != 'Dinlong') && ($('input_45').value == 'portrait')) {
				hauteur = 119;
				largeur = 84;
			}
			if (($('input_21').value != 'Dinlong') && ($('input_45').value == 'paysage')) {
				hauteur = 84;
				largeur = 119;
			}
			// formats DIN -----------------------------------------------------------
      ...
      // -----------------------------------------------------------------------
	 	...
	 	//////////////////////////////////////////////////////// choix maquette //
			...
			if (($('input_41').value == 'fb') || ($('input_42').value == 'fb') || ($('input_43').value == 'fb') || ($('input_44').value == 'fb')) {
				cena+=19;
				ktodaje = 'France banderole crée la maquette';
			}
			if (($('input_41').value == 'user') || ($('input_42').value == 'user') || ($('input_43').value == 'user') || ($('input_44').value == 'user')) {
				ktodaje = 'BAT en LIGNE';
				cena+=5;
			}
			if (($('input_41').value == 'sansbat') || ($('input_42').value == 'sansbat') || ($('input_43').value == 'sansbat') || ($('input_44').value == 'sansbat')) {
				ktodaje = 'je ne souhaite pas de BAT';
			}
			if (($('input_41').value == 'config') || ($('input_42').value == 'config') || ($('input_43').value == 'config') || ($('input_44').value == 'config')) {
				cena+=5;
			...
			if (($('input_41depliant').value == 'user') || ($('input_42depliant').value == 'user')) {
				ktodaje = 'BAT en LIGNE';
				cena+=5;
			}
			if (($('input_41depliant').value == 'sansbat') || ($('input_42depliant').value == 'sansbat')) {
				ktodaje = 'je ne souhaite pas de BAT';
			}
			if (($('input_41depliant').value == 'config') || ($('input_42depliant').value == 'config')) {
				cena+=5;
				ktodaje = 'je crée ma maquette en ligne';
			}
      ...
      opis += '<br />- '+ktodaje;
		...
		if (etiquette == true) {
			transport=0;
			optliv += '<br />- retrait colis a l\'atelier';
			cena-= cena*3/100;
		}
      ...
      //////////////////////////////////////////////////////////////////////////
			...
			dodajkoszyk.innerHTML = '<input type="hidden" name="addtocart" value="addtocart" /><input type="hidden" name="rodzaj" value="'+rodzaj+'" /><input type="hidden" name="opis" value="'+opis+prliv+optliv+'" /><input type="hidden" name="ilosc" value="1" /><input type="hidden" name="prix" value="'+cena2+' &euro;" /><input type="hidden" name="option" value="'+option2+'" /><input type="hidden" name="remise" value="-" /><input type="hidden" name="total" value="'+suma2+' &euro;" /><input type="hidden" name="transport" value="'+transport+' &euro;" /><input type="hidden" name="hauteur" value="'+hauteur+'" /><input type="hidden" name="largeur" value="'+largeur+'" /><input type="hidden" name="reference" value="'+ref+'" /><button id="submit_cart" type="submit"><i class="fa fa-shopping-cart" aria-hidden="true"></i> ajouter au panier</button> ';
		}
	});
});
</script>
