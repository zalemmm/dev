            ...
            <ul class="form-section">
                ...
                <li class="form-line" id="id_21">
                    ...
                    <select class="form-dropdown validate[required]" id="input_21" name="q21_usage" onchange="getElementById('preview_info_ul').innerHTML = '';JKakemono.czyscpola();">
                        <option value="">choisir...</option>
                        <option style="background-color:#e8e8e9" value="1">19,8x21cm ouvert -> 9,9x21cm fermé</option>
                        <option value="2">A3 ouvert -> A4 fermé</option>
                        <option style="background-color:#e8e8e9" value="3">A4 ouvert -> A5 fermé</option>
                        <option value="4">A4 ouvert -> 3 volets 10x21cm fermé</option>
                        <option style="background-color:#e8e8e9" value="5">A5 ouvert -> A6 fermé</option>
                    </select>
                </li>
...
<div id="preview">
    <span id="preview_name">DÉPLIANT ET LIVRE PERSONNALISÉS :</span>
