<div id="buying">
  ...
  <form class="jotform-form" action="" method="post" name="form_1060900217" id="1060900217" accept-charset="utf-8" onsubmit="JKakemono.cal_forex1mm(); return false;">
    <div class="form-all">
      <ul class="form-section">
        ...
        <li class="form-line" id="id_1">
          ...
          <select class="form-dropdown validate[required]" id="input_1" name="q1_usage" onchange="JKakemono.czyscpola(); ">
            <option value="">choisir...</option>
            <option value="50x20">50x20cm </option>
            <option value="75x50">75x50cm</option>
            <option value="150x50">150x50cm</option>
            <option value="200x75">200x75cm</option>
            <option value="250x100">250x100cm</option>
...
<option class="select-alt" value="12">12</option>
<option value="13">13</option>
<option class="select-alt" value="14">14</option>
<option value="15">15</option>
<option class="select-alt" value="16">16</option>
<option value="17">17</option>
<option class="select-alt" value="18">18</option>
<option value="19">19</option>
<option class="select-alt" value="20">20</option>
</select>
</li> -->
<li class="form-line" id="id_32">
  ...
  <select class="form-dropdown validate[required]" id="input_32" name="q32_usage" onchange="JKakemono.czyscpola(); ">
    ...
    <option class="select-alt" value="60">60</option>
    <option value="80">80</option>
    <option class="select-alt" value="100">100</option>
    <option value="150">150</option>
    <option class="select-alt" value="200">200</option>
    <option value="300">300</option>
    <option class="select-alt" value="400">400</option>
    <option value="500">500</option>
    <option class="select-alt" value="750">750</option>
    <option value="1000">1000</option>
    <option class="select-alt" value="1500">1500</option>
    <option value="2000">2000</option>
    <option class="select-alt" value="3000">3000</option>
    <option value="4000">4000</option>
    <option class="select-alt" value="5000">5000</option>
    <option value="7500">7500</option>
    <option class="select-alt" value="10000">10000</option>
  </select>
</li>
...
<li class="form-line" id="id_5">
  <label class="form-label-left" id="label_5" for="input_5">perçage: </label>
...
<li class="form-line" id="id_5perso">
  <label class="form-label-left" id="label_5perso" for="input_5perso">perçage: </label>
