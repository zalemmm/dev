			...
			<ul class="form-section">
				...
				<li class="form-line" id="id_1">
					<select class="form-dropdown validate[required]" id="input_1" name="q1_usage" onchange="getElementById('preview_info_ul').innerHTML=''; JKakemono.czyscpola(); ">
						<option value="">Choisir le type de stickers</option>
						<option value="Formes">Autocollant (carré/rectangulaire)</option>
						<option value="predecoupe">Sticker prédécoupé / Forme personnalisée </option>
						<option value="lettrage-blanc">Lettrage blanc prédécoupé</option>
						<option value="lettrage-couleur">Lettrage couleur prédécoupé</option>
						<option value="covering">Covering coulé prédécoupé</option>
					</select>
				</li>

				<li class="form-line" id="id_21">
					<select class="form-dropdown validate[required]" id="input_21" name="q21_support21" onclick="JKakemono.czyscpola(); ">
				...
				<li class="form-line" id="id_22">
					<select class="form-dropdown validate[required]" id="input_22" name="q22_support22" onclick="JKakemono.czyscpola(); ">
						<option value="">Choisir le support </option>
						<option value="permanent">vinyle blanc permanent 95μ monomère 3 ans</option>
						<option value="semi-permanent">vinyle blanc semi-permanent 95μ monomère 2 ans</option>
						<option value="permanent75μ">vinyle blanc permanent 75μ polymère 5 ans</option>
				...
				<li class="form-line" id="id_23">
					<select class="form-dropdown validate[required]" id="input_23" name="q23_support23" onclick="JKakemono.czyscpola(); ">
						<option value="">Choisir le support </option>
						<option value="permanent">vinyle blanc permanent 95μ monomère 3 ans</option>
						<option value="semi-permanent">vinyle blanc semi-permanent 95μ monomère 2 ans</option>
						<option value="permanent75μ">vinyle blanc permanent 75μ polymère 5 ans</option>
				...
				<li class="form-line" id="id_24">
					<select class="form-dropdown validate[required]" id="input_24" name="q24_support24" onclick="JKakemono.czyscpola(); ">
						<option value="">Choisir le support </option>
						<option value="permanent">vinyle blanc permanent 95μ monomère 3 ans</option>
						<option value="semi-permanent">vinyle blanc semi-permanent 95μ monomère 2 ans</option>
						<option value="permanent75μ">vinyle blanc permanent 75μ polymère 5 ans</option>
				...
				<li class="form-line" id="id_25">
					<select class="form-dropdown validate[required]" id="input_25" name="q25_support25" onclick="JKakemono.czyscpola(); ">
						<option value="">Choisir le support </option>
						<option value="permanent75μ">vinyle blanc permanent 75μ polymère 5 ans</option>
					</select>
				</li>
				...
				<li class="form-line optionsformline2" id="id_7">
					<label class="form-label-left" id="label_7" for="input_7" style="color:#3097c0; font-weight:bold; text-transform:capitalize; margin-left:25px">quantité (par visuel):</label>
				...
				jQuery(document).ready(function(){
					...
					jQuery(document).ready(function(){
						...
						if ((niepokazuj==0) && ((DeliveryType == '2-3') || (DeliveryType == '1-1') || (DeliveryType == '3-4'))){
							...
							dodajkoszyk.innerHTML = '<input type="hidden" name="addtocart" value="addtocart" /><input type="hidden" name="rodzaj" value="Stickers" /><input type="hidden" name="opis" value="- '+$('input_1').value+'<br />- '+ktorytyp+dodatkowaopcja+'<br />- '+ktodaje+cedzik+etiqdesc+prliv+'</br>- '+szerokosc+' x '+wysokosc+' cm" /><input type="hidden" name="ilosc" value="'+ilosc+'" /><input type="hidden" name="prix" value="'+cena2+' &euro;" /><input type="hidden" name="option" value="-" /><input type="hidden" name="remise" value="'+rabat2+'" /><input type="hidden" name="total" value="'+suma2+' &euro;" /><input type="hidden" name="transport" value="'+transport+' &euro;" /><button id="submit_cart" type="submit">Send</button> ';
