      ...
      <ul class="form-section">
        ...
        <li class="form-line" id="id_21">
          ...
          <select class="form-dropdown validate[required]" id="input_21" name="q21_usage" onchange="getElementById(\'preview_info_ul\').innerHTML=\'\'; JKakemono.czyscpola(); ">
            ...
            <option class="select-alt" value="4">120 x 160 cm (Abribus)| Quadri </option>
            <option value="5">120 x 176 cm (Abribus)| Quadri </option>
            <option class="select-alt" value="6">100 x 150 cm (Caisson lumineux/Abribus) | Quadri </option>
...
<div id="preview">
  <span id="preview_name">Affiches sélectionné:</span>
