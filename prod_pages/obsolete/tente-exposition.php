        ...
        <div class="form-all">
            <ul class="form-section">
			 ...
			 <li class="form-line optionsformline2" id="id_13">
                    <label class="form-label-left" id="label_13" for="input_13" style="color:#3097c0; font-weight:bold; text-transform:capitalize; margin-left:25px">quantité :<br /><span class="small">(par visuel)</span></label>
