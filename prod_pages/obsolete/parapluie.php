    ...
    <div class="form-all">
      <ul class="form-section">
        ...
        <li class="form-line" id="id_8">
          <label class="form-label-left" id="label_8" for="input_8">quantité :<br /><span class="small">(par visuel)</span></label>
          <input type="text" class="form-textbox validate[required, Numeric]" placeholder="hauteur en cm" id="input_8" name="q8_quantite" size="20" value="1" onchange="JKakemono.czyscpola(); " />
        </li>
