...
new Vue({
  ...
  methods: {
    ...
    selectPers: function(value) {
        ...
        this.choixPrint = 'choisir la couleur';
    },
    ...
    calculer: function(value) {
        ...
        //-------------------------------------------------- lettrage blanc -20%
  			if (this.choixPrint == 'lettrage blanc') cena -= (cena*20)/100;
        ...
        } else if (this.choixPrint == 'choisir la couleur') {
        ...
        if ((this.erreurType == 0 || this.erreurType == 2) && (this.delailiv == '2-3' || this.delailiv == '1-1' || this.delailiv == '3-4')){
          ...
          this.inputDesc = '- '+this.choixPrint+' <br />- '+this.produit+' <br />- H|'+this.hauteur+' x L|'+this.largeur+' <br>- '+this.choixLami+' <br>- '+this.choixPers+' <br>- '+this.modmaq+' <br>- '+this.sign+' <br>- '+this.retrait+this.optliv+' <br>- P '+dprod+'J / L '+dliv+'J';
