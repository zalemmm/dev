...
new Vue({
  ...
  methods: {
    ...
    selectPers: function(value) {
        ...
        // afficher le champ suivant et indiquer qu'il est requis :
        this.showColor = true;
        this.reqColor = 'required';
        this.toggleColor = true;
        this.choixColor = 'choisir la couleur';
    },


    // fonction affichage champs formulaire :            au choix couleur validé
    //==========================================================================
    selectColor: function(value) {
        this.choixColor = value;
    ...
    calculer: function(value) {
        ...
        //----------------------------------------------------------------------
  			if (this.produit == 'permanent'      && this.choixPers == 'Pas de film de pose') cena = metraz*0.0030;
  			if (this.produit == 'semi-permanent' && this.choixPers == 'Pas de film de pose') cena = metraz*0.0030;
  			if (this.produit == 'permanent 75μ'  && this.choixPers == 'Pas de film de pose') cena = metraz*0.0065;

        if (this.produit == 'permanent'      && this.choixPers == 'tape') cena = metraz*0.0045;
  			if (this.produit == 'semi-permanent' && this.choixPers == 'tape') cena = metraz*0.0045;
  			if (this.produit == 'permanent 75μ'  && this.choixPers == 'tape')	cena = metraz*0.0080;
        ...
        if (this.choixPrint =='photo hd')  {cena +=  cena*0.90;}
  			...
  			//----------------------------------------------------------- lamination
				...
				if (this.choixLami == 'pelliculage brillant')  {
  				...
  				if (this.hauteur < 160 && this.largeur < 160 && this.largeur <= this.hauteur) Prixlamination = 160*(this.largeur*0.0008);
  				if (this.hauteur < 160 && this.largeur < 160 && this.hauteur <= this.largeur) Prixlamination = 160*(this.hauteur*0.0008);
  				if (this.hauteur < 160 && this.largeur >= 160) Prixlamination = 160*(this.largeur*0.0008);
  				if (this.largeur < 160 && this.hauteur >= 160) Prixlamination = 160*(this.hauteur*0.0008);

  				if (this.hauteur < 160 && this.largeur == 160) Prixlamination = metraz*0.0008;
  				if (this.largeur < 160 && this.hauteur == 160) Prixlamination = metraz*0.0008;

  				if (this.hauteur < 160 && this.largeur < 160 && this.hauteur <= this.largeur) Prixlamination = 160*(this.hauteur*0.0008);
  				if (this.hauteur >= 160 && this.largeur >= 160) Prixlamination = metraz*0.0008;

				}	else if (this.choixLami == 'pelliculage mat')  {

  				if (this.hauteur < 160 && this.largeur < 160 && this.largeur <= this.hauteur) Prixlamination = 160*(this.largeur*0.0010);
  				if (this.hauteur < 160 && this.largeur < 160 && this.hauteur <= this.largeur) Prixlamination = 160*(this.hauteur*0.0010);
  				if (this.hauteur < 160 && this.largeur >= 160) Prixlamination = 160*(this.largeur*0.0010);
  				if (this.largeur < 160 && this.hauteur >= 160) Prixlamination = 160*(this.hauteur*0.0010);

  				if (this.hauteur < 160 && this.largeur == 160) Prixlamination = metraz*0.0010;
  				if (this.largeur < 160 && this.hauteur == 160) Prixlamination = metraz*0.0010;

  				if (this.hauteur < 160 && this.largeur < 160 && this.hauteur <= this.largeur) Prixlamination = 160*(this.hauteur*0.0010);
  				if (this.hauteur >= 160 && this.largeur >= 160) Prixlamination = metraz*0.0010;

				} else	if (this.choixLami == 'pelliculage laqué anti graffiti')  {

  				if (this.hauteur < 160 && this.largeur < 160 && this.largeur <= this.hauteur) Prixlamination = 160*(this.largeur*0.0018);
  				if (this.hauteur < 160 && this.largeur < 160 && this.hauteur <= this.largeur) Prixlamination = 160*(this.hauteur*0.0018);
  				if (this.hauteur < 160 && this.largeur >= 160) Prixlamination = 160*(this.largeur*0.0018);
  				if (this.largeur < 160 && this.hauteur >= 160) Prixlamination = 160*(this.hauteur*0.0018);

  				if (this.hauteur < 160 && this.largeur == 160) Prixlamination = metraz*0.0018;
  				if (this.largeur < 160 && this.hauteur == 160) Prixlamination = metraz*0.0018;
        ...
        //-------------------------------------------------- lettrage blanc -20%
  			if (this.choixColor == 'lettrage blanc') cena -= (cena*20)/100;
        ...
        if (this.colis == true) {
          if ( !document.getElementById('revendeur') && !document.getElementById('revendeurRC') ) {cena += cena*this.$global.livREV/100;}
        ...
        if (this.choixLami == 'choisir le type de pelliculage') {
          this.erreurType=1; this.errorMessage='<i class="fa fa-warning"></i> veuillez choisir le type de pelliculage';
        ...
        } else if (this.choixColor == 'choisir la couleur') {
          this.erreurType=1; this.errorMessage='<i class="fa fa-warning"></i> veuillez choisir la couleur';
        ...
        if ((this.erreurType == 0 || this.erreurType == 2) && (this.delailiv == '2-3' || this.delailiv == '1-1' || this.delailiv == '3-4')){
          ...
          this.inputDesc = '- carré / rectangulaire <br />- '+this.produit+' '+this.choixPrint+'<br />- H|'+this.hauteur+' x L|'+this.largeur+' <br>- '+this.choixLami+'  <br>- '+this.choixPers+' <br>- '+this.choixColor+' <br>- '+this.modmaq+' <br>- '+this.sign+' <br>- '+this.retrait+this.optliv+' <br>- P '+dprod+'J / L '+dliv+'J';

          this.inputProd      = 'Sticker lettrage prédécoupé';
