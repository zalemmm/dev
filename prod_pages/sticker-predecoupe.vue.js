...
new Vue({
  ...
  methods: {
    ...
    calculer: function(value) {
        ...
        //----------------------------------------------------------------------
  			if (this.produit == 'permanent'      && this.choixPers == 'Pas de film de pose') cena = metraz*0.0025;
  			if (this.produit == 'semi-permanent' && this.choixPers == 'Pas de film de pose') cena = metraz*0.0025;
  			if (this.produit == 'permanent 75μ'  && this.choixPers == 'Pas de film de pose') cena = metraz*0.0040;

        if (this.produit == 'permanent'      && this.choixPers == 'tape') cena = metraz*0.0040;
        ...
        if ((this.erreurType == 0 || this.erreurType == 2) && (this.delailiv == '2-3' || this.delailiv == '1-1' || this.delailiv == '3-4')){
          ...
          this.inputDesc = '- carré / rectangulaire <br />- '+this.produit+' '+this.choixPrint+'<br />- H|'+this.hauteur+' x L|'+this.largeur+' <br>- '+this.choixLami+'  <br>- '+this.choixPers+' <br>- '+this.modmaq+' <br>- '+this.sign+' <br>- '+this.retrait+this.optliv+' <br>- P '+dprod+'J / L '+dliv+'J';
