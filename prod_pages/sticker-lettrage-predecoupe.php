		...
		<div class="form-all">
			<ul class="form-section">
				...
				<li class="form-line" id="id_2">
					<span class="helpButton" onmouseover="pokazt('helpTextcouleur');" onmouseout="ukryjt('helpTextcouleur');"><img class="helpImg" src="http://www.france-banderole.com/wp-content/plugins/fbshop/images/question.png"><span class="helpText" id="helpTextcouleur" style="visibility:hidden;">Option</span></span>
					...
					jQuery(document).ready(function(){
						...
						if(production && delivery){
							...
							if(jQuery('#id_10').css('display') != 'none')
							{
								...
								jQuery('#estdate_10').html('Date de livraison max : '+output+' <a class="linkUppercase" href="http://www.france-banderole.com/etre-livre-rapidement/" target="_blank"><i class="fa fa-info-circle" aria-hidden="true"></i></a>');
