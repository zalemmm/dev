			...
			<form class="vueForm" action="" method="post" name="vueForm" id="vueForm" accept-charset="utf-8">
				<div class="form-all">
					<ul class="formSection">
						...
						<li class="formSelect" id="id_signature" v-show="showPrint">
							...
							<transition name="slideDown">
								<div class="boutonsSelect" v-show="togglePrint" >
									<div @mouseover="hoPw(9,'lettrage blanc');" @mouseout="hout(9)" v-tooltip.bottom="$global.psi" @click="reset(); selectPrint('lettrage blanc');">
										<i class="fa fa-ban" aria-hidden="true"></i><span>lettrage blanc</span>
									</div>
									<div @mouseover="hoPw(9,'lettrage couleur');" @mouseout="hout(9)" v-tooltip.bottom="$global.pne" @click="reset(); selectPrint('lettrage couleur');">
...
<script src="../wp-content/plugins/fbshop/prod_pages/vue.sticker-lettrage.js?v=2.5"></script>
