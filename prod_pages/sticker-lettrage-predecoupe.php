		...
		<div class="form-all">
			<ul class="form-section">
				...
				<li class="form-line" id="id_1">
					<span class="helpButton" onmouseover="tipShow('helpTextsupport');" onmouseout="tipHide('helpTextsupport');"><img class="helpImg" src="http://www.france-banderole.com/wp-content/plugins/fbshop/images/question.png"><span class="helpText" id="helpTextsupport" style="visibility:hidden;">Support</span></span>
				...
				<li class="form-line" id="id_2">
					<span class="helpButton" onmouseover="tipShow('helpTextcouleur');" onmouseout="tipHide('helpTextcouleur');"><img class="helpImg" src="http://www.france-banderole.com/wp-content/plugins/fbshop/images/question.png"><span class="helpText" id="helpTextcouleur" style="visibility:hidden;">Option</span></span>
