		...
		<div class="form-all">
			<ul class="form-section">
				...
				<li class="form-line" id="id_2">
					<span class="helpButton" onmouseover="pokazt('helpTextcouleur');" onmouseout="ukryjt('helpTextcouleur');"><img class="helpImg" src="http://www.france-banderole.com/wp-content/plugins/fbshop/images/interrogation.png"><span class="helpText" id="helpTextcouleur" style="visibility:hidden;">Option</span></span>
				...
				<li class="form-line" id="id_4">
					<span class="helpButton" onmouseover="pokazt('helpTextoption');" onmouseout="ukryjt('helpTextoption');"><img class="helpImg" src="http://www.france-banderole.com/wp-content/plugins/fbshop/images/interrogation.png"><span class="helpText" id="helpTextoption" style="visibility:hidden;"></span></span>
	...
	jQuery('.delivery , .production').click(function(){
		...
		if ( ($('input_1').value) &&  ($('input_4').value)  && ($('input_6').value) && ($('input_7').value) && ($('input_8').value) && ($('input_9').value) ) {
			...
			if ( ($('input_1').value == 'permanent') && ($('input_4').value == 'Pas de film de pose') ) {
				ktorytyp='Sticker lettrage prédécoupé';
