	...
	<form class="jotform-form" action="" method="post" name="form_1060900217" id="1060900217" accept-charset="utf-8" onsubmit="JKakemono.cal_banderoles(); return false;">
		...
		<div class="form-all">
			<ul class="form-section">
				...
				<li id="id_14" class="form-line optionsformline2">
					<label class="form-label-left label-highlight" id="label_14" for="input_14">taille <strong><span class="highlight">(en M)</span></strong>:</label>
