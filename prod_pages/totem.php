            ...
            jQuery('.form-checkbox').click(function(){
              ...
              if(production && delivery){
                ...
                if(jQuery('#id_8').css('display') != 'none')
                {
                  ...
                  jQuery('#estdate_8').html('Date de livraison max : '+output+' <br /><a class="linkUppercase" href="http://www.france-banderole.com/etre-livre-rapidement/" target="_blank">*voir conditions</a>');
