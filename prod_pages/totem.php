<div id="buying">
      ...
      <ul class="form-section">
        ...
        <li class="form-line" id="id_33">
          ...
          <select class="form-dropdown validate[required]" id="input_33" name="q33_dimensions" onclick="JKakemono.czyscpola(); ">
            ...
            <option class="option1" value="60x120">60x120 cm </option>
            <option class="option2" value="60x160">60x160 cm </option>
            <option class="option1" value="80x100">80x100 cm </option>
            <option class="option2" value="80x120">80x120 cm </option>
            <option class="option1" value="80x160">80x160 cm </option>
            <option class="option2" value="80x200">80x200 cm </option>
            <option class="option1" value="80x250">80x250 cm </option>
            <option class="option2" value="80x300">80x300 cm </option>
            <option class="option1" value="100x100">100x100 cm </option>
            <option class="option2" value="100x120">100x120 cm </option>
            <option class="option1" value="100x160">100x160 cm </option>
            <option class="option2" value="100x200">100x200 cm </option>
            <option class="option1" value="100x250">100x250 cm </option>
            <option class="option2" value="100x300">100x300 cm </option>
            <option class="option1" value="120x160">120x160 cm </option>
            <option class="option2" value="120x200">120x200 cm </option>
            <option class="option1" value="120x250">120x250 cm </option>
            <option class="option2" value="120x300">120x300 cm </option>
            <option class="option1" value="160x200">160x200 cm </option>
            <option class="option2" value="160x250">160x250 cm </option>
            <option class="option1" value="160x300">160x300 cm </option>
            <option class="option2" value="160x350">160x350 cm </option>
            <option class="option1" value="160x400">160x400 cm </option>
          </select>
        </li>
        ...
        <li class="form-line" id="id_52">
          ...
          <select class="form-dropdown validate[required]" id="input_52" name="q52_visuel">
            ...
            <option class="option1" value="470g M1">bâche 470g M1</option>
            <option class="option2" value="100% écologique M1">toile 100% écologique M1</option>
            <option class="option1" value="440g M1 RECTO VERSO">bâche 440g M1 RECTO VERSO </option>
          </select>
        </li>
  ...
  jQuery(document).ready(function(){
    ...
    jQuery('.delivery , .production').click(function(){
      ...
      if (($('input_1').value) &&  (($('input_32').value) || ($('input_33').value) || ($('input_34').value) || ($('input_51').value) || ($('input_52').value) || ($('input_11').value) || ($('input_16').value)) && ($('input_7').value) ) {
