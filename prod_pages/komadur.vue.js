    ...
    calculer: function(value) {
        ...
        if (this.hauteur > 100 || this.largeur > 100 ) {
          if (this.palette == false) {
            this.warngMessage = '- Enseigne livrée découpée en mètre linéaire. Si vous souhaitez votre enseigne en 1 morceau, veuillez cocher l\'option "Grand format livré entier" (uniquement pour une enseigne inférieure à 100x200cm).';
  					this.erreurType = 2;
          }else{
            this.formWarng  = false;
            this.erreurType = 0;
  			...
  			if ((this.hauteur > 100 && this.largeur > 200) || (this.hauteur > 200 && this.largeur > 100)) {
  					this.warngMessage = '- Votre enseigne est supérieure à 100x200cm, elle sera donc produite sur plusieurs plaques';
  					this.erreurType=2;
  			}
