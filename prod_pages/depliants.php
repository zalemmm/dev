<div id="buying">
  ...
  <form class="jotform-form" action="" method="post" name="form_1060900223" id="1060900223" accept-charset="utf-8" onsubmit="JKakemono.cal_depliants();
  return false;">
...
<script>
  ...
  jQuery(document).ready(function(){
      ...
      if ($('input_1').value == 'depliants 135g') {
        if ($('input_21').value == '1'){ opis += '- Double DIN long plié (19,8 x 21 cm ouvert)';}
        if ($('input_21').value == '2'){ opis += '- DIN A3 plié en Din A4';}
        if ($('input_21').value == '3'){ opis += '- A4 ouvert -> A5 fermé';}
        if ($('input_21').value == '4'){ opis += '- A4 ouvert -> 3 volets 10x21cm fermé';}
        if ($('input_21').value == '5'){ opis += '- A5 ouvert -> A6 fermé';}
        if (($('input_21').value == '1') || ($('input_21').value == '2') || ($('input_21').value == '3') || ($('input_21').value == '4') || ($('input_21').value == '5')) {
          ...
          cenar=0.22
          cenarv=0.27
          if ($('input_21').value == '1'){ cena1=(ilosc/2)*cenarv; opis += '<br />- Recto/verso<br />- 135g | Quadri';}
          if ($('input_21').value == '2'){ cena1=(ilosc/1)*cenarv; opis += '<br />- Recto/verso<br />- 135g | Quadri';}
          if ($('input_21').value == '3'){ cena1=(ilosc/2)*cenarv; opis += '<br />- Recto/verso<br />- 135g | Quadri';}
          if ($('input_21').value == '4'){ cena1=(ilosc/2)*cenarv; opis += '<br />- Recto/verso<br />- 135g | Quadri';}
          if ($('input_21').value == '5'){ cena1=(ilosc/4)*cenarv; opis += '<br />- Recto/verso<br />- 135g | Quadri';}
      ...
      if ($('input_1').value == 'depliants 170g') {
        ...
        if (($('input_21').value == '1') || ($('input_21').value == '2') || ($('input_21').value == '3') || ($('input_21').value == '4') || ($('input_21').value == '5')) {
          ...
          cenar=0.27
          cenarv=0.32
          if ($('input_21').value == '1'){ cena1=(ilosc/2)*cenarv; opis += '<br />- Recto/verso<br />- 170g | Quadri';}
          if ($('input_21').value == '2'){ cena1=(ilosc/1)*cenarv; opis += '<br />- Recto/verso<br />- 170g | Quadri';}
          if ($('input_21').value == '3'){ cena1=(ilosc/2)*cenarv; opis += '<br />- Recto/verso<br />- 170g | Quadri';}
          if ($('input_21').value == '4'){ cena1=(ilosc/2)*cenarv; opis += '<br />- Recto/verso<br />- 170g | Quadri';}
          if ($('input_21').value == '5'){ cena1=(ilosc/4)*cenarv; opis += '<br />- Recto/verso<br />- 170g | Quadri';}
          if ((ilosc == '10') || (ilosc == '25') || (ilosc == '50') || (ilosc == '100') || (ilosc == '250')){ cena1*=1.15;}
          if ((ilosc == '5000') || (ilosc == '7500') || (ilosc == '10000')){ cena1*=0.95;}
          if ((ilosc == '15000') || (ilosc == '20000')){ cena1*=0.90;}
          if ((ilosc == '25000') || (ilosc == '30000')){ cena1*=0.85;}
      ...
      if ($('input_1').value == 'depliants 250g') {
        ...
        if (($('input_21').value == '1') || ($('input_21').value == '2') || ($('input_21').value == '3') || ($('input_21').value == '4') || ($('input_21').value == '5')) {
          ...
          cenar=0.32
          cenarv=0.37
          if ($('input_21').value == '1'){ cena1=(ilosc/2)*cenarv; opis += '<br />- Recto/verso<br />- 250g | Quadri';}
          if ($('input_21').value == '2'){ cena1=(ilosc/1)*cenarv; opis += '<br />- Recto/verso<br />- 250g | Quadri';}
          if ($('input_21').value == '3'){ cena1=(ilosc/2)*cenarv; opis += '<br />- Recto/verso<br />- 250g | Quadri';}
          if ($('input_21').value == '4'){ cena1=(ilosc/2)*cenarv; opis += '<br />- Recto/verso<br />- 250g | Quadri';}
          if ($('input_21').value == '5'){ cena1=(ilosc/4)*cenarv; opis += '<br />- Recto/verso<br />- 250g | Quadri';}
          if ((ilosc == '10') || (ilosc == '25') || (ilosc == '50') || (ilosc == '100') || (ilosc == '250')){ cena1*=1.15;}
          if ((ilosc == '5000') || (ilosc == '7500') || (ilosc == '10000')){ cena1*=0.95;}
          if ((ilosc == '15000') || (ilosc == '20000')){ cena1*=0.90;}
          if ((ilosc == '25000') || (ilosc == '30000')){ cena1*=0.85;}
      ...
      if (($('input_41').value == 'fb') || ($('input_42').value == 'fb')) {
        cena+=29;
        ktodaje = 'France banderole crée la maquette';
      }
      if (($('input_41').value == 'user') || ($('input_42').value == 'user')) {
        ktodaje = 'j’ai déjà crée la maquette';
      }
      if (($('input_41').value == 'config') || ($('input_42').value == 'config')) {
        cena+=5;
