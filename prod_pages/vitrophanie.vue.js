...
new Vue({
  ...
  methods: {
    ...
    calculer: function(value) {
        ...
        if (this.choixMaqt == 'votre maquette (fichier d\'impression)') {
        ...
        if ((this.erreurType == 0 || this.erreurType == 2) && (this.delailiv == '2-3' || this.delailiv == '1-1' || this.delailiv == '3-4')){
          ...
          this.inputDesc = '- '+this.produit+' <br />- H|'+this.hauteur+' x L|'+this.largeur+' <br>- '+this.modmaq+' <br>- '+this.sign+' <br>- '+this.retrait+this.optliv+' <br>- P '+dprod+'J / L '+dliv+'J';

          this.inputProd      = 'Sticker vitrophanie';
