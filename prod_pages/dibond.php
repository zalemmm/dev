<div id="prodApp">
	<div class="row">
		<div class="column" id="choicesContainer"> <!--bloc formulaire-->
			...
			<h3>Votre devis en ligne Dibond</h3>
		...
		<div class="column" id="previewContainer">
			<div class="helpMenu">
				...
				<a :href="$global.url+'/gabarit-dibond-3mm/'" class="notice modal-link"  title="gabarits maquette">
...
<script src="../wp-content/plugins/fbshop/prod_pages/vue.dibond.js?v=2.6"></script>
