...
if ($('input_1').value == 'extérieur') {
	...
	if ($('input_ext').value == 'bache 440g' ) {
		if (metragefinal < 1.99) {cenatotal = metragefinal*10.50;}
		if ((metragefinal > 1.99) && (metragefinal <= 3.99)) {cenatotal = metragefinal*9.80;}
		if ( (metragefinal > 3.99) && (metragefinal <= 5.99) ) {cenatotal = metragefinal*9.60;}
		if ( (metragefinal > 5.99) && (metragefinal <= 7.99) ) {cenatotal = metraz*9.40;}
		if ( (metragefinal > 7.99) && (metragefinal <= 9.99) ) {cenatotal = metragefinal*9.20;}
		if ( (metragefinal > 9.99) && (metragefinal <= 13.99) ) {cenatotal = metragefinal*9.00;}
		if ( (metragefinal > 13.99) && (metragefinal <= 17.99) ) {cenatotal = metragefinal*8.75;}
		if ( (metragefinal > 17.99) && (metragefinal <= 23.99) ) {cenatotal = metragefinal*8.50;}
		if ( (metragefinal > 23.99) && (metragefinal <= 29.99) ) {cenatotal = metragefinal*8.40;}
		if ( (metragefinal > 29.99) && (metragefinal <= 39.99) ) {cenatotal = metragefinal*8.30;}
		if ( (metragefinal > 39.99) && (metragefinal <= 49.99) ) {cenatotal = metragefinal*8.20;}
		if ( (metragefinal > 49.99) && (metragefinal <= 59.99) ) {cenatotal = metragefinal*8.00;}
		if ( (metragefinal > 59.99) && (metragefinal <= 69.99) ) {cenatotal = metragefinal*7.50;}
		if ( (metragefinal > 69.99) && (metragefinal <= 79.99) ) {cenatotal = metragefinal*7.40;}
		if ( (metragefinal > 79.99) && (metragefinal <= 89.99) ) {cenatotal = metragefinal*7.30;}
		if ( (metragefinal > 89.99) && (metragefinal <= 99.99) ) {cenatotal = metragefinal*7.20;}
		if ( (metragefinal > 99.99) && (metragefinal <= 149.99) ) {cenatotal = metragefinal*7;}
		if ( (metragefinal > 149.99) && (metragefinal <= 199.99) ) {cenatotal = metragefinal*6.75;}
		if ( (metragefinal > 199.99) && (metragefinal <= 249.99) ) {cenatotal = metragefinal*6.50;}
		if ( (metragefinal > 249.99) && (metragefinal <= 299.99) ) {cenatotal = metragefinal*6.25;}
		if ( (metragefinal > 299.99) && (metragefinal <= 399.99) ) {cenatotal = metragefinal*6;}
		if ( (metragefinal > 399.99) && (metragefinal <= 499.99) ) {cenatotal = metragefinal*5.75;}
		if (metragefinal > 499.99) {cenatotal = metragefinal*5.5;}
		opis += '<br />- 440gr'
	}
	if ($('input_ext').value == 'bache 550g' ) {
		if (metragefinal < 1.99) {cenatotal = metragefinal*17.00;}
		if ((metragefinal > 1.99) && (metragefinal <= 3.99)) {cenatotal = metragefinal*16.80;}
		if ( (metragefinal > 3.99) && (metragefinal <= 5.99) ) {cenatotal = metragefinal*16.60;}
		if ( (metragefinal > 5.99) && (metragefinal <= 7.99) ) {cenatotal = metraz*16.40;}
		if ( (metragefinal > 7.99) && (metragefinal <= 9.99) ) {cenatotal = metragefinal*16.20;}
		if ( (metragefinal > 9.99) && (metragefinal <= 13.99) ) {cenatotal = metragefinal*16.00;}
		if ( (metragefinal > 13.99) && (metragefinal <= 17.99) ) {cenatotal = metragefinal*15.50;}
		if ( (metragefinal > 17.99) && (metragefinal <= 23.99) ) {cenatotal = metragefinal*15.25;}
		if ( (metragefinal > 23.99) && (metragefinal <= 29.99) ) {cenatotal = metragefinal*15.00;}
		if ( (metragefinal > 29.99) && (metragefinal <= 39.99) ) {cenatotal = metragefinal*14.75;}
		if ( (metragefinal > 39.99) && (metragefinal <= 49.99) ) {cenatotal = metragefinal*14.50;}
		if ( (metragefinal > 49.99) && (metragefinal <= 59.99) ) {cenatotal = metragefinal*14.25;}
		if ( (metragefinal > 59.99) && (metragefinal <= 69.99) ) {cenatotal = metragefinal*14.00;}
		if ( (metragefinal > 69.99) && (metragefinal <= 79.99) ) {cenatotal = metragefinal*13.75;}
		if ( (metragefinal > 79.99) && (metragefinal <= 89.99) ) {cenatotal = metragefinal*13.50;}
		if ( (metragefinal > 89.99) && (metragefinal <= 99.99) ) {cenatotal = metragefinal*13.25;}
		if ( (metragefinal > 99.99) && (metragefinal <= 149.99) ) {cenatotal = metragefinal*13;}
		if ( (metragefinal > 149.99) && (metragefinal <= 199.99) ) {cenatotal = metragefinal*12.00;}
		if ( (metragefinal > 199.99) && (metragefinal <= 249.99) ) {cenatotal = metragefinal*11.00;}
		if ( (metragefinal > 249.99) && (metragefinal <= 299.99) ) {cenatotal = metragefinal*10.00;}
		if ( (metragefinal > 299.99) && (metragefinal <= 399.99) ) {cenatotal = metragefinal*9.00;}
		if ( (metragefinal > 399.99) && (metragefinal <= 499.99) ) {cenatotal = metragefinal*8.00;}
		if (metragefinal > 499.99) {cenatotal = metragefinal*7.50;}
		opis += '<br />- 550gr'	
	}
	if ($('input_ext').value == 'bache 470g M1' ) {
		...
		if ( (metragefinal > 5.99) && (metragefinal <= 7.99) ) {cenatotal = metraz*19.50;}
	...
	if ($('input_ext').value == 'bache 750g M2/B1' ) {
		...
		if ( (metragefinal > 5.99) && (metragefinal <= 7.99) ) {cenatotal = metraz*20.50;}
	...
	if ($('input_ext').value == 'bache 750g M2/B1 recto verso' ) {
		...
		if ( (metragefinal > 5.99) && (metragefinal <= 7.99) ) {cenatotal = metraz*27.50;}
	...
	if ($('input_ext').value == 'bache micro perforée M1/B1' ) {
		...
		if ( (metragefinal > 5.99) && (metragefinal <= 7.99) ) {cenatotal = metraz*17.40;}
	...
	if ($('input_ext').value == 'bache nontissé 150g' ) {
		...
		if ( (metragefinal > 5.99) && (metragefinal <= 7.99) ) {cenatotal = metraz*15.40;}
