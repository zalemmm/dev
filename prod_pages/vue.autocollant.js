...
new Vue({
  ...
  methods: {
    ...
    // fonction affichage champs formulaire :
    //==========================================================================
    selectPers: function(value) {
        ...
        this.bg4 = {backgroundImage: 'url('+this.$global.img+'/stickers/'+this.choixPers+'.png)'}; //
    ...
    calculer: function(value) {
        ...
        var cena           = 0;  var cena2  = 0; var prixunite = 0;
  			...
  			//----------------------------------------------------------------------
  			if (this.produit == 'permanent')      cena = metraz*0.0020;
  			if (this.produit == 'semi-permanent') cena = metraz*0.0020;
  			if (this.produit == 'micro-perforé')	cena = metraz*0.0035;
  			if (this.produit == 'permanent 75μ')	cena = metraz*0.0055;
