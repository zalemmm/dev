  ...
  methods: {
    ...
    calculer: function(value) {
        ...
        if (this.maquette == 'maquette client sans bat') {
  			...
  			//---------------------------------------------------------------- coupe
        if (metraz <= 0.24) coupe=0;

        if ((metraz>0.24) && (metraz<=0.48)){
          if (np<=1){
            if (this.qte==1){coupe = -14*this.qte}
            if (this.qte==2){coupe = -5*this.qte}
            if (this.qte==3){coupe = -2*this.qte}
            if (this.qte==4){coupe = -1*this.qte}
          }
          if ((np>1) && (np<=2)){
            if (this.qte==5){coupe = -1*this.qte}
            if (this.qte==6){coupe = -0.5*this.qte}
            if (this.qte==7){coupe = -0.2*this.qte}
            if (this.qte==8){coupe = -0.1*this.qte}
          }
          if ((np>2) && (np<=3)){coupe = 0.0*this.qte}
          if ((np>3) && (np<=4)){coupe = 0.5*this.qte}
          if ((np>4) && (np<=6)){coupe = 0.5*this.qte}
          if ((np>6) && (np<=7)){coupe = 0.25*this.qte}
          if ((np>7) && (np<=8)){coupe = 0.0*this.qte}
          if ((np>8) && (np<=9)){coupe = 0.3*this.qte}
          if ((np>9) && (np<=16)){coupe = 0.0*this.qte}
          if ((np>16) && (np<=17)){coupe = 0.38*this.qte}
          if ((np>17) && (np<=18)){coupe = 0.25*this.qte}
          if ((np>18) && (np<=21)){coupe = 0.0*this.qte}
          if ((np>21) && (np<=22)){coupe = 0.0*this.qte}
          if ((np>22) && (np<=24)){coupe = 0.0*this.qte}
          if ((np>24) && (np<=25)){coupe = 0.0*this.qte}
          if ((np>25) && (np<=31)){coupe = 0.0*this.qte}
          if ((np>31) && (np<=39)){coupe = 0.0*this.qte}
          if ((np>39) && (np<=62)){coupe = 0.00*this.qte}
          if ((np>62) && (np<=70)){coupe = 0.00*this.qte}
          if ((np>70) && (np<=74)){coupe = 0.00*this.qte}
          if ((np>74) && (np<=90)){coupe = 0.0*this.qte}
          if ((np>90) && (np<=99)){coupe = 0.0*this.qte}
          if ((np>99) && (np<=112)){coupe = 0.0*this.qte}
          if ((np>112) && (np<=124)){coupe = 0.0*this.qte}
          if ((np>124) && (np<=125)){coupe = 0.25*this.qte}
          if ((np>125) && (np<=137)){coupe = 0.35*this.qte}
          if ((np>137) && (np<=187)){coupe = 0.33*this.qte}
          if ((np>187) && (np<=249)){coupe = 0.35*this.qte}
          if ((np>249) && (np<=1000000)){coupe = 0.45*this.qte}
        }
        //------------------------------------------------------------------------
        if ((metraz>0.48) && (metraz<=0.96)){
          if (np<=1){
            if (this.qte==1){coupe = -14*this.qte}
            if (this.qte==2){coupe = -2*this.qte}
          }
          if ((np>1) && (np<=2)){
            if (this.qte==3){coupe = -2*this.qte}
            if (this.qte==4){coupe = 0*this.qte}
          }
          if ((np>2) && (np<=3)){coupe = 0.0*this.qte}
          if ((np>3) && (np<=4)){coupe = 0.5*this.qte}
          if ((np>4) && (np<=6)){coupe = 0.5*this.qte}
          ...
          if ((np>24) && (np<=25)){coupe = 0.0*this.qte}
          if ((np>25) && (np<=31)){coupe = 0.0*this.qte}
          if ((np>31) && (np<=39)){coupe = 0.20*this.qte}
          if ((np>39) && (np<=62)){coupe = 0.0*this.qte}
          if ((np>62) && (np<=70)){coupe = 0.03*this.qte}
          if ((np>70) && (np<=74)){coupe = 0.10*this.qte}
          if ((np>74) && (np<=90)){coupe = 0.26*this.qte}
          if ((np>90) && (np<=99)){coupe = 0.25*this.qte}
          ...
          if ((np>137) && (np<=187)){coupe = 0.33*this.qte}
          if ((np>187) && (np<=249)){coupe = 0.35*this.qte}
          if ((np>249) && (np<=1000000)){coupe = 0.65*this.qte}
        }
        //------------------------------------------------------------------------
        if ((metraz>0.96) && (metraz<=1.92)){
          if (np<=1){coupe = 1.8*this.qte}
          if ((np>1) && (np<=2)){coupe = 1.7*this.qte}
