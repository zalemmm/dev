		...
		var myClass = jQuery(this).attr("class");
			...
			if(production && delivery){
				...
				if(jQuery('#id_10').css('display') != 'none')
				{
					...
					jQuery('#estdate_10').html('Date de livraison : '+output+' <a style="text-transform: uppercase; text-decoration: none" href="//www.france-banderole.com/etre-livre-rapidement/" target="_blank">(*)</a>');
