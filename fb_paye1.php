...
if ($query) {
	if (isset($_POST['addpayment'])) {
		...
		if (isset($_GET['pay'])) {
			...
			<div id="paiements_left_con"><form name="regulamin" id="regulamin" action="" method="post" onsubmit="potwierdzregulamin(); return false;"><input type="checkbox" name="accepte" id="reg_confirm" value="prawda"'.$chec.' /><label for="accepte" class="checkbox2"> En cochant cette case, je reconnais avoir lu et <a href="'.get_bloginfo("url").'/cgv/" class="modal-link conditio">accepter les conditions</a> générales de vente.</label><button id="suivant_reg" type="submit">Suivant <i class="fa fa-caret-right" aria-hidden="true"></i></button></form></div>
			...
			if($paiement_tbl['cb']) {
				...
				<button id="but_conf_pay" type="submit" '.$pcb.'><i class="fa fa-caret-right" aria-hidden="true"></i> Payer</button>
				</div>';
			}
			if($paiement_tbl['cheque']) {
				...
				<button id="but_conf_pay" type="submit" '.$pch.'><i class="fa fa-caret-right" aria-hidden="true"></i> Payer</button>
				</div>';
			}
			if($paiement_tbl['virement']) {
				...
				<button id="but_conf_pay" type="submit" '.$pvi.'><i class="fa fa-caret-right" aria-hidden="true"></i> Payer</button>
				</div>';
			}
			if($paiement_tbl['trente']) {
				...
				<button id="but_conf_pay" type="submit" '.$p30.'><i class="fa fa-caret-right" aria-hidden="true"></i> Payer</button>
				</div>';
			}
			if($paiement_tbl['soixante']) {
				...
				<span class="pay_carte_info">Ce mode de paiement implique la suppression de l\'escompte commercial de 5% sur nos tarifs en ligne.</span>
				<button id="but_conf_pay" type="submit" '.$p60.'><i class="fa fa-caret-right" aria-hidden="true"></i> Payer</button>
				</div>';
			}
			if($paiement_tbl['administratif']) {
				...
				<span class="pay_carte_info">Ce mode de paiement implique la suppression de l\'escompte commercial de 5% sur nos tarifs en ligne.</span>
				<button id="but_conf_pay" type="submit" '.$pad.'><i class="fa fa-caret-right" aria-hidden="true"></i> Payer</button>
				</div>';
			}

			$view .= '<div class="paiements_right_con2"></div>
			</form>
			</div>';
