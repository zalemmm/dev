...
function fbshop_head() {
  ...
  JotForm.setConditions([
    ...
    {"type": "field", "link": "Any", "terms": [{"field": "31", "operator": "equals", "value": "ourlet de renfort périmétrique"},{"field": "41", "operator": "equals", "value": "fourreaux haut/bas"},{"field": "41", "operator": "equals", "value": "fourreaux gauche/droite"},{"field": "42", "operator": "equals", "value": "fourreaux haut/bas"},{"field": "43", "operator": "equals", "value": "fourreaux gauche/droite"},{"field": "34", "operator": "isFilled", "value": false}], "action": {"field": "51", "visibility": "Show"}},

    {"type": "field", "link": "Any", "terms": [{"field": "41", "operator": "equals", "value": "sans fourreaux"},{"field": "42", "operator": "equals", "value": "sans fourreaux"},{"field": "43", "operator": "equals", "value": "sans fourreaux"}], "action": {"field": "71", "visibility": "Show"}},
          ...
          <tr>
              ...
              <td class="optionstd">
                  ...
                  <div class="plvoptions">
                      ...
                      <span class="plvoptionsingle"><input type="checkbox" class="form-checkbox" checked="checked" id="fedex' . $licznik . '" name="fedex[]" value="" onclick=" FEDClick(' . $licznik . ');" /><label  class="form-label-left" id="label_fedex' . $licznik . '" for="fedex' . $licznik . '">Livraison avec Fedex</label><span class="helpButton" onmouseover="tipShow(\'helpTextfedex' . $licznik . '\');" onmouseout="tipHide(\'helpTextfedex' . $licznik . '\');"><span class="helpText" id="helpTextfedex' . $licznik . '" style="visibility:hidden;">Livraison gratuite avec Fedex en 7 à 9 jours ouvrés (non compatible avec les délais Rush, et Relais colis).</span></span></span>
                      <span class="plvoptionsingle"><input type="checkbox" class="form-checkbox" id="tnt' . $licznik . '" name="tnt[]" value="" onclick=" TNTClick(' . $licznik . '); " /><label class="form-label-left" id="label_tnt' . $licznik . '" for="tnt' . $licznik . '">Livraison avec TNT</label><span class="helpButton" onmouseover="tipShow(\'helpTexttnt' . $licznik . '\');" onmouseout="tipHide(\'helpTexttnt' . $licznik . '\');"><span class="helpText" id="helpTexttnt' . $licznik . '" style="visibility:hidden;">Livraison payante avec TNT en 6 à 8 jours ouvrés(non compatible pour un colis hors-norme*)</span></span></span>
                  </div>
              </td>
              <td class="righttd">
